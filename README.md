...
- <code>&nbsp;67503</code> [Ollama](https://github.com/jmorganca/ollama) - Run large language models locally.
- <code>&nbsp;20444</code> [LocalAI](https://github.com/mudler/LocalAI) - Open Source OpenAI alternative, self-host AI models.
- <code>&nbsp;&nbsp;3264</code> [langchaingo](https://github.com/tmc/langchaingo) - LangChainGo is a framework for developing applications powered by language models.
...
- <code>&nbsp;16960</code> [casbin](https://github.com/hsluoyz/casbin) - Authorization library that supports access control models like ACL, RBAC, and ABAC.
...
- <code>&nbsp;&nbsp;5063</code> [goth](https://github.com/markbates/goth) - provides a simple, clean, and idiomatic way to use OAuth and OAuth2. Handles multiple providers out of the box.
...
- <code>&nbsp;&nbsp;2334</code> [openfga](https://github.com/openfga/openfga) - Implementation of fine-grained authorization based on the "Zanzibar: Google's Consistent, Global Authorization System" paper. Backed by [CNCF](https://www.cncf.io/).
- <code>&nbsp;&nbsp;1982</code> [scs](https://github.com/alexedwards/scs) - Session Manager for HTTP servers.
...
- <code>&nbsp;&nbsp;1562</code> [gorbac](https://github.com/mikespook/gorbac) - provides a lightweight role-based access control (RBAC) implementation in Golang.
- <code>&nbsp;&nbsp;1207</code> [oidc](https://github.com/zitadel/oidc) - Easy to use OpenID Connect client and server library written for Go and certified by the OpenID Foundation
...
- <code>&nbsp;46355</code> [go-ethereum](https://github.com/ethereum/go-ethereum) - Official Go implementation of the Ethereum protocol.
- <code>&nbsp;15825</code> [kubo](https://github.com/ipfs/kubo) - A blockchain framework implemented in Go. It provides content-addressable storage which can be used for decentralized storage in DApps. It is based on the IPFS protocol.
...
- <code>&nbsp;&nbsp;&nbsp;670</code> [solana-go](https://github.com/gagliardetto/solana-go) - Go library to interface with Solana JSON RPC and WebSocket interfaces.
- <code>&nbsp;&nbsp;&nbsp;558</code> [cometbft](https://github.com/cometbft/cometbft) - A distributed, Byzantine fault-tolerant, deterministic state machine replication engine. It is a fork of Tendermint Core and implements the Tendermint consensus algorithm.
...
- <code>&nbsp;&nbsp;5469</code> [telegram-bot-api](https://github.com/Syfaro/telegram-bot-api) - Simple and clean Telegram bot client.
- <code>&nbsp;&nbsp;3691</code> [telebot](https://github.com/tucnak/telebot) - Telegram bot framework is written in Go.
...
- <code>&nbsp;&nbsp;&nbsp;431</code> [bot](https://github.com/go-telegram/bot) - Zero-dependencies Telegram Bot library with additional UI components
- <code>&nbsp;&nbsp;&nbsp;419</code> [telego](https://github.com/mymmrac/telego) - Telegram Bot API library for Golang with full one-to-one API implementation.
...
- <code>&nbsp;10159</code> [Task](https://github.com/go-task/task) - simple "Make" alternative.
...
- <code>&nbsp;&nbsp;3912</code> [mage](https://github.com/magefile/mage) - Mage is a make/rake-like build tool using Go.
...
- <code>&nbsp;24587</code> [bubbletea](https://github.com/charmbracelet/bubbletea) - Go framework to build terminal apps, based on The Elm Architecture.
- <code>&nbsp;13003</code> [termui](https://github.com/gizak/termui) - Go terminal dashboard based on **termbox-go** and inspired by <code>&nbsp;15410</code> [blessed-contrib](https://github.com/yaronn/blessed-contrib).
- <code>&nbsp;&nbsp;9674</code> [gocui](https://github.com/jroimartin/gocui) - Minimalist Go library aimed at creating Console User Interfaces.
- <code>&nbsp;&nbsp;7459</code> [lipgloss](https://github.com/charmbracelet/lipgloss) - Declaratively define styles for color, format and layout in the terminal.
- <code>&nbsp;&nbsp;5206</code> [go-prompt](https://github.com/c-bata/go-prompt) - Library for building a powerful interactive prompt, inspired by <code>&nbsp;&nbsp;8997</code> [python-prompt-toolkit](https://github.com/jonathanslenders/python-prompt-toolkit).
- <code>&nbsp;&nbsp;4874</code> [bubbles](https://github.com/charmbracelet/bubbles) - TUI components for bubbletea.
...
- <code>&nbsp;&nbsp;3852</code> [progressbar](https://github.com/schollz/progressbar) - Basic thread-safe progress bar that works in every OS.
...
- <code>&nbsp;&nbsp;&nbsp;328</code> [bubble-table](https://github.com/Evertras/bubble-table) - An interactive table component for bubbletea.
...
- <code>&nbsp;36260</code> [cobra](https://github.com/spf13/cobra) - Commander for modern Go CLI interactions.
...
- <code>&nbsp;&nbsp;5462</code> [elvish](https://github.com/elves/elvish) - An expressive programming language and a versatile interactive shell.
- <code>&nbsp;&nbsp;4056</code> [survey](https://github.com/go-survey/survey) - Build interactive and accessible prompts with full support for windows and posix terminals.
...
- <code>&nbsp;&nbsp;2514</code> [go-flags](https://github.com/jessevdk/go-flags) - go command line option parser.
...
- <code>&nbsp;&nbsp;1208</code> [ops](https://github.com/nanovms/ops) - Unikernel Builder/Orchestrator.
...
- <code>&nbsp;&nbsp;&nbsp;724</code> [carapace-bin](https://github.com/rsteube/carapace-bin) - Multi-shell multi-command argument completer.
...
- <code>&nbsp;&nbsp;&nbsp;256</code> [carapace](https://github.com/rsteube/carapace) - Command argument completion generator for spf13/cobra.
...
- <code>&nbsp;25968</code> [viper](https://github.com/spf13/viper) - Go configuration with fangs.
- <code>&nbsp;&nbsp;7636</code> [godotenv](https://github.com/joho/godotenv) - Go port of Ruby's dotenv library (Loads environment variables from `.env`).
...
- <code>&nbsp;&nbsp;2397</code> [koanf](https://github.com/knadh/koanf) - Light weight, extensible library for reading config in Go applications. Built in support for JSON, TOML, YAML, env, command line.
...
- <code>&nbsp;&nbsp;&nbsp;592</code> [xdg](https://github.com/adrg/xdg) - Go implementation of the [XDG Base Directory Specification](https://specifications.freedesktop.org/basedir-spec/basedir-spec-latest.html) and [XDG user directories](https://wiki.archlinux.org/index.php/XDG_user_directories).
...
- <code>&nbsp;31565</code> [drone](https://github.com/drone/drone) - Drone is a Continuous Integration platform built on Docker, written in Go.
- <code>&nbsp;&nbsp;4462</code> [CDS](https://github.com/ovh/cds) - Enterprise-Grade CI/CD and DevOps Automation Open Source Platform.
- <code>&nbsp;&nbsp;3743</code> [woodpecker](https://github.com/woodpecker-ci/woodpecker) - Woodpecker is a community fork of the Drone CI system.
...
- <code>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;3</code> [go-beautiful-html-coverage](https://github.com/gha-common/go-beautiful-html-coverage) - A GitHub Action to track code coverage in your pull requests, with a beautiful HTML preview, for free.
...
- <code>&nbsp;&nbsp;1269</code> [bitset](https://github.com/bits-and-blooms/bitset) - Go package implementing bitsets.
...
- <code>&nbsp;&nbsp;1584</code> [boomfilters](https://github.com/tylertreat/BoomFilters) - Probabilistic data structures for processing continuous, unbounded streams.
- <code>&nbsp;&nbsp;1076</code> [cuckoofilter](https://github.com/seiflotfy/cuckoofilter) - Cuckoo filter: a good alternative to a counting bloom filter implemented in Go.
...
- <code>&nbsp;15582</code> [gods](https://github.com/emirpasic/gods) - Go Data Structures. Containers, Sets, Lists, Stacks, Maps, BidiMaps, Trees, HashSet etc.
...
- <code>&nbsp;&nbsp;3949</code> [golang-set](https://github.com/deckarep/golang-set) - Thread-Safe and Non-Thread-Safe high-performance sets for Go.
...
- <code>&nbsp;&nbsp;9703</code> [bleve](https://github.com/blevesearch/bleve) - Modern text indexing library for go.
...
- <code>&nbsp;12748</code> [groupcache](https://github.com/golang/groupcache) - Groupcache is a caching and cache-filling library, intended as a replacement for memcached in many cases.
- <code>&nbsp;&nbsp;7233</code> [BigCache](https://github.com/allegro/bigcache) - Efficient key/value cache for gigabytes of data.
- <code>&nbsp;&nbsp;2540</code> [GCache](https://github.com/bluele/gcache) - Cache library with support for expirable Cache, LFU, LRU and ARC.
- <code>&nbsp;&nbsp;2267</code> [gocache](https://github.com/eko/gocache) - A complete Go cache library with multiple stores (memory, memcache, redis, ...), chainable, loadable, metrics cache and more.
...
- <code>&nbsp;&nbsp;2000</code> [fastcache](https://github.com/VictoriaMetrics/fastcache) - fast thread-safe inmemory cache for big number of entries. Minimizes GC overhead.
- <code>&nbsp;&nbsp;1473</code> [otter](https://github.com/maypok86/otter) - A high performance lockless cache for Go. Many times faster than Ristretto and friends.
...
- <code>&nbsp;&nbsp;&nbsp;221</code> [theine](https://github.com/Yiling-J/theine-go) - High performance, near optimal in-memory cache with proactive TTL expiration and generics.
- <code>&nbsp;&nbsp;&nbsp;174</code> [cache](https://github.com/akyoto/cache) - In-memory key:value store with expiration time, 0 dependencies, <100 LoC, 100% coverage.
...
- <code>&nbsp;53087</code> [prometheus](https://github.com/prometheus/prometheus) - Monitoring system and time series database.
- <code>&nbsp;36274</code> [tidb](https://github.com/pingcap/tidb) - TiDB is a distributed SQL database. Inspired by the design of Google F1.
- <code>&nbsp;29221</code> [cockroach](https://github.com/cockroachdb/cockroach) - Scalable, Geo-Replicated, Transactional Datastore.
- <code>&nbsp;27881</code> [influxdb](https://github.com/influxdb/influxdb) - Scalable datastore for metrics, events, and real-time analytics.
- <code>&nbsp;27230</code> [Milvus](https://github.com/milvus-io/milvus) - Milvus is a vector database for embedding management, analytics and search.
- <code>&nbsp;20096</code> [dgraph](https://github.com/dgraph-io/dgraph) - Scalable, Distributed, Low Latency, High Throughput Graph Database.
- <code>&nbsp;17096</code> [dolt](https://github.com/dolthub/dolt) - Dolt – It's Git for Data.
- <code>&nbsp;14970</code> [rqlite](https://github.com/rqlite/rqlite) - The lightweight, distributed, relational database built on SQLite.
- <code>&nbsp;13447</code> [badger](https://github.com/dgraph-io/badger) - Fast key-value store in Go.
- <code>&nbsp;10961</code> [VictoriaMetrics](https://github.com/VictoriaMetrics/VictoriaMetrics) - fast, resource-effective and scalable open source time series database. May be used as long-term remote storage for Prometheus. Supports PromQL.
...
- <code>&nbsp;&nbsp;7719</code> [bbolt](https://github.com/etcd-io/bbolt) - An embedded key/value database for Go.
- <code>&nbsp;&nbsp;6042</code> [goleveldb](https://github.com/syndtr/goleveldb) - Implementation of the <code>&nbsp;35236</code> [LevelDB](https://github.com/google/leveldb) key/value database in Go.
- <code>&nbsp;&nbsp;4407</code> [buntdb](https://github.com/tidwall/buntdb) - Fast, embeddable, in-memory key/value database for Go with custom indexing and spatial support.
- <code>&nbsp;&nbsp;4392</code> [rosedb](https://github.com/roseduan/rosedb) - An embedded k-v database based on LSM+WAL, supports string, list, hash, set, zset.
...
- <code>&nbsp;&nbsp;3358</code> [godis](https://github.com/hdt3213/godis) - A Golang implemented high-performance Redis server and cluster.
...
- <code>&nbsp;&nbsp;1969</code> [lotusdb](https://github.com/flower-corp/lotusdb) - Fast k/v database compatible with lsm and b+tree.
...
- <code>&nbsp;&nbsp;1236</code> [pogreb](https://github.com/akrylysov/pogreb) - Embedded key-value store for read-heavy workloads.
...
- <code>&nbsp;14168</code> [migrate](https://github.com/golang-migrate/migrate) - Database migrations. CLI and Golang library.
- <code>&nbsp;10213</code> [bytebase](https://github.com/bytebase/bytebase) - Safe database schema change and version control for DevOps teams.
- <code>&nbsp;&nbsp;5869</code> [goose](https://github.com/pressly/goose) - Database migration tool. You can manage your database's evolution by creating incremental SQL or Go scripts.
- <code>&nbsp;&nbsp;5118</code> [atlas](https://github.com/ariga/atlas) - A Database Toolkit. A CLI designed to help companies better work with their data.
- <code>&nbsp;&nbsp;4392</code> [dbmate](https://github.com/amacneil/dbmate) - A lightweight, framework-agnostic database migration tool.
- <code>&nbsp;&nbsp;3104</code> [sql-migrate](https://github.com/rubenv/sql-migrate) - Database migration tool. Allows embedding migrations into the application using go-bindata.
...
- <code>&nbsp;17920</code> [vitess](https://github.com/youtube/vitess) - vitess provides servers and tools which facilitate scaling of MySQL databases for large scale web services.
- <code>&nbsp;&nbsp;8313</code> [pgweb](https://github.com/sosedoff/pgweb) - Web-based PostgreSQL database browser.
...
- <code>&nbsp;&nbsp;5512</code> [orchestrator](https://github.com/github/orchestrator) - MySQL replication topology manager & visualizer.
...
- <code>&nbsp;11208</code> [sqlc](https://github.com/kyleconroy/sqlc) - Generate type-safe code from SQL.
- <code>&nbsp;&nbsp;6566</code> [Squirrel](https://github.com/Masterminds/squirrel) - Go library that helps you build SQL queries.
...
- <code>&nbsp;&nbsp;2094</code> [jet](https://github.com/go-jet/jet) - Framework for writing type-safe SQL queries in Go, with ability to easily convert database query result into desired arbitrary object structure.
...
- <code>&nbsp;&nbsp;&nbsp;679</code> [gokv](https://github.com/philippgille/gokv) - Simple key-value store abstraction and implementations for Go (Redis, Consul, etcd, bbolt, BadgerDB, LevelDB, Memcached, DynamoDB, S3, PostgreSQL, MongoDB, CockroachDB and many more).
- <code>&nbsp;&nbsp;&nbsp;183</code> [go-transaction-manager](https://github.com/avito-tech/go-transaction-manager) - Transaction manager with multiple adapters (sql, sqlx, gorm, mongo, ...) controls transaction boundaries.
...
- <code>&nbsp;14229</code> [go-sql-driver/mysql](https://github.com/go-sql-driver/mysql) - MySQL driver for Go.
- <code>&nbsp;&nbsp;9573</code> [pgx](https://github.com/jackc/pgx) - PostgreSQL driver supporting features beyond those exposed by database/sql.
- <code>&nbsp;&nbsp;8787</code> [pq](https://github.com/lib/pq) - Pure Go Postgres driver for database/sql.
- <code>&nbsp;&nbsp;7506</code> [go-sqlite3](https://github.com/mattn/go-sqlite3) - SQLite3 driver for go that uses database/sql.
...
- <code>&nbsp;&nbsp;&nbsp;&nbsp;16</code> [pig](https://github.com/alexeyco/pig) - Simple <code>&nbsp;&nbsp;9573</code> [pgx](https://github.com/jackc/pgx) wrapper to execute and <code>&nbsp;&nbsp;1202</code> [scan](https://github.com/georgysavva/scany) query results easily.

### NoSQL Database Drivers

- <code>&nbsp;19392</code> [redis](https://github.com/redis/go-redis) - Redis client for Golang.
...
- <code>&nbsp;&nbsp;2208</code> [rueidis](http://github.com/rueian/rueidis) - Fast Redis RESP3 client with auto pipelining and server-assisted client side caching.
...
- <code>&nbsp;&nbsp;1712</code> [gomemcache](https://github.com/bradfitz/gomemcache/) - memcache client library for the Go programming language.
...
- <code>&nbsp;&nbsp;4548</code> [carbon](https://github.com/golang-module/carbon) - A simple, semantic and developer-friendly golang package for datetime.
- <code>&nbsp;&nbsp;4377</code> [now](https://github.com/jinzhu/now) - Now is a time toolkit for golang.
...
- <code>&nbsp;27789</code> [go-zero](https://github.com/tal-tech/go-zero) - A web and rpc framework. It's born to ensure the stability of the busy sites with resilient design. Builtin goctl greatly improves the development productivity.
- <code>&nbsp;26176</code> [go-kit](https://github.com/go-kit/kit) - Microservice toolkit with support for service discovery, load balancing, pluggable transports, request tracking, etc.
...
- <code>&nbsp;19975</code> [grpc-go](https://github.com/grpc/grpc-go) - The Go language implementation of gRPC. HTTP/2 based RPC.
- <code>&nbsp;14881</code> [NATS](https://github.com/nats-io/gnatsd) - Lightweight, high performance messaging system for microservices, IoT, and cloud native systems.
...
- <code>&nbsp;&nbsp;7904</code> [raft](https://github.com/hashicorp/raft) - Golang implementation of the Raft consensus protocol, by HashiCorp.
...
- <code>&nbsp;&nbsp;6119</code> [lura](https://github.com/luraproject/lura) - Ultra performant API Gateway framework with middlewares.
...
- <code>&nbsp;&nbsp;3384</code> [gleam](https://github.com/chrislusf/gleam) - Fast and scalable distributed map/reduce system written in pure Go and Luajit, combining Go's high concurrency with Luajit's high performance, runs standalone or distributed.
...
- <code>&nbsp;&nbsp;2540</code> [liftbridge](https://github.com/liftbridge-io/liftbridge) - Lightweight, fault-tolerant message streams for NATS.
- <code>&nbsp;&nbsp;2032</code> [Dragonfly](https://github.com/dragonflyoss/Dragonfly2) - Provide efficient, stable and secure file distribution and image acceleration based on p2p technology to be the best practice and standard solution in cloud native architectures.
...
- <code>&nbsp;&nbsp;&nbsp;987</code> [sponge](https://github.com/zhufuyi/sponge) - A distributed development framework that integrates automatic code generation, gin and grpc frameworks, base development frameworks.
- <code>&nbsp;&nbsp;&nbsp;931</code> [rain](https://github.com/cenkalti/rain) - BitTorrent client and library.
...
- <code>&nbsp;&nbsp;&nbsp;713</code> [trpc-go](https://github.com/trpc-group/trpc-go) - The Go language implementation of tRPC, which is a pluggable, high-performance RPC framework.
...
- <code>&nbsp;&nbsp;&nbsp;370</code> [sleuth](https://github.com/ursiform/sleuth) - Library for master-less p2p auto-discovery and RPC between HTTP services (using <code>&nbsp;&nbsp;9331</code> [ZeroMQ](https://github.com/zeromq/libzmq)).
...
- <code>&nbsp;&nbsp;1449</code> [GoDNS](https://github.com/timothyye/godns) - A dynamic DNS client tool, supports DNSPod & HE.net, written in Go.
...
- <code>&nbsp;13438</code> [MailHog](https://github.com/mailhog/MailHog) - Email and SMTP testing with web and API interface.
- <code>&nbsp;&nbsp;4694</code> [Maddy](https://github.com/foxcpp/maddy) - All-in-one (SMTP, IMAP, DKIM, DMARC, MTA-STS, DANE) email server
- <code>&nbsp;&nbsp;4624</code> [Mailpit](https://github.com/axllent/mailpit) - Email and SMTP testing tool for developers.
...
- <code>&nbsp;&nbsp;1091</code> [email-verifier](https://github.com/AfterShip/email-verifier) - A Go library for email verification without sending any emails.
...
- <code>&nbsp;&nbsp;&nbsp;480</code> [go-mail](https://github.com/wneessen/go-mail) - A simple Go library for sending mails in Go.
...
- <code>&nbsp;&nbsp;6039</code> [gopher-lua](https://github.com/yuin/gopher-lua) - Lua 5.1 VM and compiler written in Go.
- <code>&nbsp;&nbsp;5658</code> [expr](https://github.com/antonmedv/expr) - Expression evaluation engine for Go: fast, non-Turing complete, dynamic typing, static typing.
- <code>&nbsp;&nbsp;4982</code> [goja](https://github.com/dop251/goja) - ECMAScript 5.1(+) implementation in Go.
- <code>&nbsp;&nbsp;3467</code> [tengo](https://github.com/d5/tengo) - Bytecode compiled script language for Go.
- <code>&nbsp;&nbsp;2950</code> [go-lua](https://github.com/Shopify/go-lua) - Port of the Lua 5.2 VM to pure Go.
...
- <code>&nbsp;&nbsp;&nbsp;736</code> [Wa/凹语言](https://github.com/wa-lang/wa) - The Wa Programming Language embedded in Go.
...
- <code>&nbsp;&nbsp;&nbsp;&nbsp;74</code> [binder](https://github.com/alexeyco/binder) - Go to Lua binding library, based on <code>&nbsp;&nbsp;6039</code> [gopher-lua](https://github.com/yuin/gopher-lua).
...
- <code>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;7</code> [starlet](https://github.com/1set/starlet) - Go wrapper for <code>&nbsp;&nbsp;2218</code> [starlark-go](https://github.com/google/starlark-go) that simplifies script execution, offers data conversion, and useful Starlark libraries and extensions.
...
- <code>&nbsp;&nbsp;2192</code> [go-multierror](https://github.com/hashicorp/go-multierror) - Go (golang) package for representing a list of errors as a single error.
...
- <code>&nbsp;&nbsp;&nbsp;176</code> [oops](https://github.com/samber/oops) - Error handling with context, stack trace and source fragments.
...
- <code>&nbsp;&nbsp;6363</code> [pdfcpu](https://github.com/pdfcpu/pdfcpu) - PDF processor.
...
- <code>&nbsp;&nbsp;&nbsp;&nbsp;21</code> [todotxt](https://github.com/1set/todotxt) - Go library for Gina Trapani's [*todo.txt*](http://todotxt.org/) files, supports parsing and manipulating of task lists in the <code>&nbsp;&nbsp;2262</code> [*todo.txt* format](https://github.com/todotxt/todo.txt).
...
- <code>&nbsp;&nbsp;5984</code> [decimal](https://github.com/shopspring/decimal) - Arbitrary-precision fixed-point decimal numbers.
- <code>&nbsp;&nbsp;4836</code> [ticker](https://github.com/achannarasappa/ticker) - Terminal stock watcher and stock position tracker.
- <code>&nbsp;&nbsp;1515</code> [go-money](https://github.com/rhymond/go-money) - Implementation of Fowler's Money pattern.
...
- <code>&nbsp;&nbsp;&nbsp;494</code> [currency](https://github.com/bojanz/currency) - Handles currency amounts, provides currency information and formatting.
...
- <code>&nbsp;&nbsp;1524</code> [nosurf](https://github.com/justinas/nosurf) - CSRF protection middleware for Go.
...
- <code>&nbsp;&nbsp;&nbsp;707</code> [form](https://github.com/go-playground/form) - Decodes url.Values into Go value(s) and Encodes Go value(s) into url.Values. Dual Array and Full map support.
...
- <code>&nbsp;&nbsp;2332</code> [mo](https://github.com/samber/mo) - Monads and popular FP abstractions, based on Go 1.18+ Generics (Option, Result, Either...).
...
- <code>&nbsp;&nbsp;9978</code> [Ebitengine](https://github.com/hajimehoshi/ebiten) - dead simple 2D game engine in Go.
- <code>&nbsp;&nbsp;5150</code> [Leaf](https://github.com/name5566/leaf) - Lightweight game server framework.
- <code>&nbsp;&nbsp;4412</code> [Pixel](https://github.com/faiface/pixel) - Hand-crafted 2D game library in Go.
- <code>&nbsp;&nbsp;2711</code> [nano](https://github.com/lonng/nano) - Lightweight, facility, high performance golang based game server framework.
- <code>&nbsp;&nbsp;2657</code> [g3n](https://github.com/g3n/engine) - Go 3D Game Engine.
- <code>&nbsp;&nbsp;2513</code> [goworld](https://github.com/xiaonanln/goworld) - Scalable game server engine, featuring space-entity framework and hot-swapping.
...
- <code>&nbsp;&nbsp;&nbsp;586</code> [go-astar](https://github.com/beefsack/go-astar) - Go implementation of the A\* path finding algorithm.
...
- <code>&nbsp;&nbsp;5290</code> [oapi-codegen](https://github.com/deepmap/oapi-codegen) - This package contains a set of utilities for generating Go boilerplate code for services based on OpenAPI 3.0 API definitions.
...
- <code>&nbsp;&nbsp;&nbsp;965</code> [GoWrap](https://github.com/hexdigest/gowrap) - Generate decorators for Go interfaces using simple templates.
- <code>&nbsp;&nbsp;&nbsp;662</code> [go-enum](https://github.com/abice/go-enum) - Code generation for enums from code comments.
- <code>&nbsp;&nbsp;&nbsp;447</code> [goverter](https://github.com/jmattheis/goverter) - Generate converters by defining an interface.
...
- <code>&nbsp;&nbsp;1641</code> [S2 geometry](https://github.com/golang/geo) - S2 geometry library in Go.
...
- <code>&nbsp;&nbsp;&nbsp;341</code> [osm](https://github.com/paulmach/osm) - Library for reading, writing and working with OpenStreetMap data and APIs.
...
- <code>&nbsp;12510</code> [gopherjs](https://github.com/gopherjs/gopherjs) - Compiler from Go to JavaScript.
...
- <code>&nbsp;12183</code> [ants](https://github.com/panjf2000/ants) - A high-performance and low-cost goroutine pool in Go.
...
- <code>&nbsp;&nbsp;3809</code> [tunny](https://github.com/Jeffail/tunny) - Goroutine pool for golang.
- <code>&nbsp;&nbsp;2777</code> [goworker](https://github.com/benmanns/goworker) - goworker is a Go-based background worker.
...
- <code>&nbsp;&nbsp;1246</code> [pond](https://github.com/alitto/pond) - Minimalistic and High-performance goroutine worker pool written in Go.
...
- <code>&nbsp;&nbsp;&nbsp;257</code> [flowmatic](https://github.com/carlmjohnson/flowmatic) - Structured concurrency made easy.
...
- <code>&nbsp;23508</code> [fyne](https://github.com/fyne-io/fyne) - Cross platform native GUIs designed for Go based on Material Design. Supports: Linux, macOS, Windows, BSD, iOS and Android.
- <code>&nbsp;12069</code> [webview](https://github.com/zserge/webview) - Cross-platform webview window with simple two-way JavaScript bindings (Windows / macOS / Linux).
...
- <code>&nbsp;&nbsp;7718</code> [app](https://github.com/murlokswarm/app) - Package to create apps with GO, HTML and CSS. Supports: MacOS, Windows in progress.
...
- <code>&nbsp;&nbsp;9312</code> [robotgo](https://github.com/go-vgo/robotgo) - Go Native cross-platform GUI system automation. Control the mouse, keyboard and other.
...
- <code>&nbsp;&nbsp;&nbsp;645</code> [zenity](https://github.com/ncruces/zenity) - Cross-platform Go library and CLI to create simple dialogs that interact graphically with the user.
...
- <code>&nbsp;&nbsp;4201</code> [arduino-cli](https://github.com/arduino/arduino-cli) - Official Arduino CLI and library. Can run standalone, or be incorporated into larger Go projects.
- <code>&nbsp;&nbsp;2143</code> [go-rpio](https://github.com/stianeikeland/go-rpio) - GPIO for Go, doesn't require cgo.
- <code>&nbsp;&nbsp;1591</code> [ghw](https://github.com/jaypipes/ghw) - Golang hardware discovery/inspection library.
...
- <code>&nbsp;&nbsp;6336</code> [gocv](https://github.com/hybridgroup/gocv) - Go package for computer vision using OpenCV 3.3+.
- <code>&nbsp;&nbsp;5349</code> [imaginary](https://github.com/h2non/imaginary) - Fast and simple HTTP microservice for image resizing.
- <code>&nbsp;&nbsp;5100</code> [imaging](https://github.com/disintegration/imaging) - Simple Go image processing package.
...
- <code>&nbsp;&nbsp;2726</code> [gowitness](https://github.com/sensepost/gowitness) - Screenshoting webpages using go and headless chrome on command line.
- <code>&nbsp;&nbsp;2565</code> [bimg](https://github.com/h2non/bimg) - Small package for fast and efficient image processing using libvips.
...
- <code>&nbsp;&nbsp;1441</code> [canvas](https://github.com/tdewolff/canvas) - Vector graphics to PDF, SVG or rasterized image.
- <code>&nbsp;&nbsp;1264</code> [geopattern](https://github.com/pravj/geopattern) - Create beautiful generative image patterns from a string.
- <code>&nbsp;&nbsp;1173</code> [stegify](https://github.com/DimitarPetrov/stegify) - Go tool for LSB steganography, capable of hiding any file within an image.
- <code>&nbsp;&nbsp;1160</code> [govips](https://github.com/davidbyttow/govips) - A lightning fast image processing and resizing library for Go.
...
- <code>&nbsp;&nbsp;4997</code> [gocron](https://github.com/go-co-op/gocron) - Easy and fluent Go job scheduling. This is an actively maintained fork of <code>&nbsp;&nbsp;3388</code> [jasonlvhit/gocron](https://github.com/jasonlvhit/gocron).
- <code>&nbsp;&nbsp;1669</code> [go-quartz](https://github.com/reugn/go-quartz) - Simple, zero-dependency scheduling library for Go.
- <code>&nbsp;&nbsp;1204</code> [Dagu](https://github.com/dagu-go/dagu) - No-code workflow executor. it executes DAGs defined in a simple YAML format.
...
- <code>&nbsp;13687</code> [GJSON](https://github.com/tidwall/gjson) - Get a JSON value with one line of code.
...
- <code>&nbsp;&nbsp;2173</code> [fastjson](https://github.com/valyala/fastjson) - Fast JSON parser and validator for Go. No custom structs, no code generation, no reflection.
...
- <code>&nbsp;24134</code> [logrus](https://github.com/Sirupsen/logrus) - Structured logger for Go.
- <code>&nbsp;21062</code> [zap](https://github.com/uber-go/zap) - Fast, structured, leveled logging in Go.
- <code>&nbsp;&nbsp;9906</code> [zerolog](https://github.com/rs/zerolog) - Zero-allocation JSON logger.
...
- <code>&nbsp;&nbsp;4645</code> [lumberjack](https://github.com/natefinch/lumberjack) - Simple rolling logger, implements io.WriteCloser.
...
- <code>&nbsp;&nbsp;&nbsp;258</code> [slog-multi](https://github.com/samber/slog-multi) - Chain of slog.Handler (pipeline, fanout...).
- <code>&nbsp;&nbsp;&nbsp;197</code> [logur](https://github.com/logur/logur) - An opinionated logger interface and collection of logging best practices with adapters and integrations for well-known libraries (<code>&nbsp;24134</code> [logrus](https://github.com/sirupsen/logrus), <code>&nbsp;26176</code> [go-kit log](https://github.com/go-kit/kit/tree/master/log), <code>&nbsp;21062</code> [zap](https://github.com/uber-go/zap), <code>&nbsp;&nbsp;9906</code> [zerolog](https://github.com/rs/zerolog), etc).
...
- <code>&nbsp;&nbsp;&nbsp;&nbsp;28</code> [logrusly](https://github.com/sebest/logrusly) - <code>&nbsp;24134</code> [logrus](https://github.com/sirupsen/logrus) plug-in to send errors to a [Loggly](https://www.loggly.com/).
...
- <code>&nbsp;&nbsp;&nbsp;&nbsp;16</code> [logrusiowriter](https://github.com/cabify/logrusiowriter) - `io.Writer` implementation using <code>&nbsp;24134</code> [logrus](https://github.com/sirupsen/logrus) logger.
...
- <code>&nbsp;&nbsp;9187</code> [GoLearn](https://github.com/sjwhitworth/golearn) - General Machine Learning library for Go.
- <code>&nbsp;&nbsp;8183</code> [gorse](https://github.com/zhenghaoz/gorse) - An offline recommender system backend based on collaborative filtering written in Go.
...
- <code>&nbsp;&nbsp;2721</code> [m2cgen](https://github.com/BayesWitnesses/m2cgen) - A CLI tool to transpile trained classic ML models into a native Go code with zero dependencies, written in Python with Go language support.
...
- <code>&nbsp;&nbsp;1545</code> [goml](https://github.com/cdipaolo/goml) - On-line Machine Learning in Go.
...
- <code>&nbsp;&nbsp;&nbsp;662</code> [ocrserver](https://github.com/otiai10/ocrserver) - A simple OCR API server, seriously easy to be deployed by Docker and Heroku.
...
- <code>&nbsp;11070</code> [sarama](https://github.com/Shopify/sarama) - Go library for Apache Kafka.
- <code>&nbsp;&nbsp;8739</code> [Asynq](https://github.com/hibiken/asynq) - A simple, reliable, and efficient distributed task queue for Go built on top of Redis.
- <code>&nbsp;&nbsp;7968</code> [Centrifugo](https://github.com/centrifugal/centrifugo) - Real-time messaging (Websockets or SockJS) server in Go.
- <code>&nbsp;&nbsp;7754</code> [gorush](https://github.com/appleboy/gorush) - Push notification server using <code>&nbsp;&nbsp;2945</code> [APNs2](https://github.com/sideshow/apns2) and google <code>&nbsp;&nbsp;&nbsp;103</code> [GCM](https://github.com/google/go-gcm).
- <code>&nbsp;&nbsp;7682</code> [Benthos](https://github.com/Jeffail/benthos) - A message streaming bridge between a range of protocols.
- <code>&nbsp;&nbsp;7329</code> [machinery](https://github.com/RichardKnop/machinery) - Asynchronous task queue/job queue based on distributed message passing.
- <code>&nbsp;&nbsp;6799</code> [Watermill](https://github.com/ThreeDotsLabs/watermill) - Working efficiently with message streams. Building event driven applications, enabling event sourcing, RPC over messages, sagas. Can use conventional pub/sub implementations like Kafka or RabbitMQ, but also HTTP or MySQL binlog.
- <code>&nbsp;&nbsp;5581</code> [go-socket.io](https://github.com/googollee/go-socket.io) - socket.io library for golang, a realtime application framework.
- <code>&nbsp;&nbsp;5194</code> [NATS Go Client](https://github.com/nats-io/nats) - Lightweight and high performance publish-subscribe and distributed queueing messaging system - this is the Go library.
- <code>&nbsp;&nbsp;4452</code> [Confluent Kafka Golang Client](https://github.com/confluentinc/confluent-kafka-go) - confluent-kafka-go is Confluent's Golang client for Apache Kafka and the Confluent Platform.
- <code>&nbsp;&nbsp;3771</code> [Mercure](https://github.com/dunglas/mercure) - Server and library to dispatch server-sent updates using the Mercure protocol (built on top of Server-Sent Events).
- <code>&nbsp;&nbsp;3580</code> [melody](https://github.com/olahol/melody) - Minimalist framework for dealing with websocket sessions, includes broadcasting and automatic ping/pong handling.
- <code>&nbsp;&nbsp;2945</code> [APNs2](https://github.com/sideshow/apns2) - HTTP/2 Apple Push Notification provider for Go — Send push notifications to iOS, tvOS, Safari and OSX apps.
...
- <code>&nbsp;&nbsp;1518</code> [Beaver](https://github.com/Clivern/Beaver) - A real time messaging server to build a scalable in-app notifications, multiplayer games, chat apps in web and mobile apps.
- <code>&nbsp;&nbsp;1337</code> [amqp](https://github.com/rabbitmq/amqp091-go) - Go RabbitMQ Client Library.
...
- <code>&nbsp;&nbsp;4210</code> [unioffice](https://github.com/unidoc/unioffice) - Pure go library for creating and processing Office Word (.docx), Excel (.xlsx) and Powerpoint (.pptx) documents.

### Microsoft Excel

*Libraries for working with Microsoft Excel.*

- <code>&nbsp;17396</code> [excelize](https://github.com/xuri/excelize) - Golang library for reading and writing Microsoft Excel&trade; (XLSX) files.
...
- <code>&nbsp;12398</code> [google/wire](https://github.com/google/wire) - Automated Initialization in Go.
...
- <code>&nbsp;&nbsp;3721</code> [dig](https://github.com/uber-go/dig) - A reflection based dependency injection toolkit for Go.
- <code>&nbsp;&nbsp;1623</code> [do](https://github.com/samber/do) - A dependency injection framework based on Generics.
...
- <code>&nbsp;&nbsp;1319</code> [pagoda](https://github.com/mikestefanello/pagoda) - Rapid, easy full-stack web development starter kit built in Go.
...
- <code>&nbsp;&nbsp;&nbsp;218</code> [gobeam/Stringy](https://github.com/gobeam/Stringy) - String manipulation library to convert string to camel case, snake case, kebab case / slugify etc.
...
- <code>&nbsp;10125</code> [gopsutil](https://github.com/shirou/gopsutil) - Cross-platform library for retrieving process and system utilization(CPU, Memory, Disks, etc).
- <code>&nbsp;&nbsp;5461</code> [gatus](https://github.com/TwinProduction/gatus) - Automated service health dashboard.
- <code>&nbsp;&nbsp;4250</code> [gofakeit](https://github.com/brianvoe/gofakeit) - Random data generator written in go.
...
- <code>&nbsp;&nbsp;1161</code> [llvm](https://github.com/llir/llvm) - Library for interacting with LLVM IR in pure Go.
...
- <code>&nbsp;&nbsp;&nbsp;873</code> [shoutrrr](https://github.com/containrrr/shoutrrr) - Notification library providing easy access to various messaging services like slack, mattermost, gotify and smtp among others.
- <code>&nbsp;&nbsp;&nbsp;795</code> [stateless](https://github.com/qmuntal/stateless) - A fluent library for creating state machines.
...
- <code>&nbsp;&nbsp;&nbsp;198</code> [gtree](https://github.com/ddddddO/gtree) - Provide CLI, Package and Web for tree output and directories creation from Markdown or programmatically.
...
- <code>&nbsp;&nbsp;2336</code> [gojieba](https://github.com/yanyiwu/gojieba) - This is a Go implementation of <code>&nbsp;32530</code> [jieba](https://github.com/fxsjy/jieba) which a Chinese word splitting algorithm.
...
- <code>&nbsp;21129</code> [fasthttp](https://github.com/valyala/fasthttp) - Package fasthttp is a fast HTTP implementation for Go, up to 10 times faster than net/http.
- <code>&nbsp;13709</code> [kcptun](https://github.com/xtaci/kcptun) - Extremely simple & fast udp tunnel based on KCP protocol.
- <code>&nbsp;12810</code> [webrtc](https://github.com/pions/webrtc) - A pure Go implementation of the WebRTC API.
- <code>&nbsp;&nbsp;9562</code> [quic-go](https://github.com/lucas-clemente/quic-go) - An implementation of the QUIC protocol in pure Go.
- <code>&nbsp;&nbsp;9156</code> [gnet](https://github.com/panjf2000/gnet) - `gnet` is a high-performance, lightweight, non-blocking, event-driven networking framework written in pure Go.
- <code>&nbsp;&nbsp;7780</code> [dns](https://github.com/miekg/dns) - Go library for working with DNS.
...
- <code>&nbsp;&nbsp;3486</code> [gobgp](https://github.com/osrg/gobgp) - BGP implemented in the Go Programming Language.
...
- <code>&nbsp;&nbsp;1370</code> [grab](https://github.com/cavaliercoder/grab) - Go package for managing file downloads.
...
- <code>&nbsp;&nbsp;1134</code> [mdns](https://github.com/hashicorp/mdns) - Simple mDNS (Multicast DNS) client/server library in Golang.
- <code>&nbsp;&nbsp;1073</code> [gosnmp](https://github.com/soniah/gosnmp) - Native Go library for performing SNMP actions.
- <code>&nbsp;&nbsp;&nbsp;997</code> [gws](https://github.com/lxzan/gws) - High-Performance WebSocket Server & Client With AsyncIO Supporting .
- <code>&nbsp;&nbsp;&nbsp;962</code> [gmqtt](https://github.com/DrmagicE/gmqtt) - Gmqtt is a flexible, high-performance MQTT broker library that fully implements the MQTT protocol V3.1.1.
...
- <code>&nbsp;&nbsp;&nbsp;353</code> [arp](https://github.com/mdlayher/arp) - Package arp implements the ARP protocol, as described in RFC 826.
...
- <code>&nbsp;&nbsp;&nbsp;&nbsp;81</code> [natiu-mqtt](https://github.com/soypat/natiu-mqtt) - A dead-simple, non-allocating, low level implementation of MQTT well suited for embedded systems.
...
- <code>&nbsp;&nbsp;9430</code> [resty](https://github.com/go-resty/resty) - Simple HTTP and REST client for Go inspired by Ruby rest-client.
- <code>&nbsp;&nbsp;4037</code> [req](https://github.com/imroc/req) - Simple Go HTTP client with Black Magic (Less code and More efficiency).
...
- <code>&nbsp;35643</code> [GORM](https://github.com/go-gorm/gorm) - The fantastic ORM library for Golang, aims to be developer friendly.
- <code>&nbsp;14999</code> [ent](https://github.com/facebook/ent) - An entity framework for Go. Simple, yet powerful ORM for modeling and querying data.
...
- <code>&nbsp;&nbsp;3184</code> [bun](https://github.com/uptrace/bun) - SQL-first Golang ORM. Successor of go-pg.
- <code>&nbsp;&nbsp;2320</code> [gormt](https://github.com/xxjwxc/gormt) - Mysql database to golang gorm struct.
- <code>&nbsp;&nbsp;1966</code> [Prisma](https://github.com/prisma/prisma-client-go) - Prisma Client Go, Typesafe database access for Go.
...
- <code>&nbsp;&nbsp;&nbsp;272</code> [gup](https://github.com/nao1215/gup) - Update binaries installed by "go install".
...
- <code>&nbsp;19589</code> [jaeger](https://github.com/jaegertracing/jaeger) - A distributed tracing system.
- <code>&nbsp;&nbsp;5314</code> [pixie](https://github.com/pixie-labs/pixie) - No instrumentation tracing for Golang applications via eBPF.
- <code>&nbsp;&nbsp;3138</code> [statsviz](https://github.com/arl/statsviz) - Live visualization of your Go application runtime statistics.
- <code>&nbsp;&nbsp;1965</code> [profile](https://github.com/pkg/profile) - Simple profiling support package for Go.
...
- <code>&nbsp;&nbsp;9756</code> [graphql-go](https://github.com/graphql-go/graphql) - Implementation of GraphQL for Go.
- <code>&nbsp;&nbsp;9677</code> [gqlgen](https://github.com/99designs/gqlgen) - go generate based graphql server library.
...
- <code>&nbsp;&nbsp;7297</code> [gonum](https://github.com/gonum/gonum) - Gonum is a set of numeric libraries for the Go programming language. It contains libraries for matrices, statistics, optimization, and more.
...
- <code>&nbsp;15436</code> [age](https://github.com/FiloSottile/age) - A simple, modern and secure encryption tool (and Go library) with small explicit keys, no config options, and UNIX-style composability.
...
- <code>&nbsp;&nbsp;3907</code> [Cameradar](https://github.com/Ullaakut/cameradar) - Tool and library to remotely hack RTSP streams from surveillance cameras.
- <code>&nbsp;&nbsp;2489</code> [memguard](https://github.com/awnumar/memguard) - A pure Go library for handling sensitive values in memory.
- <code>&nbsp;&nbsp;2222</code> [secure](https://github.com/unrolled/secure) - HTTP middleware for Go that facilitates some quick security wins.
- <code>&nbsp;&nbsp;2029</code> [acmetool](https://github.com/hlandau/acme) - ACME (Let's Encrypt) client tool with automatic renewal.
...
- <code>&nbsp;&nbsp;1301</code> [acra](https://github.com/cossacklabs/acra) - Network encryption proxy to protect database-based applications from data leaks: strong selective encryption, SQL injections prevention, intrusion detection system.
...
- <code>&nbsp;&nbsp;&nbsp;466</code> [booster](https://github.com/anatol/booster) - Fast initramfs generator with full-disk encryption support.
...
- <code>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;3</code> [multikey](https://github.com/adrianosela/multikey) - An n-out-of-N keys encryption/decryption framework based on Shamir's Secret Sharing algorithm.
...
- <code>&nbsp;13103</code> [jsoniter](https://github.com/json-iterator/go) - High-performance 100% compatible drop-in replacement of "encoding/json".
...
- <code>&nbsp;&nbsp;7721</code> [mapstructure](https://github.com/mitchellh/mapstructure) - Go library for decoding generic map values into native Go structures.
...
- <code>&nbsp;&nbsp;&nbsp;895</code> [csvutil](https://github.com/jszwec/csvutil) - High Performance, idiomatic CSV record encoding and decoding to native Go structures.
- <code>&nbsp;&nbsp;&nbsp;733</code> [colfer](https://github.com/pascaldekloe/colfer) - Code generation for the Colfer binary format.
- <code>&nbsp;&nbsp;&nbsp;667</code> [cbor](https://github.com/fxamacker/cbor) - Small, safe, and easy CBOR encoding and decoding library.
...
- <code>&nbsp;54327</code> [Caddy](https://github.com/caddyserver/caddy) - Caddy is an alternative, HTTP/2 web server that's easy to configure and use.
- <code>&nbsp;46523</code> [etcd](https://github.com/etcd-io/etcd) - Highly-available key value store for shared configuration and service discovery.
- <code>&nbsp;44577</code> [minio](https://github.com/minio/minio) - Minio is a distributed object storage server.
- <code>&nbsp;&nbsp;8264</code> [SFTPGo](https://github.com/drakkan/sftpgo) - Fully featured and highly configurable SFTP server with optional FTP/S and WebDAV support. It can serve local filesystem and Cloud Storage backends such as S3 and Google Cloud Storage.
...
- <code>&nbsp;&nbsp;5709</code> [Easegress](https://github.com/megaease/easegress) - A cloud native high availability/performance traffic orchestration system with observability and extensibility.
...
- <code>&nbsp;&nbsp;3102</code> [Wish](https://github.com/charmbracelet/wish) - Make SSH apps, just like that!
- <code>&nbsp;&nbsp;2677</code> [Fider](https://github.com/getfider/fider) - Fider is an open platform to collect and organize customer feedback.
- <code>&nbsp;&nbsp;2664</code> [algernon](https://github.com/xyproto/algernon) - HTTP/2 web server with built-in support for Lua, Markdown, GCSS and Amber.
...
- <code>&nbsp;&nbsp;1091</code> [go-feature-flag](https://github.com/thomaspoignant/go-feature-flag) - A simple, complete and lightweight self-hosted feature flag solution 100% Open Source.
...
- <code>&nbsp;&nbsp;6658</code> [templ](https://github.com/a-h/templ) - A HTML templating language that has great developer tooling.
...
- <code>&nbsp;&nbsp;1462</code> [maroto](https://github.com/johnfercher/maroto) - A maroto way to create PDFs. Maroto is inspired in Bootstrap and uses gofpdf. Fast and simple.
...
- Testing Frameworks
  ...
  - <code>&nbsp;22173</code> [Testify](https://github.com/stretchr/testify) - Sacred extension to the standard go testing package.
  - <code>&nbsp;&nbsp;8123</code> [GoConvey](https://github.com/smartystreets/goconvey/) - BDD-style framework with web UI and live reload.
  - <code>&nbsp;&nbsp;4003</code> [go-cmp](https://github.com/google/go-cmp) - Package for comparing Go values in tests.
  ...
  - <code>&nbsp;&nbsp;1725</code> [is](https://github.com/matryer/is) - Professional lightweight testing mini-framework for Go.
...
- Mock
  ...
  - <code>&nbsp;&nbsp;5871</code> [go-sqlmock](https://github.com/DATA-DOG/go-sqlmock) - Mock SQL driver for testing database interactions.
  - <code>&nbsp;&nbsp;5693</code> [mockery](https://github.com/vektra/mockery) - Tool to generate Go interfaces.
  ...
  - <code>&nbsp;&nbsp;&nbsp;201</code> [xgo](https://github.com/xhd2015/xgo) - A general pureposed function mocking library.
...
- Selenium and browser control tools.
  ...
  - <code>&nbsp;10445</code> [chromedp](https://github.com/knq/chromedp) - a way to drive/test Chrome, Safari, Edge, Android Webviews, and other browsers supporting the Chrome Debugging Protocol.
  - <code>&nbsp;&nbsp;4857</code> [rod](https://github.com/go-rod/rod) - A Devtools driver to make web automation and scraping easy.
  ...
  - <code>&nbsp;&nbsp;1822</code> [playwright-go](https://github.com/mxschmitt/playwright-go) - browser automation library to control Chromium, Firefox and WebKit with a single API.
...
- <code>&nbsp;&nbsp;4453</code> [toml](https://github.com/BurntSushi/toml) - TOML configuration format (encoder/decoder with reflection).
- <code>&nbsp;&nbsp;3381</code> [goldmark](https://github.com/yuin/goldmark) - A Markdown parser written in Go. Easy to extend, standard (CommonMark) compliant, well structured.
...
- <code>&nbsp;&nbsp;&nbsp;730</code> [html-to-markdown](https://github.com/JohannesKaufmann/html-to-markdown) - Convert HTML to Markdown. Even works with entire websites and can be extended through rules.
...
- <code>&nbsp;&nbsp;&nbsp;611</code> [mxj](https://github.com/clbanning/mxj) - Encode / decode XML as JSON or map[string]interface{}; extract values with dot-notation paths and wildcards. Replaces x2j and j2x packages.
...
- <code>&nbsp;&nbsp;6842</code> [sh](https://github.com/mvdan/sh) - Shell parser and formatter.
- <code>&nbsp;&nbsp;2480</code> [gofeed](https://github.com/mmcdole/gofeed) - Parse RSS and Atom feeds in Go.
...
- <code>&nbsp;&nbsp;&nbsp;185</code> [rex](https://github.com/hedhyw/rex) - Regular expressions builder.
...
- <code>&nbsp;22318</code> [colly](https://github.com/asciimoo/colly) - Fast and Elegant Scraping Framework for Gophers.
- <code>&nbsp;13616</code> [GoQuery](https://github.com/PuerkitoBio/goquery) - GoQuery brings a syntax and a set of features similar to jQuery to the Go language.
...
- <code>&nbsp;&nbsp;8327</code> [go-openai](https://github.com/sashabaranov/go-openai) - OpenAI ChatGPT, DALL·E, Whisper API library for Go.
- <code>&nbsp;&nbsp;4781</code> [discordgo](https://github.com/bwmarrin/discordgo) - Go bindings for the Discord Chat API.
...
- <code>&nbsp;&nbsp;3621</code> [google-cloud](https://github.com/GoogleCloudPlatform/gcloud-golang) - Google Cloud APIs Go Client Library.
- <code>&nbsp;&nbsp;2419</code> [aws-sdk-go](https://github.com/aws/aws-sdk-go-v2) - The official AWS SDK for the Go programming language.
...
- <code>&nbsp;&nbsp;&nbsp;934</code> [webhooks](https://github.com/go-playground/webhooks) - Webhook receiver for GitHub and Bitbucket.
...
- <code>&nbsp;60364</code> [fzf](https://github.com/junegunn/fzf) - Command-line fuzzy finder written in Go.
- <code>&nbsp;43882</code> [dive](https://github.com/wagoodman/dive) - A tool for exploring each layer in a Docker image.
...
- <code>&nbsp;15597</code> [air](https://github.com/cosmtrek/air) - Air - Live reload for Go apps.
- <code>&nbsp;15543</code> [lo](https://github.com/samber/lo) - A Lodash like Go library based on Go 1.18+ Generics (map, filter, contains, find...)
- <code>&nbsp;15488</code> [sqlx](https://github.com/jmoiron/sqlx) - provides a set of extensions on top of the excellent built-in database/sql package.
- <code>&nbsp;15199</code> [ctop](https://github.com/bcicen/ctop) - [Top-like](https://ctop.sh) interface (e.g. htop) for container metrics.
- <code>&nbsp;13150</code> [goreleaser](https://github.com/goreleaser/goreleaser) - Deliver Go binaries as fast and easily as possible.
...
- <code>&nbsp;&nbsp;3608</code> [minify](https://github.com/tdewolff/minify) - Fast minifiers for HTML, CSS, JS, XML, JSON and SVG file formats.
...
- <code>&nbsp;&nbsp;&nbsp;781</code> [upterm](https://github.com/owenthereal/upterm) - A tool for developers to share terminal/tmux sessions securely over the web. It’s perfect for remote pair programming, accessing computers behind NATs/firewalls, remote debugging, and more.
...
- <code>&nbsp;&nbsp;&nbsp;148</code> [cmd](https://github.com/SimonBaeumer/cmd) - Library for executing shell commands on osx, windows and linux.
...
- <code>&nbsp;&nbsp;&nbsp;&nbsp;20</code> [just](https://github.com/kazhuravlev/just) - Just a collection of useful functions for working with generic data structures.
...
- <code>&nbsp;&nbsp;4190</code> [ulid](https://github.com/oklog/ulid) - Go implementation of ULID (Universally Unique Lexicographically Sortable Identifier).
- <code>&nbsp;&nbsp;3770</code> [xid](https://github.com/rs/xid) - Xid is a globally unique id generator library, ready to be safely used directly in your server code.
- <code>&nbsp;&nbsp;1520</code> [uuid](https://github.com/gofrs/uuid) - Implementation of Universally Unique Identifier (UUID). Supports both creation and parsing of UUIDs. Actively maintained fork of satori uuid.
...
- <code>&nbsp;15722</code> [validator](https://github.com/go-playground/validator) - Go Struct and Field validation, including Cross Field, Cross Struct, Map, Slice and Array diving.
...
- <code>&nbsp;&nbsp;3585</code> [ozzo-validation](https://github.com/go-ozzo/ozzo-validation) - Supports validation of various data types (structs, strings, maps, slices, etc.) with configurable and extensible validation rules specified in usual code constructs instead of struct tags.
...
- <code>&nbsp;&nbsp;&nbsp;105</code> [jio](https://github.com/faceair/jio) - jio is a json schema validator similar to <code>&nbsp;20637</code> [joi](https://github.com/hapijs/joi).
...
- <code>&nbsp;&nbsp;5539</code> [go-git](https://github.com/go-git/go-git) - highly extensible Git implementation in pure Go.
- <code>&nbsp;&nbsp;2018</code> [hercules](https://github.com/src-d/hercules) - gaining advanced insights from Git repository history.
- <code>&nbsp;&nbsp;1913</code> [git2go](https://github.com/libgit2/git2go) - Go bindings for libgit2.
...
- <code>&nbsp;75830</code> [Gin](https://github.com/gin-gonic/gin) - Gin is a web framework written in Go! It features a martini-like API with much better performance, up to 40 times faster. If you need performance and good productivity.
- <code>&nbsp;31623</code> [Fiber](https://github.com/gofiber/fiber) - An Express.js inspired web framework build on Fasthttp.
...
- <code>&nbsp;28648</code> [Echo](https://github.com/labstack/echo) - High performance, minimalist Go web framework.
- <code>&nbsp;13090</code> [Revel](https://github.com/revel/revel) - High-productivity web framework for the Go language.
- <code>&nbsp;10942</code> [GoFrame](https://github.com/gogf/gf) - GoFrame is a modular, powerful, high-performance and enterprise-class application development framework of Golang.
...
- <code>&nbsp;&nbsp;4761</code> [Hertz](https://github.com/cloudwego/hertz) - A high-performance and strong-extensibility Go HTTP framework that helps developers build microservices.
...
- <code>&nbsp;&nbsp;3482</code> [Macaron](https://github.com/go-macaron/macaron) - Macaron is a high productive and modular design web framework in Go.
...
- <code>&nbsp;&nbsp;1409</code> [Huma](https://github.com/danielgtaylor/huma/) - Framework for modern REST/GraphQL APIs with built-in OpenAPI 3, generated documentation, and a CLI.
...
- <code>&nbsp;&nbsp;1066</code> [GoFr](https://github.com/gofr-dev/gofr) - Gofr is an opinionated microservice development framework.
...
- <code>&nbsp;&nbsp;&nbsp;189</code> [Yokai](https://github.com/ankorstore/yokai) - Simple, modular, and observable Go framework for backend applications.
...
- <code>&nbsp;&nbsp;2558</code> [CORS](https://github.com/rs/cors) - Easily add CORS capabilities to your API.
- <code>&nbsp;&nbsp;1968</code> [Limiter](https://github.com/ulule/limiter) - Dead simple rate limit middleware for Go.
...
- <code>&nbsp;&nbsp;3006</code> [alice](https://github.com/justinas/alice) - Painless middleware chaining for Go.
- <code>&nbsp;&nbsp;1907</code> [render](https://github.com/unrolled/render) - Go package for easily rendering JSON, XML, and HTML template responses.
...
- <code>&nbsp;20242</code> [mux](https://github.com/gorilla/mux) - Powerful URL router and dispatcher for golang.
- <code>&nbsp;17251</code> [chi](https://github.com/go-chi/chi) - Small, fast and expressive HTTP router built on net/context.
...
- <code>&nbsp;14566</code> [tinygo](https://github.com/tinygo-org/tinygo) - Go compiler for small places. Microcontrollers, WebAssembly, and command-line tools. Based on LLVM.
...
- <code>&nbsp;&nbsp;&nbsp;734</code> [zek](https://github.com/miku/zek) - Generate a Go struct from XML.
...
- <code>&nbsp;&nbsp;4129</code> [Cosign](https://github.com/sigstore/cosign) - Container Signing, Verification and Storage in an OCI registry.
- <code>&nbsp;&nbsp;1683</code> [Spire](https://github.com/spiffe/spire) - SPIRE (the SPIFFE Runtime Environment) is a toolchain of APIs for establishing trust between software systems across a wide variety of hosting platforms.
...
- <code>&nbsp;14572</code> [golangci-lint](https://github.com/golangci/golangci-lint) – A fast Go linters runner. It runs linters in parallel, uses caching, supports `yaml` config, has integrations with all major IDE and has dozens of linters included.
...
- <code>&nbsp;&nbsp;&nbsp;840</code> [golines](https://github.com/segmentio/golines) - Formatter that automatically shortens long lines in Go code.
...
- <code>&nbsp;&nbsp;&nbsp;&nbsp;78</code> [testifylint](https://github.com/Antonboom/testifylint) – A linter that checks usage of <code>&nbsp;22173</code> [github.com/stretchr/testify](https://github.com/stretchr/testify).
...
- <code>&nbsp;&nbsp;1700</code> [genny](https://github.com/cheekybits/genny) - Elegant generics for Go.
...
- <code>&nbsp;&nbsp;9302</code> [go-swagger](https://github.com/go-swagger/go-swagger) - Swagger 2.0 implementation for go. Swagger is a simple yet powerful representation of your RESTful API.
- <code>&nbsp;&nbsp;5760</code> [go-callvis](https://github.com/TrueFurby/go-callvis) - Visualize call graph of your Go program using dot format.
...
- <code>&nbsp;&nbsp;&nbsp;459</code> [go-size-analyzer](https://github.com/Zxilly/go-size-analyzer) - Analyze and visualize the size of dependencies in compiled Golang binaries, providing insight into their impact on the final build.
...
- <code>107262</code> [kubernetes](https://github.com/kubernetes/kubernetes) - Container Cluster Manager from Google.
- <code>&nbsp;67831</code> [Moby](https://github.com/moby/moby) - Collaborative project for the container ecosystem to assemble container-based systems.
- <code>&nbsp;48316</code> [traefik](https://github.com/containous/traefik) - Reverse proxy and load balancer with support for multiple backends.
- <code>&nbsp;42329</code> [Gitea](https://github.com/go-gitea/gitea) - Fork of Gogs, entirely community driven.
- <code>&nbsp;28474</code> [minikube](https://github.com/kubernetes/minikube) - Run Kubernetes locally.
- <code>&nbsp;26628</code> [k3s](https://github.com/k3s-io/k3s) - Lightweight Kubernetes.
- <code>&nbsp;23551</code> [k6](https://github.com/grafana/k6) - A modern load testing tool, using Go and JavaScript.
- <code>&nbsp;22813</code> [Vegeta](https://github.com/tsenart/vegeta) - HTTP load testing tool and library. It's over 9000!
- <code>&nbsp;17356</code> [Hey](https://github.com/rakyll/hey) - Hey is a tiny program that sends some load to a web application.
...
- <code>&nbsp;12847</code> [kind](https://github.com/kubernetes-sigs/kind) - Kubernetes IN Docker - local clusters for testing Kubernetes.
- <code>&nbsp;10601</code> [kubeshark](https://github.com/kubeshark/kubeshark) - API traffic analyzer for Kubernetes, inspired by Wireshark, purposely built for Kubernetes.
- <code>&nbsp;&nbsp;9920</code> [webhook](https://github.com/adnanh/webhook) - Tool which allows user to create HTTP endpoints (hooks) that execute commands on the server.
- <code>&nbsp;&nbsp;9697</code> [GVM](https://github.com/moovweb/gvm) - GVM provides an interface to manage Go versions.
- <code>&nbsp;&nbsp;8526</code> [Flannel](https://github.com/flannel-io/flannel) - Flannel is a network fabric for containers, designed for Kubernetes.
...
- <code>&nbsp;&nbsp;5320</code> [bombardier](https://github.com/codesenberg/bombardier) - Fast cross-platform HTTP benchmarking tool.
- <code>&nbsp;&nbsp;5168</code> [gaia](https://github.com/gaia-pipeline/gaia) - Build powerful pipelines in any programming language.
- <code>&nbsp;&nbsp;5120</code> [script](https://github.com/bitfield/script) - Making it easy to write shell-like scripts in Go for DevOps and system administration tasks.
- <code>&nbsp;&nbsp;5118</code> [k3d](https://github.com/k3d-io/k3d) - Little helper to run CNCF's k3s in Docker.
...
- <code>&nbsp;&nbsp;1468</code> [ghorg](https://github.com/gabrie30/ghorg) - Quickly clone an entire org/users repositories into one directory - Supports GitHub, GitLab, Gitea, and Bitbucket.
- <code>&nbsp;&nbsp;1432</code> [go-selfupdate](https://github.com/sanbornm/go-selfupdate) - Enable your Go applications to self update.
...
- <code>&nbsp;26429</code> [croc](https://github.com/schollz/croc) - Easily and securely send files or folders from one computer to another.
- <code>&nbsp;23987</code> [restic](https://github.com/restic/restic) - De-duplicating backup program.
- <code>&nbsp;21245</code> [Seaweed File System](https://github.com/chrislusf/seaweedfs) - Fast, Simple and Scalable Distributed File System with O(1) disk seek.
...
- <code>&nbsp;10356</code> [toxiproxy](https://github.com/shopify/toxiproxy) - Proxy to simulate network and system conditions for automated tests.
- <code>&nbsp;10235</code> [Comcast](https://github.com/tylertreat/Comcast) - Simulate bad network connections.
...
- <code>&nbsp;&nbsp;7465</code> [LiteIDE](https://github.com/visualfc/liteide) - LiteIDE is a simple, open source, cross-platform Go IDE.
- <code>&nbsp;&nbsp;6638</code> [drive](https://github.com/odeke-em/drive) - Google Drive client for the commandline.
- <code>&nbsp;&nbsp;6171</code> [scc](https://github.com/boyter/scc) - Sloc Cloc and Code, a very fast accurate code counter with complexity calculations and COCOMO estimates.
- <code>&nbsp;&nbsp;5375</code> [nes](https://github.com/fogleman/nes) - Nintendo Entertainment System (NES) emulator written in Go.
- <code>&nbsp;&nbsp;5031</code> [Duplicacy](https://github.com/gilbertchen/duplicacy) - A cross-platform network and cloud backup tool based on the idea of lock-free deduplication.
- <code>&nbsp;&nbsp;4258</code> [blocky](https://github.com/0xERR0R/blocky) - Fast and lightweight DNS proxy as ad-blocker for local network with many features.
...
- <code>&nbsp;&nbsp;1393</code> [Plik](https://github.com/root-gg/plik) - Plik is a temporary file upload system (Wetransfer like) in Go.
...
- <code>&nbsp;&nbsp;1029</code> [Gokapi](https://github.com/Forceu/gokapi) - Lightweight server to share files, which expire after a set amount of downloads or days. Similar to Firefox Send, but without public upload.
...
- <code>&nbsp;&nbsp;&nbsp;443</code> [GoNB](https://github.com/janpfeifer/gonb) - Interactive Go programming with Jupyter Notebooks (also works in VSCode, Binder and Google's Colab).
...
- <code>&nbsp;&nbsp;1533</code> [go_serialization_benchmarks](https://github.com/alecthomas/go_serialization_benchmarks) - Benchmarks of Go serialization methods.
...
- <code>&nbsp;16102</code> [GoBooks](https://github.com/dariubs/GoBooks) - A curated list of Go books.
...
- <code>&nbsp;&nbsp;3367</code> [gophers](https://github.com/egonelbre/gophers) - Free gophers.
- <code>&nbsp;&nbsp;3305</code> [Free Gophers Pack](https://github.com/MariaLetta/free-gophers-pack) - Gopher graphics pack by Maria Letta with illustrations and emotional characters in vector and raster.
...
- <code>&nbsp;29221</code> [CockroachDB](https://github.com/cockroachdb/cockroach/blob/master/docs/style.md)
- <code>&nbsp;15427</code> [Hyperledger](https://github.com/hyperledger/fabric/blob/release-1.4/docs/source/style-guides/go-style.rst)
- <code>&nbsp;15301</code> [Uber](https://github.com/uber-go/guide/blob/master/style.md)
...
- <code>120136</code> [Go Projects](https://github.com/golang/go/wiki/Projects) - List of projects on the Go community wiki.
- <code>&nbsp;31325</code> [awesome-awesomeness](https://github.com/bayandin/awesome-awesomeness) - List of other amazingly awesome lists.
- <code>&nbsp;28294</code> [Awesome Remote Job](https://github.com/lukasz-madon/awesome-remote-job) - Curated list of awesome remote jobs. A lot of them are looking for Go hackers.
...
- <code>&nbsp;24226</code> [go-patterns](https://github.com/tmrts/go-patterns) - Curated list of Go design patterns, recipes and idioms.
- <code>&nbsp;21358</code> [Learn Go with TDD](https://github.com/quii/learn-go-with-tests) - Learn Go with test-driven development.
- <code>&nbsp;18409</code> [Learn Go with 1000+ Exercises](https://github.com/inancgumus/learngo) - Learn Go with thousands of examples, exercises, and quizzes.
...
- <code>&nbsp;&nbsp;4525</code> [Golang for Node.js Developers](https://github.com/miguelmota/golang-for-nodejs-developers) - Examples of Golang compared to Node.js for learning.
