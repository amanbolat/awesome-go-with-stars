...
- <code>&nbsp;&nbsp;5265</code> [ProtoActor](https://github.com/asynkron/protoactor-go) - Proto Actor - Ultra fast distributed actors for Go, C# and Java/Kotlin.
- <code>&nbsp;&nbsp;4024</code> [Ergo](https://github.com/ergo-services/ergo) - An actor-based Framework with network transparency for creating event-driven architecture in Golang. Inspired by Erlang.
- <code>&nbsp;&nbsp;1981</code> [Hollywood](https://github.com/anthdm/hollywood) - Blazingly fast and light-weight Actor engine written in Golang.
...
- <code>146350</code> [Ollama](https://github.com/jmorganca/ollama) - Run large language models locally.
- <code>&nbsp;33816</code> [LocalAI](https://github.com/mudler/LocalAI) - Open Source OpenAI alternative, self-host AI models.
- <code>&nbsp;&nbsp;7116</code> [langchaingo](https://github.com/tmc/langchaingo) - LangChainGo is a framework for developing applications powered by language models.
...
- <code>&nbsp;&nbsp;&nbsp;342</code> [malgo](https://github.com/gen2brain/malgo) - Mini audio library.
...
- <code>&nbsp;18867</code> [casbin](https://github.com/hsluoyz/casbin) - Authorization library that supports access control models like ACL, RBAC, and ABAC.
- <code>&nbsp;&nbsp;8247</code> [jwt-go](https://github.com/golang-jwt/jwt) - A full featured implementation of JSON Web Tokens (JWT). This library supports the parsing and verification as well as the generation and signing of JWTs.
- <code>&nbsp;&nbsp;6097</code> [goth](https://github.com/markbates/goth) - provides a simple, clean, and idiomatic way to use OAuth and OAuth2. Handles multiple providers out of the box.
- <code>&nbsp;&nbsp;5642</code> [oauth2](https://github.com/golang/oauth2) - Successor of goauth2. Generic OAuth 2.0 package that comes with JWT, Google APIs, Compute Engine, and App Engine support.
- <code>&nbsp;&nbsp;5064</code> [keto](https://github.com/ory/keto) - Open Source (Go) implementation of "Zanzibar: Google's Consistent, Global Authorization System". Ships gRPC, REST APIs, newSQL, and an easy and granular permission language. Supports ACL, RBAC, and other access models.
- <code>&nbsp;&nbsp;3993</code> [authboss](https://github.com/volatiletech/authboss) - Modular authentication system for the web. It tries to remove as much boilerplate and "hard things" as possible so that each time you start a new web project in Go, you can plug it in, configure it, and start building your app without having to build an authentication system each time.
- <code>&nbsp;&nbsp;3841</code> [openfga](https://github.com/openfga/openfga) - Implementation of fine-grained authorization based on the "Zanzibar: Google's Consistent, Global Authorization System" paper. Backed by [CNCF](https://www.cncf.io/).
...
- <code>&nbsp;&nbsp;1926</code> [loginsrv](https://github.com/tarent/loginsrv) - JWT login microservice with pluggable backends such as OAuth2 (Github), htpasswd, osiam.
...
- <code>&nbsp;&nbsp;1606</code> [oidc](https://github.com/zitadel/oidc) - Easy to use OpenID Connect client and server library written for Go and certified by the OpenID Foundation
...
- <code>&nbsp;49277</code> [go-ethereum](https://github.com/ethereum/go-ethereum) - Official Go implementation of the Ethereum protocol.
- <code>&nbsp;16566</code> [kubo](https://github.com/ipfs/kubo) - A blockchain framework implemented in Go. It provides content-addressable storage which can be used for decentralized storage in DApps. It is based on the IPFS protocol.
- <code>&nbsp;&nbsp;7970</code> [lnd](https://github.com/lightningnetwork/lnd) - A complete implementation of a Lightning Network node.
- <code>&nbsp;&nbsp;6652</code> [cosmos-sdk](https://github.com/cosmos/cosmos-sdk) - A Framework for Building Public Blockchains in the Cosmos Ecosystem.
- <code>&nbsp;&nbsp;5815</code> [tendermint](https://github.com/tendermint/tendermint) - High-performance middleware for transforming a state machine written in any programming language into a Byzantine Fault Tolerant replicated state machine using the Tendermint consensus and blockchain protocols.
...
- <code>&nbsp;&nbsp;4387</code> [telebot](https://github.com/tucnak/telebot) - Telegram bot framework is written in Go.
- <code>&nbsp;&nbsp;2001</code> [wayback](https://github.com/wabarc/wayback) - A bot for Telegram, Mastodon, Slack, and other messaging platforms archives webpages.
...
- <code>&nbsp;21011</code> [air](https://github.com/cosmtrek/air) - Air - Live reload for Go apps.
- <code>&nbsp;13112</code> [Task](https://github.com/go-task/task) - simple "Make" alternative.
...
- <code>&nbsp;33131</code> [bubbletea](https://github.com/charmbracelet/bubbletea) - Go framework to build terminal apps, based on The Elm Architecture.
- <code>&nbsp;19666</code> [fx](https://github.com/antonmedv/fx) - Terminal JSON viewer & processor.
- <code>&nbsp;13383</code> [termui](https://github.com/gizak/termui) - Go terminal dashboard based on **termbox-go** and inspired by <code>&nbsp;15620</code> [blessed-contrib](https://github.com/yaronn/blessed-contrib).
- <code>&nbsp;10288</code> [gocui](https://github.com/jroimartin/gocui) - Minimalist Go library aimed at creating Console User Interfaces.
- <code>&nbsp;&nbsp;9249</code> [lipgloss](https://github.com/charmbracelet/lipgloss) - Declaratively define styles for color, format and layout in the terminal.
- <code>&nbsp;&nbsp;6566</code> [bubbles](https://github.com/charmbracelet/bubbles) - TUI components for bubbletea.
- <code>&nbsp;&nbsp;5384</code> [go-prompt](https://github.com/c-bata/go-prompt) - Library for building a powerful interactive prompt, inspired by <code>&nbsp;&nbsp;9818</code> [python-prompt-toolkit](https://github.com/jonathanslenders/python-prompt-toolkit).
- <code>&nbsp;&nbsp;5157</code> [pterm](https://github.com/pterm/pterm) - A library to beautify console output on every platform with many combinable components.
- <code>&nbsp;&nbsp;4731</code> [termbox-go](https://github.com/nsf/termbox-go) - Termbox is a library for creating cross-platform text-based interfaces.
- <code>&nbsp;&nbsp;4436</code> [progressbar](https://github.com/schollz/progressbar) - Basic thread-safe progress bar that works in every OS.
- <code>&nbsp;&nbsp;2848</code> [asciigraph](https://github.com/guptarohit/asciigraph) - Go package to make lightweight ASCII line graph ╭┈╯ in command line apps with no other dependencies.
- <code>&nbsp;&nbsp;2847</code> [termdash](https://github.com/mum4k/termdash) - Go terminal dashboard based on **termbox-go** and inspired by <code>&nbsp;13383</code> [termui](https://github.com/gizak/termui).
- <code>&nbsp;&nbsp;2443</code> [spinner](https://github.com/briandowns/spinner) - Go package to easily provide a terminal spinner with options.
- <code>&nbsp;&nbsp;2416</code> [mpb](https://github.com/vbauerster/mpb) - Multi progress bar for terminal applications.
...
- <code>&nbsp;&nbsp;&nbsp;505</code> [bubble-table](https://github.com/Evertras/bubble-table) - An interactive table component for bubbletea.
...
- <code>&nbsp;41100</code> [cobra](https://github.com/spf13/cobra) - Commander for modern Go CLI interactions.
- <code>&nbsp;23337</code> [urfave/cli](https://github.com/urfave/cli) - Simple, fast, and fun package for building command line apps in Go (formerly codegangsta/cli).
...
- <code>&nbsp;&nbsp;2887</code> [Dnote](https://github.com/dnote/dnote) - A simple command line notebook with multi-device sync.
...
- <code>&nbsp;&nbsp;1366</code> [ops](https://github.com/nanovms/ops) - Unikernel Builder/Orchestrator.
- <code>&nbsp;&nbsp;1344</code> [carapace-bin](https://github.com/rsteube/carapace-bin) - Multi-shell multi-command argument completer.
...
- <code>&nbsp;&nbsp;&nbsp;738</code> [carapace](https://github.com/rsteube/carapace) - Command argument completion generator for spf13/cobra.
...
- <code>&nbsp;28848</code> [viper](https://github.com/spf13/viper) - Go configuration with fangs.
- <code>&nbsp;&nbsp;9511</code> [godotenv](https://github.com/joho/godotenv) - Go port of Ruby's dotenv library (Loads environment variables from `.env`).
- <code>&nbsp;&nbsp;8392</code> [sonic](https://github.com/bytedance/sonic) - A blazingly fast JSON serializing & deserializing library.
- <code>&nbsp;&nbsp;5622</code> [env](https://github.com/caarlos0/env) - Parse environment variables to Go structs (with defaults).
...
- <code>&nbsp;&nbsp;3512</code> [ini](https://github.com/go-ini/ini) - Go package to read and write INI files.
- <code>&nbsp;&nbsp;3306</code> [koanf](https://github.com/knadh/koanf) - Light weight, extensible library for reading config in Go applications. Built in support for JSON, TOML, YAML, env, command line.
- <code>&nbsp;&nbsp;2717</code> [kong](https://github.com/alecthomas/kong) - Command-line parser with support for arbitrarily complex command-line structures and additional sources of configuration such as YAML, JSON, TOML, etc (successor to `kingpin`).
...
- <code>&nbsp;&nbsp;&nbsp;843</code> [xdg](https://github.com/adrg/xdg) - Go implementation of the [XDG Base Directory Specification](https://specifications.freedesktop.org/basedir-spec/latest/) and [XDG user directories](https://wiki.archlinux.org/index.php/XDG_user_directories).
...
- <code>&nbsp;32959</code> [drone](https://github.com/drone/drone) - Drone is a Continuous Integration platform built on Docker, written in Go.
- <code>&nbsp;&nbsp;5233</code> [woodpecker](https://github.com/woodpecker-ci/woodpecker) - Woodpecker is a community fork of the Drone CI system.
- <code>&nbsp;&nbsp;4732</code> [CDS](https://github.com/ovh/cds) - Enterprise-Grade CI/CD and DevOps Automation Open Source Platform.
- <code>&nbsp;&nbsp;2566</code> [muffet](https://github.com/raviqqe/muffet) - Fast website link checker in Go, see <code>&nbsp;&nbsp;2829</code> [alternatives](https://github.com/lycheeverse/lychee#features).
...
- <code>&nbsp;&nbsp;8406</code> [Benthos](https://github.com/benthosdev/benthos) - A message streaming bridge between a range of protocols.
- <code>&nbsp;&nbsp;6138</code> [CloudQuery](http://github.com/cloudquery/cloudquery) - A high-performance ELT data integration framework with pluggable architecture.
...
- <code>&nbsp;17014</code> [gods](https://github.com/emirpasic/gods) - Go Data Structures. Containers, Sets, Lists, Stacks, Maps, BidiMaps, Trees, HashSet etc.
...
- <code>&nbsp;&nbsp;1100</code> [gostl](https://github.com/liyue201/gostl) - Data structure and algorithm library for go, designed to provide functions similar to C++ STL.
...
- <code>&nbsp;&nbsp;5818</code> [hatchet](https://github.com/hatchet-dev/hatchet) - Distributed, Fault-tolerant task queue.
...
- <code>&nbsp;10452</code> [bleve](https://github.com/blevesearch/bleve) - Modern text indexing library for go.
...
- <code>&nbsp;&nbsp;6212</code> [ristretto](https://github.com/dgraph-io/ristretto) - A high performance memory-bound Go cache.
- <code>&nbsp;&nbsp;2694</code> [GCache](https://github.com/bluele/gcache) - Cache library with support for expirable Cache, LFU, LRU and ARC.
- <code>&nbsp;&nbsp;2692</code> [gocache](https://github.com/eko/gocache) - A complete Go cache library with multiple stores (memory, memcache, redis, ...), chainable, loadable, metrics cache and more.
- <code>&nbsp;&nbsp;2239</code> [fastcache](https://github.com/VictoriaMetrics/fastcache) - fast thread-safe inmemory cache for big number of entries. Minimizes GC overhead.
- <code>&nbsp;&nbsp;2176</code> [otter](https://github.com/maypok86/otter) - A high performance lockless cache for Go. Many times faster than Ristretto and friends.
...
- <code>&nbsp;59440</code> [prometheus](https://github.com/prometheus/prometheus) - Monitoring system and time series database.
- <code>&nbsp;38719</code> [tidb](https://github.com/pingcap/tidb) - TiDB is a distributed SQL database. Inspired by the design of Google F1.
- <code>&nbsp;35927</code> [Milvus](https://github.com/milvus-io/milvus) - Milvus is a vector database for embedding management, analytics and search.
- <code>&nbsp;31078</code> [cockroach](https://github.com/cockroachdb/cockroach) - Scalable, Geo-Replicated, Transactional Datastore.
- <code>&nbsp;30318</code> [influxdb](https://github.com/influxdb/influxdb) - Scalable datastore for metrics, events, and real-time analytics.
- <code>&nbsp;21005</code> [dgraph](https://github.com/dgraph-io/dgraph) - Scalable, Distributed, Low Latency, High Throughput Graph Database.
- <code>&nbsp;18872</code> [dolt](https://github.com/dolthub/dolt) - Dolt – It's Git for Data.
- <code>&nbsp;16748</code> [rqlite](https://github.com/rqlite/rqlite) - The lightweight, distributed, relational database built on SQLite.
- <code>&nbsp;14754</code> [badger](https://github.com/dgraph-io/badger) - Fast key-value store in Go.
- <code>&nbsp;14516</code> [VictoriaMetrics](https://github.com/VictoriaMetrics/VictoriaMetrics) - fast, resource-effective and scalable open source time series database. May be used as long-term remote storage for Prometheus. Supports PromQL.
...
- <code>&nbsp;&nbsp;8908</code> [bbolt](https://github.com/etcd-io/bbolt) - An embedded key/value database for Go.
- <code>&nbsp;&nbsp;8777</code> [immudb](https://github.com/codenotary/immudb) - immudb is a lightweight, high-speed immutable database for systems and applications written in Go.
- <code>&nbsp;&nbsp;6282</code> [goleveldb](https://github.com/syndtr/goleveldb) - Implementation of the <code>&nbsp;37866</code> [LevelDB](https://github.com/google/leveldb) key/value database in Go.
...
- <code>&nbsp;&nbsp;4737</code> [buntdb](https://github.com/tidwall/buntdb) - Fast, embeddable, in-memory key/value database for Go with custom indexing and spatial support.
...
- <code>&nbsp;&nbsp;3860</code> [redka](https://github.com/nalgeon/redka) - Redis re-implemented with SQLite.
- <code>&nbsp;&nbsp;3722</code> [godis](https://github.com/hdt3213/godis) - A Golang implemented high-performance Redis server and cluster.
...
- <code>&nbsp;&nbsp;1018</code> [eliasdb](https://github.com/krotik/eliasdb) - Dependency-free, transactional graph database with REST API, phrase search and SQL-like query language.
- <code>&nbsp;&nbsp;1008</code> [moss](https://github.com/couchbase/moss) - Moss is a simple LSM key-value storage engine written in 100% Go.
- <code>&nbsp;&nbsp;&nbsp;763</code> [clover](https://github.com/ostafen/clover) - A lightweight document-oriented NoSQL database written in pure Golang.
...
- <code>&nbsp;16979</code> [migrate](https://github.com/golang-migrate/migrate) - Database migrations. CLI and Golang library.
- <code>&nbsp;12735</code> [bytebase](https://github.com/bytebase/bytebase) - Safe database schema change and version control for DevOps teams.
- <code>&nbsp;&nbsp;8722</code> [goose](https://github.com/pressly/goose) - Database migration tool. You can manage your database's evolution by creating incremental SQL or Go scripts.
- <code>&nbsp;&nbsp;7029</code> [atlas](https://github.com/ariga/atlas) - A Database Toolkit. A CLI designed to help companies better work with their data.
- <code>&nbsp;&nbsp;6125</code> [dbmate](https://github.com/amacneil/dbmate) - A lightweight, framework-agnostic database migration tool.
...
- <code>&nbsp;&nbsp;1102</code> [gormigrate](https://github.com/go-gormigrate/gormigrate) - Database schema migration helper for Gorm ORM.
...
- <code>&nbsp;19839</code> [vitess](https://github.com/youtube/vitess) - vitess provides servers and tools which facilitate scaling of MySQL databases for large scale web services.
...
- <code>&nbsp;15514</code> [sqlc](https://github.com/kyleconroy/sqlc) - Generate type-safe code from SQL.
- <code>&nbsp;&nbsp;7504</code> [Squirrel](https://github.com/Masterminds/squirrel) - Go library that helps you build SQL queries.
...
- <code>&nbsp;&nbsp;3268</code> [jet](https://github.com/go-jet/jet) - Framework for writing type-safe SQL queries in Go, with ability to easily convert database query result into desired arbitrary object structure.
...
- <code>&nbsp;&nbsp;&nbsp;172</code> [bqb](https://github.com/nullism/bqb) - Lightweight and easy to learn query builder.
...
- <code>&nbsp;14926</code> [go-sql-driver/mysql](https://github.com/go-sql-driver/mysql) - MySQL driver for Go.
- <code>&nbsp;12133</code> [pgx](https://github.com/jackc/pgx) - PostgreSQL driver supporting features beyond those exposed by database/sql.
- <code>&nbsp;&nbsp;9540</code> [pq](https://github.com/lib/pq) - Pure Go Postgres driver for database/sql.
- <code>&nbsp;&nbsp;8569</code> [go-sqlite3](https://github.com/mattn/go-sqlite3) - SQLite3 driver for go that uses database/sql.
...
- <code>&nbsp;&nbsp;&nbsp;&nbsp;17</code> [pig](https://github.com/alexeyco/pig) - Simple <code>&nbsp;12133</code> [pgx](https://github.com/jackc/pgx) wrapper to execute and <code>&nbsp;&nbsp;1442</code> [scan](https://github.com/georgysavva/scany) query results easily.
...
- <code>&nbsp;21069</code> [redis](https://github.com/redis/go-redis) - Redis client for Golang.
- <code>&nbsp;&nbsp;9833</code> [redigo](https://github.com/gomodule/redigo) - Redigo is a Go client for the Redis database.
- <code>&nbsp;&nbsp;8392</code> [mongo-go-driver](https://github.com/mongodb/mongo-go-driver) - Official MongoDB driver for the Go language.
- <code>&nbsp;&nbsp;2718</code> [rueidis](http://github.com/rueian/rueidis) - Fast Redis RESP3 client with auto pipelining and server-assisted client side caching.
...
- <code>&nbsp;&nbsp;1822</code> [gomemcache](https://github.com/bradfitz/gomemcache/) - memcache client library for the Go programming language.
...
- <code>&nbsp;&nbsp;5913</code> [go-elasticsearch](https://github.com/elastic/go-elasticsearch) - Official Elasticsearch client for Go.
...
- <code>&nbsp;&nbsp;1006</code> [zoekt](https://github.com/sourcegraph/zoekt) - Fast trigram based code search.
...
- <code>&nbsp;27158</code> [go-kit](https://github.com/go-kit/kit) - Microservice toolkit with support for service discovery, load balancing, pluggable transports, request tracking, etc.
- <code>&nbsp;24584</code> [Kratos](https://github.com/go-kratos/kratos) - A modular-designed and easy-to-use microservices framework in Go.
- <code>&nbsp;22387</code> [go-micro](https://github.com/micro/go-micro) - A distributed systems development framework.
- <code>&nbsp;22011</code> [grpc-go](https://github.com/grpc/grpc-go) - The Go language implementation of gRPC. HTTP/2 based RPC.
- <code>&nbsp;17486</code> [NATS](https://github.com/nats-io/nats-server) - NATS is a simple, secure, and performant communications system for digital systems, services, and devices.
...
- <code>&nbsp;&nbsp;6580</code> [lura](https://github.com/luraproject/lura) - Ultra performant API Gateway framework with middlewares.
...
- <code>&nbsp;&nbsp;3951</code> [emitter-io](https://github.com/emitter-io/emitter) - High performance, distributed, secure and low latency publish-subscribe platform built with MQTT, Websockets and love.
...
- <code>&nbsp;&nbsp;2175</code> [sponge](https://github.com/zhufuyi/sponge) - A distributed development framework that integrates automatic code generation, gin and grpc frameworks, base development frameworks.
- <code>&nbsp;&nbsp;1633</code> [redis-lock](https://github.com/bsm/redislock) - Simplified distributed locking implementation using Redis.
- <code>&nbsp;&nbsp;1573</code> [mochi mqtt](https://github.com/mochi-co/mqtt) - Fully spec compliant, embeddable high-performance MQTT v5/v3 broker for IoT, smarthome, and pubsub.
...
- <code>&nbsp;&nbsp;&nbsp;878</code> [raft](https://github.com/etcd-io/raft) - Go implementation of the Raft consensus protocol, by CoreOS.
...
- <code>&nbsp;&nbsp;&nbsp;381</code> [sleuth](https://github.com/ursiform/sleuth) - Library for master-less p2p auto-discovery and RPC between HTTP services (using <code>&nbsp;10357</code> [ZeroMQ](https://github.com/zeromq/libzmq)).
...
- <code>&nbsp;&nbsp;&nbsp;&nbsp;78</code> [outbox](https://github.com/oagudo/outbox) - Lightweight library for the transactional outbox pattern in Go, not tied to any specific relational database or broker.
...
- <code>&nbsp;&nbsp;7348</code> [Mailpit](https://github.com/axllent/mailpit) - Email and SMTP testing tool for developers.
- <code>&nbsp;&nbsp;5596</code> [Maddy](https://github.com/foxcpp/maddy) - All-in-one (SMTP, IMAP, DKIM, DMARC, MTA-STS, DANE) email server
- <code>&nbsp;&nbsp;5066</code> [mox](https://github.com/mjl-/mox) - Modern full-featured secure mail server for low-maintenance, self-hosted email.
- <code>&nbsp;&nbsp;2908</code> [hermes](https://github.com/matcornic/hermes) - Golang package that generates clean, responsive HTML e-mails.
- <code>&nbsp;&nbsp;2743</code> [email](https://github.com/jordan-wright/email) - A robust and flexible email library for Go.
- <code>&nbsp;&nbsp;2208</code> [go-imap](https://github.com/emersion/go-imap) - IMAP library for clients and servers.
- <code>&nbsp;&nbsp;1400</code> [email-verifier](https://github.com/AfterShip/email-verifier) - A Go library for email verification without sending any emails.
- <code>&nbsp;&nbsp;1036</code> [go-mail](https://github.com/wneessen/go-mail) - A simple Go library for sending mails in Go.
- <code>&nbsp;&nbsp;1022</code> [SendGrid](https://github.com/sendgrid/sendgrid-go) - SendGrid's Go library for sending email.
...
- <code>&nbsp;&nbsp;9661</code> [FrankenPHP](https://github.com/dunglas/frankenphp) - PHP embedded in Go, with a `net/http` handler.
- <code>&nbsp;&nbsp;6994</code> [expr](https://github.com/antonmedv/expr) - Expression evaluation engine for Go: fast, non-Turing complete, dynamic typing, static typing.
- <code>&nbsp;&nbsp;6651</code> [gopher-lua](https://github.com/yuin/gopher-lua) - Lua 5.1 VM and compiler written in Go.
- <code>&nbsp;&nbsp;6280</code> [goja](https://github.com/dop251/goja) - ECMAScript 5.1(+) implementation in Go.
...
- <code>&nbsp;&nbsp;2611</code> [cel-go](https://github.com/google/cel-go) - Fast, portable, non-Turing complete expression evaluation with gradual typing.
...
- <code>&nbsp;&nbsp;&nbsp;&nbsp;79</code> [binder](https://github.com/alexeyco/binder) - Go to Lua binding library, based on <code>&nbsp;&nbsp;6651</code> [gopher-lua](https://github.com/yuin/gopher-lua).
...
- <code>&nbsp;&nbsp;2471</code> [go-multierror](https://github.com/hashicorp/go-multierror) - Go (golang) package for representing a list of errors as a single error.
...
- <code>&nbsp;&nbsp;7794</code> [pdfcpu](https://github.com/pdfcpu/pdfcpu) - PDF processor.
- <code>&nbsp;&nbsp;6267</code> [afero](https://github.com/spf13/afero) - FileSystem Abstraction System for Go.
- <code>&nbsp;&nbsp;4607</code> [gdu](https://github.com/dundee/gdu) - Disk usage analyzer with console interface.
...
- <code>&nbsp;&nbsp;&nbsp;344</code> [vfs](https://github.com/C2FO/vfs) - A pluggable, extensible, and opinionated set of filesystem functionality for Go across a number of filesystem types such as os, S3, and GCS.
...
- <code>&nbsp;&nbsp;&nbsp;&nbsp;98</code> [fastwalk](https://github.com/charlievieth/fastwalk) - Fast parallel directory traversal library (used by <code>&nbsp;71975</code> [fzf](https://github.com/junegunn/fzf)).
...
- <code>&nbsp;&nbsp;&nbsp;&nbsp;25</code> [todotxt](https://github.com/1set/todotxt) - Go library for Gina Trapani's [*todo.txt*](http://todotxt.org/) files, supports parsing and manipulating of task lists in the <code>&nbsp;&nbsp;2848</code> [*todo.txt* format](https://github.com/todotxt/todo.txt).
...
- <code>&nbsp;&nbsp;5320</code> [ticker](https://github.com/achannarasappa/ticker) - Terminal stock watcher and stock position tracker.
- <code>&nbsp;&nbsp;1781</code> [go-money](https://github.com/rhymond/go-money) - Implementation of Fowler's Money pattern.
- <code>&nbsp;&nbsp;1382</code> [bbgo](https://github.com/c9s/bbgo) - A crypto trading bot framework written in Go. Including common crypto exchange API, standard indicators, back-testing and many built-in strategies.
...
- <code>&nbsp;&nbsp;&nbsp;493</code> [ach](https://github.com/moov-io/ach) - A reader, writer, and validator for Automated Clearing House (ACH) files.
...
- <code>&nbsp;&nbsp;&nbsp;848</code> [form](https://github.com/go-playground/form) - Decodes url.Values into Go value(s) and Encodes Go value(s) into url.Values. Dual Array and Full map support.
...
- <code>&nbsp;&nbsp;3021</code> [mo](https://github.com/samber/mo) - Monads and popular FP abstractions, based on Go 1.18+ Generics (Option, Result, Either...).
...
- <code>&nbsp;12223</code> [Ebitengine](https://github.com/hajimehoshi/ebiten) - dead simple 2D game engine in Go.
...
- <code>&nbsp;&nbsp;2100</code> [raylib-go](https://github.com/gen2brain/raylib-go) - Go bindings for [raylib](https://www.raylib.com/), a simple and easy-to-use library to learn videogames programming.
...
- <code>&nbsp;&nbsp;7313</code> [oapi-codegen](https://github.com/deepmap/oapi-codegen) - This package contains a set of utilities for generating Go boilerplate code for services based on OpenAPI 3.0 API definitions.
- <code>&nbsp;&nbsp;3592</code> [go-linq](https://github.com/ahmetalpbalkan/go-linq) - .NET LINQ-like query methods for Go.
...
- <code>&nbsp;&nbsp;1765</code> [S2 geometry](https://github.com/golang/geo) - S2 geometry library in Go.
...
- <code>&nbsp;&nbsp;2443</code> [bunster](https://github.com/yassinebenaid/bunster) - Compile shell scripts to Go.
...
- <code>&nbsp;13819</code> [ants](https://github.com/panjf2000/ants) - A high-performance and low-cost goroutine pool in Go.
- <code>&nbsp;&nbsp;9993</code> [conc](https://github.com/sourcegraph/conc) - `conc` is your toolbelt for structured concurrency in go, making common tasks easier and safer.
...
- <code>&nbsp;26744</code> [fyne](https://github.com/fyne-io/fyne) - Cross platform native GUIs designed for Go based on Material Design. Supports: Linux, macOS, Windows, BSD, iOS and Android.
- <code>&nbsp;13226</code> [webview](https://github.com/zserge/webview) - Cross-platform webview window with simple two-way JavaScript bindings (Windows / macOS / Linux).
...
- <code>&nbsp;&nbsp;5277</code> [DarwinKit](https://github.com/progrium/darwinkit) - Build native macOS applications using Go.
...
- <code>&nbsp;&nbsp;2174</code> [gotk3](https://github.com/gotk3/gotk3) - Go bindings for GTK3.
- <code>&nbsp;&nbsp;2040</code> [Cogent Core](https://github.com/cogentcore/core) - A framework for building 2D and 3D apps that run on macOS, Windows, Linux, iOS, Android, and the web.
...
- <code>&nbsp;&nbsp;&nbsp;424</code> [cimgui-go](https://github.com/AllenDang/cimgui-go) - Auto generated Go wrapper for <code>&nbsp;66824</code> [Dear ImGui](https://github.com/ocornut/imgui) via <code>&nbsp;&nbsp;1684</code> [cimgui](https://github.com/cimgui/cimgui).
- <code>&nbsp;&nbsp;&nbsp;273</code> [unison](https://github.com/richardwilkes/unison) - A unified graphical user experience toolkit for Go desktop applications. macOS, Windows, and Linux are supported.
...
- <code>&nbsp;&nbsp;3508</code> [systray](https://github.com/getlantern/systray) - Cross platform Go library to place an icon and menu in the notification area.
- <code>&nbsp;&nbsp;&nbsp;821</code> [zenity](https://github.com/ncruces/zenity) - Cross-platform Go library and CLI to create simple dialogs that interact graphically with the user.
...
- <code>&nbsp;&nbsp;5879</code> [imaginary](https://github.com/h2non/imaginary) - Fast and simple HTTP microservice for image resizing.
...
- <code>&nbsp;&nbsp;1596</code> [canvas](https://github.com/tdewolff/canvas) - Vector graphics to PDF, SVG or rasterized image.
- <code>&nbsp;&nbsp;1462</code> [govips](https://github.com/davidbyttow/govips) - A lightning fast image processing and resizing library for Go.
...
- <code>&nbsp;&nbsp;9217</code> [gobot](https://github.com/hybridgroup/gobot/) - Gobot is a framework for robotics, physical computing, and the Internet of Things.
...
- <code>&nbsp;&nbsp;1355</code> [shifu](https://github.com/Edgenesis/shifu) - Kubernetes native IoT development framework.
- <code>&nbsp;&nbsp;1197</code> [rulego](https://github.com/rulego/rulego) - RuleGo is a lightweight, high-performance, embedded, orchestrable component-based rule engine for IoT edge.
...
- <code>&nbsp;&nbsp;6359</code> [gocron](https://github.com/go-co-op/gocron) - Easy and fluent Go job scheduling. This is an actively maintained fork of <code>&nbsp;&nbsp;3492</code> [jasonlvhit/gocron](https://github.com/jasonlvhit/gocron).
...
- <code>&nbsp;15041</code> [GJSON](https://github.com/tidwall/gjson) - Get a JSON value with one line of code.
...
- <code>&nbsp;&nbsp;&nbsp;904</code> [OjG](https://github.com/ohler55/ojg) - Optimized JSON for Go is a high performance parser with a variety of additional JSON tools including JSONPath.
...
- <code>&nbsp;25368</code> [logrus](https://github.com/Sirupsen/logrus) - Structured logger for Go.
- <code>&nbsp;23340</code> [zap](https://github.com/uber-go/zap) - Fast, structured, leveled logging in Go.
- <code>&nbsp;11592</code> [zerolog](https://github.com/rs/zerolog) - Zero-allocation JSON logger.
...
- <code>&nbsp;&nbsp;5160</code> [lumberjack](https://github.com/natefinch/lumberjack) - Simple rolling logger, implements io.WriteCloser.
...
- <code>&nbsp;&nbsp;1967</code> [pp](https://github.com/k0kubun/pp) - Colored pretty printer for Go language.
...
- <code>&nbsp;&nbsp;&nbsp;595</code> [lazyjournal](https://github.com/Lifailon/lazyjournal) - A TUI for reading and filtering logs from journalctl, file system, Docker and Podman containers, as well Kubernetes pods.
- <code>&nbsp;&nbsp;&nbsp;498</code> [slog-multi](https://github.com/samber/slog-multi) - Chain of slog.Handler (pipeline, fanout...).
...
- <code>&nbsp;&nbsp;&nbsp;205</code> [logur](https://github.com/logur/logur) - An opinionated logger interface and collection of logging best practices with adapters and integrations for well-known libraries (<code>&nbsp;25368</code> [logrus](https://github.com/sirupsen/logrus), <code>&nbsp;27158</code> [go-kit log](https://github.com/go-kit/kit/tree/master/log), <code>&nbsp;23340</code> [zap](https://github.com/uber-go/zap), <code>&nbsp;11592</code> [zerolog](https://github.com/rs/zerolog), etc).
- <code>&nbsp;&nbsp;&nbsp;190</code> [glg](https://github.com/kpango/glg) - glg is simple and fast leveled logging library for Go.
- <code>&nbsp;&nbsp;&nbsp;177</code> [slog-formatter](https://github.com/samber/slog-formatter) - Common formatters for slog and helpers to build your own.
...
- <code>&nbsp;&nbsp;&nbsp;&nbsp;28</code> [logrusly](https://github.com/sebest/logrusly) - <code>&nbsp;25368</code> [logrus](https://github.com/sirupsen/logrus) plug-in to send errors to a [Loggly](https://www.loggly.com/).
...
- <code>&nbsp;&nbsp;&nbsp;&nbsp;16</code> [logrusiowriter](https://github.com/cabify/logrusiowriter) - `io.Writer` implementation using <code>&nbsp;25368</code> [logrus](https://github.com/sirupsen/logrus) logger.
...
- <code>&nbsp;&nbsp;5807</code> [gorgonia](https://github.com/gorgonia/gorgonia) - graph-based computational library like Theano for Go that provides primitives for building various machine learning and neural network algorithms.
...
- <code>&nbsp;&nbsp;&nbsp;901</code> [eaopt](https://github.com/MaxHalford/eaopt) - An evolutionary optimization library.
- <code>&nbsp;&nbsp;&nbsp;829</code> [GoMLX](https://github.com/gomlx/gomlx) - An accelerated Machine Learning framework for Go.
- <code>&nbsp;&nbsp;&nbsp;810</code> [bayesian](https://github.com/jbrukh/bayesian) - Naive Bayesian Classification for Golang.
- <code>&nbsp;&nbsp;&nbsp;806</code> [onnx-go](https://github.com/owulveryck/onnx-go) - Go Interface to Open Neural Network Exchange (ONNX).
...
- <code>&nbsp;12091</code> [sarama](https://github.com/Shopify/sarama) - Go library for Apache Kafka.
- <code>&nbsp;11570</code> [Asynq](https://github.com/hibiken/asynq) - A simple, reliable, and efficient distributed task queue for Go built on top of Redis.
- <code>&nbsp;&nbsp;9118</code> [Centrifugo](https://github.com/centrifugal/centrifugo) - Real-time messaging (Websockets or SockJS) server in Go.
- <code>&nbsp;&nbsp;8650</code> [Watermill](https://github.com/ThreeDotsLabs/watermill) - Working efficiently with message streams. Building event driven applications, enabling event sourcing, RPC over messages, sagas. Can use conventional pub/sub implementations like Kafka or RabbitMQ, but also HTTP or MySQL binlog.
...
- <code>&nbsp;&nbsp;6017</code> [NATS Go Client](https://github.com/nats-io/nats.go) - Go client for the NATS messaging system.
...
- <code>&nbsp;&nbsp;4941</code> [Confluent Kafka Golang Client](https://github.com/confluentinc/confluent-kafka-go) - confluent-kafka-go is Confluent's Golang client for Apache Kafka and the Confluent Platform.
...
- <code>&nbsp;&nbsp;1810</code> [amqp](https://github.com/rabbitmq/amqp091-go) - Go RabbitMQ Client Library.
...
- <code>&nbsp;&nbsp;4621</code> [unioffice](https://github.com/unidoc/unioffice) - Pure go library for creating and processing Office Word (.docx), Excel (.xlsx) and Powerpoint (.pptx) documents.

### Microsoft Excel

*Libraries for working with Microsoft Excel.*

- <code>&nbsp;19366</code> [excelize](https://github.com/xuri/excelize) - Golang library for reading and writing Microsoft Excel&trade; (XLSX) files.
...
- <code>&nbsp;13937</code> [google/wire](https://github.com/google/wire) - Automated Initialization in Go.
- <code>&nbsp;&nbsp;6652</code> [fx](https://github.com/uber-go/fx) - A dependency injection based application framework for Go (built on top of dig).
- <code>&nbsp;&nbsp;4221</code> [dig](https://github.com/uber-go/dig) - A reflection based dependency injection toolkit for Go.
- <code>&nbsp;&nbsp;2191</code> [do](https://github.com/samber/do) - A dependency injection framework based on Generics.
...
- <code>&nbsp;53062</code> [golang-standards/project-layout](https://github.com/golang-standards/project-layout) - Set of common historical and emerging project layout patterns in the Go ecosystem. Note: despite the org-name they do not represent official golang standards, see <code>&nbsp;53062</code> [this issue](https://github.com/golang-standards/project-layout/issues/117) for more information. Nonetheless, some may find the layout useful.
- <code>&nbsp;&nbsp;7839</code> [go-blueprint](https://github.com/Melkeydev/go-blueprint) - Allows users to spin up a quick Go project using a popular framework.
- <code>&nbsp;&nbsp;3821</code> [ardanlabs/service](https://github.com/ardanlabs/service) - A <code>&nbsp;&nbsp;3821</code> [starter kit](https://github.com/ardanlabs/service/wiki) for building production grade scalable web service applications.
...
- <code>&nbsp;&nbsp;&nbsp;719</code> [cookiecutter-golang](https://github.com/lacion/cookiecutter-golang) - A Go application boilerplate template for quick starting projects following production best practices.
- <code>&nbsp;&nbsp;&nbsp;563</code> [go-starter](https://github.com/allaboutapps/go-starter) - An opinionated production-ready RESTful JSON backend template, highly integrated with VSCode DevContainers.
...
- <code>&nbsp;&nbsp;1138</code> [sttr](https://github.com/abhimanyu003/sttr) - cross-platform, cli app to perform various operations on string.
...
- <code>&nbsp;11305</code> [gopsutil](https://github.com/shirou/gopsutil) - Cross-platform library for retrieving process and system utilization(CPU, Memory, Disks, etc).
- <code>&nbsp;&nbsp;7676</code> [gatus](https://github.com/TwinProduction/gatus) - Automated service health dashboard.
...
- <code>&nbsp;&nbsp;1079</code> [stateless](https://github.com/qmuntal/stateless) - A fluent library for creating state machines.
...
- <code>&nbsp;&nbsp;1810</code> [spaGO](https://github.com/nlpodyssey/spago) - Self-contained Machine Learning and Natural Language Processing library in Go.
...
- <code>&nbsp;&nbsp;1263</code> [slug](https://github.com/gosimple/slug) - URL-friendly slugify with multiple languages support.
- <code>&nbsp;&nbsp;&nbsp;&nbsp;96</code> [go-slugify](https://github.com/mozillazg/go-slugify) - Make pretty slug with multiple languages support.
...
- <code>&nbsp;&nbsp;2542</code> [gojieba](https://github.com/yanyiwu/gojieba) - This is a Go implementation of <code>&nbsp;34242</code> [jieba](https://github.com/fxsjy/jieba) which a Chinese word splitting algorithm.
...
- <code>&nbsp;&nbsp;3292</code> [go-i18n](https://github.com/nicksnyder/go-i18n/) - Package and an accompanying tool to work with localized text.
...
- <code>&nbsp;22732</code> [fasthttp](https://github.com/valyala/fasthttp) - Package fasthttp is a fast HTTP implementation for Go, up to 10 times faster than net/http.
...
- <code>&nbsp;11017</code> [cloudflared](https://github.com/cloudflare/cloudflared) - Cloudflare Tunnel client (formerly Argo Tunnel).
- <code>&nbsp;10816</code> [quic-go](https://github.com/lucas-clemente/quic-go) - An implementation of the QUIC protocol in pure Go.
- <code>&nbsp;10642</code> [gnet](https://github.com/panjf2000/gnet) - `gnet` is a high-performance, lightweight, non-blocking, event-driven networking framework written in pure Go.
- <code>&nbsp;&nbsp;8419</code> [dns](https://github.com/miekg/dns) - Go library for working with DNS.
...
- <code>&nbsp;&nbsp;3985</code> [tun2socks](https://github.com/xjasonlyu/tun2socks) - A pure go implementation of tun2socks powered by [gVisor](https://gvisor.dev/) TCP/IP stack.
- <code>&nbsp;&nbsp;3941</code> [ssh](https://github.com/gliderlabs/ssh) - Higher-level API for building SSH servers (wraps crypto/ssh).
- <code>&nbsp;&nbsp;3825</code> [gobgp](https://github.com/osrg/gobgp) - BGP implemented in the Go Programming Language.
- <code>&nbsp;&nbsp;3556</code> [fortio](https://github.com/fortio/fortio) - Load testing library and command line tool, advanced echo server and web UI. Allows to specify a set query-per-second load and record latency histograms and other useful stats and graph them. Tcp, Http, gRPC.
...
- <code>&nbsp;&nbsp;1126</code> [nodepass](https://github.com/yosebyte/nodepass) - A secure, efficient TCP/UDP tunneling solution that delivers fast, reliable access across network restrictions using pre-established TLS/TCP connections.
...
- <code>&nbsp;&nbsp;&nbsp;450</code> [ftpserverlib](https://github.com/fclairamb/ftpserverlib) - Fully featured FTP server library.
...
- <code>&nbsp;11040</code> [resty](https://github.com/go-resty/resty) - Simple HTTP and REST client for Go inspired by Ruby rest-client.
...
- <code>&nbsp;&nbsp;2159</code> [go-retryablehttp](https://github.com/hashicorp/go-retryablehttp) - Retryable HTTP client in Go.
...
- <code>&nbsp;&nbsp;&nbsp;284</code> [azuretls-client](https://github.com/Noooste/azuretls-client) - An easy-to-use HTTP client 100% in Go to spoof TLS/JA3 and HTTP2 fingerprint
...
- <code>&nbsp;38503</code> [GORM](https://github.com/go-gorm/gorm) - The fantastic ORM library for Golang, aims to be developer friendly.
- <code>&nbsp;16351</code> [ent](https://github.com/facebook/ent) - An entity framework for Go. Simple, yet powerful ORM for modeling and querying data.
- <code>&nbsp;&nbsp;6895</code> [SQLBoiler](https://github.com/volatiletech/sqlboiler) - ORM generator. Generate a featureful and blazing-fast ORM tailored to your database schema.
...
- <code>&nbsp;&nbsp;3606</code> [upper.io/db](https://github.com/upper/db) - Single interface for interacting with different data sources through the use of adapters that wrap mature database drivers.
- <code>&nbsp;&nbsp;2407</code> [gormt](https://github.com/xxjwxc/gormt) - Mysql database to golang gorm struct.
- <code>&nbsp;&nbsp;2306</code> [Prisma](https://github.com/prisma/prisma-client-go) - Prisma Client Go, Typesafe database access for Go.
- <code>&nbsp;&nbsp;1570</code> [go-sqlbuilder](https://github.com/huandu/go-sqlbuilder) - A flexible and powerful SQL string builder library plus a zero-config ORM.
...
- <code>&nbsp;&nbsp;1358</code> [bob](https://github.com/stephenafamo/bob) - SQL query builder and ORM/Factory generator for Go. Successor of SQLBoiler.
...
- <code>&nbsp;&nbsp;7326</code> [syft](https://github.com/anchore/syft) - A CLI tool and Go library for generating a Software Bill of Materials (SBOM) from container images and filesystems.
...
- <code>&nbsp;21576</code> [jaeger](https://github.com/jaegertracing/jaeger) - A distributed tracing system.
- <code>&nbsp;&nbsp;6083</code> [pixie](https://github.com/pixie-labs/pixie) - No instrumentation tracing for Golang applications via eBPF.
...
- <code>&nbsp;&nbsp;7497</code> [dasel](https://github.com/tomwright/dasel) - Query and update data structures using selectors from the command line. Comparable to jq/yq but supports JSON, YAML, TOML and XML with zero runtime dependencies.
...
- <code>&nbsp;&nbsp;8089</code> [gonum](https://github.com/gonum/gonum) - Gonum is a set of numeric libraries for the Go programming language. It contains libraries for matrices, statistics, optimization, and more.
...
- <code>&nbsp;&nbsp;2879</code> [gonum/plot](https://github.com/gonum/plot) - gonum/plot provides an API for building and drawing plots in Go.
...
- <code>&nbsp;19216</code> [age](https://github.com/FiloSottile/age) - A simple, modern and secure encryption tool (and Go library) with small explicit keys, no config options, and UNIX-style composability.
...
- <code>&nbsp;&nbsp;4493</code> [Cameradar](https://github.com/Ullaakut/cameradar) - Tool and library to remotely hack RTSP streams from surveillance cameras.
...
- <code>&nbsp;&nbsp;1268</code> [beelzebub](https://github.com/mariocandela/beelzebub) - A secure low code honeypot framework, leveraging AI for System Virtualization.
...
- <code>&nbsp;&nbsp;9980</code> [goprotobuf](https://github.com/golang/protobuf) - Go support, in the form of a library and protocol compiler plugin, for Google's protocol buffers.
- <code>&nbsp;&nbsp;8004</code> [mapstructure](https://github.com/mitchellh/mapstructure) - Go library for decoding generic map values into native Go structures.
...
- <code>&nbsp;65447</code> [Caddy](https://github.com/caddyserver/caddy) - Caddy is an alternative, HTTP/2 web server that's easy to configure and use.
- <code>&nbsp;53765</code> [minio](https://github.com/minio/minio) - Minio is a distributed object storage server.
- <code>&nbsp;49825</code> [etcd](https://github.com/etcd-io/etcd) - Highly-available key value store for shared configuration and service discovery.
- <code>&nbsp;49008</code> [pocketbase](https://github.com/pocketbase/pocketbase) - PocketBase is a realtime backend in 1 file consisting of embedded database (SQLite) with realtime subscriptions, built-in auth management and much more.
- <code>&nbsp;10685</code> [SFTPGo](https://github.com/drakkan/sftpgo) - Fully featured and highly configurable SFTP server with optional FTP/S and WebDAV support. It can serve local filesystem and Cloud Storage backends such as S3 and Google Cloud Storage.
...
- <code>&nbsp;&nbsp;4205</code> [Wish](https://github.com/charmbracelet/wish) - Make SSH apps, just like that!
- <code>&nbsp;&nbsp;3603</code> [Fider](https://github.com/getfider/fider) - Fider is an open platform to collect and organize customer feedback.
...
- <code>&nbsp;&nbsp;2036</code> [Trickster](https://github.com/tricksterproxy/trickster) - HTTP reverse proxy cache and time series accelerator.
...
- <code>&nbsp;&nbsp;&nbsp;638</code> [Clace](https://github.com/claceio/clace) - Clace makes internal tool deployment and management easy by implementing an app server for containerized webapps.
...
- <code>&nbsp;&nbsp;9473</code> [templ](https://github.com/a-h/templ) - A HTML templating language that has great developer tooling.
- <code>&nbsp;&nbsp;3231</code> [quicktemplate](https://github.com/valyala/quicktemplate) - Fast, powerful, yet easy to use template engine. Converts templates into Go code and then compiles it.
- <code>&nbsp;&nbsp;2960</code> [pongo2](https://github.com/flosch/pongo2) - Django-like template-engine for Go.
- <code>&nbsp;&nbsp;2487</code> [maroto](https://github.com/johnfercher/maroto) - A maroto way to create PDFs. Maroto is inspired in Bootstrap and uses gofpdf. Fast and simple.
...
- <code>&nbsp;24888</code> [Testify](https://github.com/stretchr/testify) - Sacred extension to the standard go testing package.
...
- <code>&nbsp;&nbsp;4186</code> [testcontainers-go](https://github.com/testcontainers/testcontainers-go) - A Go package that makes it simple to create and clean up container-based dependencies for automated integration/smoke tests. The clean, easy-to-use API enables developers to programmatically define containers that should be run as part of a test and clean up those resources when the test is done.
...
- <code>&nbsp;&nbsp;&nbsp;979</code> [embedded-postgres](https://github.com/fergusstrange/embedded-postgres) - Run a real Postgres database locally on Linux, OSX or Windows as part of another Go application or test.
...
- <code>&nbsp;&nbsp;&nbsp;707</code> [minimock](https://github.com/gojuno/minimock) - Mock generator for Go interfaces.
- <code>&nbsp;&nbsp;&nbsp;497</code> [pgxmock](https://github.com/pashagolub/pgxmock) - A mock library implementing <code>&nbsp;12133</code> [pgx - PostgreSQL Driver and Toolkit](https://github.com/jackc/pgx/).
...
- <code>&nbsp;12012</code> [chromedp](https://github.com/knq/chromedp) - a way to drive/test Chrome, Safari, Edge, Android Webviews, and other browsers supporting the Chrome Debugging Protocol.
- <code>&nbsp;&nbsp;6070</code> [rod](https://github.com/go-rod/rod) - A Devtools driver to make web automation and scraping easy.
- <code>&nbsp;&nbsp;2785</code> [playwright-go](https://github.com/mxschmitt/playwright-go) - browser automation library to control Chromium, Firefox and WebKit with a single API.
...
- <code>&nbsp;&nbsp;4183</code> [goldmark](https://github.com/yuin/goldmark) - A Markdown parser written in Go. Easy to extend, standard (CommonMark) compliant, well structured.
- <code>&nbsp;&nbsp;2927</code> [html-to-markdown](https://github.com/JohannesKaufmann/html-to-markdown) - Convert HTML to Markdown. Even works with entire websites and can be extended through rules.
...
- <code>&nbsp;&nbsp;7859</code> [sh](https://github.com/mvdan/sh) - Shell parser and formatter.
...
- <code>&nbsp;&nbsp;1267</code> [godump (goforj)](https://github.com/goforj/godump) - Pretty-print Go structs with Laravel/Symfony-style dumps, full type info, colorized CLI output, cycle detection, and private field access.
...
- <code>&nbsp;24428</code> [colly](https://github.com/asciimoo/colly) - Fast and Elegant Scraping Framework for Gophers.
- <code>&nbsp;14591</code> [GoQuery](https://github.com/PuerkitoBio/goquery) - GoQuery brings a syntax and a set of features similar to jQuery to the Go language.
- <code>&nbsp;&nbsp;1228</code> [xurls](https://github.com/mvdan/xurls) - Extract urls from text.
...
- <code>&nbsp;10859</code> [github](https://github.com/google/go-github) - Go library for accessing the GitHub REST API v3.
- <code>&nbsp;10155</code> [go-openai](https://github.com/sashabaranov/go-openai) - OpenAI ChatGPT, DALL·E, Whisper API library for Go.
- <code>&nbsp;&nbsp;5467</code> [discordgo](https://github.com/bwmarrin/discordgo) - Go bindings for the Discord Chat API.
- <code>&nbsp;&nbsp;4809</code> [slack](https://github.com/slack-go/slack) - Slack API in Go.
- <code>&nbsp;&nbsp;4290</code> [google](https://github.com/google/google-api-go-client) - Auto-generated Google APIs for Go.
- <code>&nbsp;&nbsp;4286</code> [google-cloud](https://github.com/GoogleCloudPlatform/gcloud-golang) - Google Cloud APIs Go Client Library.
- <code>&nbsp;&nbsp;3151</code> [aws-sdk-go](https://github.com/aws/aws-sdk-go-v2) - The official AWS SDK for the Go programming language.
- <code>&nbsp;&nbsp;2739</code> [minio-go](https://github.com/minio/minio-go) - Minio Go Library for Amazon S3 compatible cloud storage.
...
- <code>&nbsp;71975</code> [fzf](https://github.com/junegunn/fzf) - Command-line fuzzy finder written in Go.
- <code>&nbsp;51382</code> [dive](https://github.com/wagoodman/dive) - A tool for exploring each layer in a Docker image.
...
- <code>&nbsp;19737</code> [lo](https://github.com/samber/lo) - A Lodash like Go library based on Go 1.18+ Generics (map, filter, contains, find...)
- <code>&nbsp;17041</code> [sqlx](https://github.com/jmoiron/sqlx) - provides a set of extensions on top of the excellent built-in database/sql package.
- <code>&nbsp;16239</code> [ctop](https://github.com/bcicen/ctop) - [Top-like](https://ctop.sh) interface (e.g. htop) for container metrics.
- <code>&nbsp;14891</code> [goreleaser](https://github.com/goreleaser/goreleaser) - Deliver Go binaries as fast and easily as possible.
...
- <code>&nbsp;&nbsp;7770</code> [peco](https://github.com/peco/peco) - Simplistic interactive filtering tool.
- <code>&nbsp;&nbsp;5113</code> [lancet](https://github.com/duke-git/lancet) - A comprehensive, efficient, and reusable util function library of go.
...
- <code>&nbsp;&nbsp;3908</code> [minify](https://github.com/tdewolff/minify) - Fast minifiers for HTML, CSS, JS, XML, JSON and SVG file formats.
...
- <code>&nbsp;&nbsp;2211</code> [filetype](https://github.com/h2non/filetype) - Small package to infer the file type checking the magic numbers signature.
- <code>&nbsp;&nbsp;2082</code> [Storm](https://github.com/asdine/storm) - Simple and powerful toolkit for BoltDB.
- <code>&nbsp;&nbsp;1868</code> [jump](https://github.com/gsamokovarov/jump) - Jump helps you navigate faster by learning your habits.
...
- <code>&nbsp;&nbsp;&nbsp;820</code> [immortal](https://github.com/immortal/immortal) - \*nix cross-platform (OS agnostic) supervisor.
...
- <code>&nbsp;&nbsp;&nbsp;703</code> [clipboard](https://github.com/golang-design/clipboard) - 📋 cross-platform clipboard package in Go.
...
- <code>&nbsp;&nbsp;5728</code> [uuid](https://github.com/google/uuid) - Go package for UUIDs based on RFC 4122 and DCE 1.1: Authentication and Security Services.
...
- <code>&nbsp;&nbsp;4152</code> [xid](https://github.com/rs/xid) - Xid is a globally unique id generator library, ready to be safely used directly in your server code.
...
- <code>&nbsp;&nbsp;&nbsp;&nbsp;65</code> [guid](https://github.com/sdrapkin/guid) - Fast cryptographically safe Guid generator for Go (~10x faster than `uuid`).
...
- <code>&nbsp;18639</code> [validator](https://github.com/go-playground/validator) - Go Struct and Field validation, including Cross Field, Cross Struct, Map, Slice and Array diving.
...
- <code>&nbsp;&nbsp;3947</code> [ozzo-validation](https://github.com/go-ozzo/ozzo-validation) - Supports validation of various data types (structs, strings, maps, slices, etc.) with configurable and extensible validation rules specified in usual code constructs instead of struct tags.
...
- <code>&nbsp;&nbsp;&nbsp;903</code> [Zog](https://github.com/Oudwins/zog) - A <code>&nbsp;38991</code> [Zod](https://github.com/colinhacks/zod) inspired schema builder for runtime value parsing and validation. **[⬆ back to top](#contents)**
...
- <code>&nbsp;83096</code> [Gin](https://github.com/gin-gonic/gin) - Gin is a web framework written in Go! It features a martini-like API with much better performance, up to 40 times faster. If you need performance and good productivity.
- <code>&nbsp;37115</code> [Fiber](https://github.com/gofiber/fiber) - An Express.js inspired web framework build on Fasthttp.
...
- <code>&nbsp;31252</code> [Echo](https://github.com/labstack/echo) - High performance, minimalist Go web framework.
- <code>&nbsp;13201</code> [Revel](https://github.com/revel/revel) - High-productivity web framework for the Go language.
- <code>&nbsp;12521</code> [GoFrame](https://github.com/gogf/gf) - GoFrame is a modular, powerful, high-performance and enterprise-class application development framework of Golang.
- <code>&nbsp;12161</code> [GoFr](https://github.com/gofr-dev/gofr) - Gofr is an opinionated microservice development framework.
- <code>&nbsp;&nbsp;6374</code> [Hertz](https://github.com/cloudwego/hertz) - A high-performance and strong-extensibility Go HTTP framework that helps developers build microservices.
...
- <code>&nbsp;&nbsp;3909</code> [goravel](https://github.com/goravel/goravel) - A Laravel-inspired web framework with ORM, authentication, queue, task scheduling, and more built-in features.
- <code>&nbsp;&nbsp;3226</code> [Huma](https://github.com/danielgtaylor/huma/) - Framework for modern REST/GraphQL APIs with built-in OpenAPI 3, generated documentation, and a CLI.
...
- <code>&nbsp;&nbsp;&nbsp;770</code> [templui](https://github.com/axzilla/templui) - Modern UI Components for Go & Templ.
...
- <code>&nbsp;21470</code> [mux](https://github.com/gorilla/mux) - Powerful URL router and dispatcher for golang.
- <code>&nbsp;20116</code> [chi](https://github.com/go-chi/chi) - Small, fast and expressive HTTP router built on net/context.
...
- <code>&nbsp;11035</code> [webhook](https://github.com/adnanh/webhook) - Tool which allows user to create HTTP endpoints (hooks) that execute commands on the server.
...
- <code>&nbsp;&nbsp;1251</code> [go-ole](https://github.com/go-ole/go-ole) - Win32 OLE implementation for golang.
...
- <code>&nbsp;&nbsp;2390</code> [Dagu](https://github.com/dagu-go/dagu) - No-code workflow executor. it executes DAGs defined in a simple YAML format.
- <code>&nbsp;&nbsp;&nbsp;562</code> [go-taskflow](https://github.com/noneback/go-taskflow) - A taskflow-like General-purpose Task-parallel Programming Framework with integrated visualizer and profiler.
...
- <code>&nbsp;&nbsp;5049</code> [Cosign](https://github.com/sigstore/cosign) - Container Signing, Verification and Storage in an OCI registry.
- <code>&nbsp;&nbsp;3434</code> [OpenZiti](https://github.com/openziti/ziti) - A full, open source zero trust overlay network. Including numerous SDKs for numerous languages such as <code>&nbsp;&nbsp;&nbsp;108</code> [golang](https://github.com/openziti/sdk-golang) allowing you to embed zero trust principles directly into your applications. The [OpenZiti Test Kitchen](https://github.com/openziti-test-kitchen) has numerous examples to draw inspiration from including a <code>&nbsp;&nbsp;&nbsp;&nbsp;39</code> [zero trust ssh client - zssh](https://github.com/openziti-test-kitchen/zssh)
- <code>&nbsp;&nbsp;1989</code> [Spire](https://github.com/spiffe/spire) - SPIRE (the SPIFFE Runtime Environment) is a toolchain of APIs for establishing trust between software systems across a wide variety of hosting platforms.
...
- <code>&nbsp;17303</code> [golangci-lint](https://github.com/golangci/golangci-lint) – A fast Go linters runner. It runs linters in parallel, uses caching, supports `yaml` config, has integrations with all major IDE and has dozens of linters included.
...
- <code>&nbsp;&nbsp;5233</code> [revive](https://github.com/mgechev/revive) – ~6x faster, stricter, configurable, extensible, and beautiful drop-in replacement for `golint`.
...
- <code>&nbsp;&nbsp;2026</code> [GoPlantUML](https://github.com/jfeliu007/goplantuml) - Library and CLI that generates text plantump class diagram containing information about structures and interfaces with the relationship among them.
...
- <code>&nbsp;&nbsp;1082</code> [golines](https://github.com/segmentio/golines) - Formatter that automatically shortens long lines in Go code.
...
- <code>&nbsp;&nbsp;&nbsp;341</code> [wrapcheck](https://github.com/tomarrell/wrapcheck) - A linter to check that errors from external packages are wrapped.
...
- <code>&nbsp;&nbsp;&nbsp;143</code> [testifylint](https://github.com/Antonboom/testifylint) – A linter that checks usage of <code>&nbsp;24888</code> [github.com/stretchr/testify](https://github.com/stretchr/testify).
...
- <code>&nbsp;&nbsp;&nbsp;576</code> [coc-go language server extension for Vim/Neovim](https://github.com/josa42/coc-go) - This plugin adds <code>&nbsp;&nbsp;7756</code> [gopls](https://github.com/golang/tools/blob/master/gopls/README.md) features to Vim/Neovim.
...
- <code>&nbsp;&nbsp;6314</code> [go-callvis](https://github.com/TrueFurby/go-callvis) - Visualize call graph of your Go program using dot format.
...
- <code>116292</code> [kubernetes](https://github.com/kubernetes/kubernetes) - Container Cluster Manager from Google.
- <code>&nbsp;70078</code> [Moby](https://github.com/moby/moby) - Collaborative project for the container ecosystem to assemble container-based systems.
- <code>&nbsp;55523</code> [traefik](https://github.com/containous/traefik) - Reverse proxy and load balancer with support for multiple backends.
- <code>&nbsp;49545</code> [Gitea](https://github.com/go-gitea/gitea) - Fork of Gogs, entirely community driven.
- <code>&nbsp;30684</code> [minikube](https://github.com/kubernetes/minikube) - Run Kubernetes locally.
- <code>&nbsp;30189</code> [k3s](https://github.com/k3s-io/k3s) - Lightweight Kubernetes.
- <code>&nbsp;28239</code> [k6](https://github.com/grafana/k6) - A modern load testing tool, using Go and JavaScript.
- <code>&nbsp;24372</code> [Vegeta](https://github.com/tsenart/vegeta) - HTTP load testing tool and library. It's over 9000!
- <code>&nbsp;19054</code> [Hey](https://github.com/rakyll/hey) - Hey is a tiny program that sends some load to a web application.
...
- <code>&nbsp;14302</code> [kind](https://github.com/kubernetes-sigs/kind) - Kubernetes IN Docker - local clusters for testing Kubernetes.
- <code>&nbsp;11426</code> [kubeshark](https://github.com/kubeshark/kubeshark) - API traffic analyzer for Kubernetes, inspired by Wireshark, purposely built for Kubernetes.
- <code>&nbsp;11065</code> [GVM](https://github.com/moovweb/gvm) - GVM provides an interface to manage Go versions.
...
- <code>&nbsp;&nbsp;8066</code> [ko](https://github.com/google/ko) - Command line tool for building and deploying Go applications on Kubernetes
- <code>&nbsp;&nbsp;6772</code> [script](https://github.com/bitfield/script) - Making it easy to write shell-like scripts in Go for DevOps and system administration tasks.
- <code>&nbsp;&nbsp;6755</code> [KubeVela](https://github.com/kubevela/kubevela) - Cloud native application delivery.
- <code>&nbsp;&nbsp;6421</code> [bombardier](https://github.com/codesenberg/bombardier) - Fast cross-platform HTTP benchmarking tool.
- <code>&nbsp;&nbsp;5907</code> [k3d](https://github.com/k3d-io/k3d) - Little helper to run CNCF's k3s in Docker.
- <code>&nbsp;&nbsp;5653</code> [podinfo](https://github.com/stefanprodan/podinfo) - Podinfo is a tiny web application made with Go that showcases best practices of running microservices in Kubernetes. Podinfo is used by CNCF projects like Flux and Flagger for end-to-end testing and workshops.
- <code>&nbsp;&nbsp;5229</code> [Fleet device management](https://github.com/fleetdm/fleet) - Lightweight, programmable telemetry for servers and workstations.
- <code>&nbsp;&nbsp;5229</code> [gaia](https://github.com/gaia-pipeline/gaia) - Build powerful pipelines in any programming language.
- <code>&nbsp;&nbsp;4337</code> [Pomerium](https://github.com/pomerium/pomerium) - Pomerium is an identity-aware access proxy.
- <code>&nbsp;&nbsp;4053</code> [tau](https://github.com/taubyte/tau) - Easily build Cloud Computing Platforms with features like Serverless WebAssembly Functions, Frontend Hosting, CI/CD, Object Storage, K/V Database, and Pub-Sub Messaging.
- <code>&nbsp;&nbsp;3420</code> [s5cmd](https://github.com/peak/s5cmd) - Blazing fast S3 and local filesystem execution tool.
...
- <code>&nbsp;&nbsp;2674</code> [aptly](https://github.com/aptly-dev/aptly) - aptly is a Debian repository management tool.
...
- <code>&nbsp;&nbsp;1774</code> [ghorg](https://github.com/gabrie30/ghorg) - Quickly clone an entire org/users repositories into one directory - Supports GitHub, GitLab, Gitea, and Bitbucket.
...
- <code>&nbsp;&nbsp;1191</code> [PipeCD](https://github.com/pipe-cd/pipecd) - A GitOps-style continuous delivery platform that provides consistent deployment and operations experience for any applications.
...
- <code>&nbsp;&nbsp;&nbsp;691</code> [alaz](https://github.com/ddosify/alaz) - Effortless, Low-Overhead, eBPF-based Kubernetes Monitoring.
...
- <code>&nbsp;30549</code> [croc](https://github.com/schollz/croc) - Easily and securely send files or folders from one computer to another.
- <code>&nbsp;29273</code> [restic](https://github.com/restic/restic) - De-duplicating backup program.
- <code>&nbsp;25156</code> [Seaweed File System](https://github.com/chrislusf/seaweedfs) - Fast, Simple and Scalable Distributed File System with O(1) disk seek.
...
- <code>&nbsp;11874</code> [JuiceFS](https://github.com/juicedata/juicefs) - Distributed POSIX file system built on top of Redis and AWS S3.
- <code>&nbsp;11351</code> [toxiproxy](https://github.com/shopify/toxiproxy) - Proxy to simulate network and system conditions for automated tests.
...
- <code>&nbsp;&nbsp;7700</code> [LiteIDE](https://github.com/visualfc/liteide) - LiteIDE is a simple, open source, cross-platform Go IDE.
- <code>&nbsp;&nbsp;7469</code> [scc](https://github.com/boyter/scc) - Sloc Cloc and Code, a very fast accurate code counter with complexity calculations and COCOMO estimates.
...
- <code>&nbsp;&nbsp;5473</code> [Duplicacy](https://github.com/gilbertchen/duplicacy) - A cross-platform network and cloud backup tool based on the idea of lock-free deduplication.
- <code>&nbsp;&nbsp;5453</code> [blocky](https://github.com/0xERR0R/blocky) - Fast and lightweight DNS proxy as ad-blocker for local network with many features.
...
- <code>&nbsp;&nbsp;2061</code> [Gokapi](https://github.com/Forceu/gokapi) - Lightweight server to share files, which expire after a set amount of downloads or days. Similar to Firefox Send, but without public upload.
...
- <code>&nbsp;&nbsp;1583</code> [Plik](https://github.com/root-gg/plik) - Plik is a temporary file upload system (Wetransfer like) in Go.
...
- <code>&nbsp;&nbsp;&nbsp;589</code> [Chapar](https://github.com/chapar-rest/chapar) - Chapar is a a cross-platform Postman alternative built with go, aims to help developers to test their api endpoints. it support http and grpc protocols.
...
- <code>&nbsp;18216</code> [GoBooks](https://github.com/dariubs/GoBooks) - A curated list of Go books.
...
- <code>&nbsp;31078</code> [CockroachDB](https://github.com/cockroachdb/cockroach/blob/master/docs/style.md)
- <code>&nbsp;16641</code> [Uber](https://github.com/uber-go/guide/blob/master/style.md)
- <code>&nbsp;16192</code> [Hyperledger](https://github.com/hyperledger/fabric/blob/release-1.4/docs/source/style-guides/go-style.rst)
...
- <code>128857</code> [Go Projects](https://github.com/golang/go/wiki/Projects) - List of projects on the Go community wiki.
- <code>&nbsp;38695</code> [Awesome Remote Job](https://github.com/lukasz-madon/awesome-remote-job) - Curated list of awesome remote jobs. A lot of them are looking for Go hackers.
- <code>&nbsp;32704</code> [awesome-awesomeness](https://github.com/bayandin/awesome-awesomeness) - List of other amazingly awesome lists.
...
- <code>&nbsp;43683</code> [Build web application with Golang](https://github.com/astaxie/build-web-application-with-golang) - Golang ebook intro how to build a web app with golang.
- <code>&nbsp;26665</code> [go-patterns](https://github.com/tmrts/go-patterns) - Curated list of Go design patterns, recipes and idioms.
- <code>&nbsp;22964</code> [Learn Go with TDD](https://github.com/quii/learn-go-with-tests) - Learn Go with test-driven development.
- <code>&nbsp;19387</code> [Learn Go with 1000+ Exercises](https://github.com/inancgumus/learngo) - Learn Go with thousands of examples, exercises, and quizzes.
- <code>&nbsp;&nbsp;8663</code> [Go Cheat Sheet](https://github.com/a8m/go-lang-cheat-sheet) - Go's reference card.
- <code>&nbsp;&nbsp;6940</code> [go-clean-template](https://github.com/evrone/go-clean-template) - Clean Architecture template for Golang services.
...
- <code>&nbsp;&nbsp;&nbsp;284</code> [The Go Interview Practice](https://github.com/RezaSi/go-interview-practice) - A GitHub repository offering coding challenges for Go technical interview preparation.
