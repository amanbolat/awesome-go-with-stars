...
* <code>&nbsp;&nbsp;3696</code> ![](https://img.shields.io/github/last-commit/golang/oauth2) [oauth2](https://github.com/golang/oauth2) - Successor of goauth2. Generic OAuth 2.0 package that comes with JWT, Google APIs, Compute Engine and App Engine support.
* <code>&nbsp;&nbsp;3215</code> ![](https://img.shields.io/github/last-commit/markbates/goth) [goth](https://github.com/markbates/goth) - provides a simple, clean, and idiomatic way to use OAuth and OAuth2. Handles multiple providers out of the box.
...
* <code>&nbsp;&nbsp;1402</code> ![](https://img.shields.io/github/last-commit/dghubble/gologin) [gologin](https://github.com/dghubble/gologin) - chainable handlers for login with OAuth1 and OAuth2 authentication providers.
...
* <code>&nbsp;&nbsp;&nbsp;336</code> ![](https://img.shields.io/github/last-commit/ursiform/sleuth) [sleuth](https://github.com/ursiform/sleuth) - Library for master-less p2p auto-discovery and RPC between HTTP services (using <code>&nbsp;&nbsp;7061</code> ![](https://img.shields.io/github/last-commit/zeromq/libzmq) [ZeroMQ](https://github.com/zeromq/libzmq)).
...
* <code>&nbsp;&nbsp;1170</code> ![](https://img.shields.io/github/last-commit/justinas/nosurf) [nosurf](https://github.com/justinas/nosurf) - CSRF protection middleware for Go.
...
* <code>&nbsp;10269</code> ![](https://img.shields.io/github/last-commit/gopherjs/gopherjs) [gopherjs](https://github.com/gopherjs/gopherjs) - Compiler from Go to JavaScript.
...
* <code>&nbsp;&nbsp;&nbsp;182</code> ![](https://img.shields.io/github/last-commit/c-bata/goptuna) [Goptuna](https://github.com/c-bata/goptuna) - Bayesian optimization framework for black-box functions written in Go. Everything will be optimized.
...
* <code>&nbsp;&nbsp;&nbsp;173</code> ![](https://img.shields.io/github/last-commit/etherlabsio/healthcheck) [healthcheck](https://github.com/etherlabsio/healthcheck) - An opinionated and concurrent health-check HTTP handler for RESTful services.
...
* <code>&nbsp;&nbsp;&nbsp;668</code> ![](https://img.shields.io/github/last-commit/reugn/go-streams) [go-streams](https://github.com/reugn/go-streams) - Go stream processing library.
...
* <code>&nbsp;&nbsp;&nbsp;468</code> ![](https://img.shields.io/github/last-commit/miku/zek) [zek](https://github.com/miku/zek) - Generate a Go struct from XML.
...
* <code>&nbsp;&nbsp;2393</code> ![](https://img.shields.io/github/last-commit/egonelbre/gophers) [gophers](https://github.com/egonelbre/gophers) - Free gophers.
* <code>&nbsp;&nbsp;2251</code> ![](https://img.shields.io/github/last-commit/MariaLetta/free-gophers-pack) [Free Gophers Pack](https://github.com/MariaLetta/free-gophers-pack) - Gopher graphics pack by Maria Letta with illustrations and emotional characters in vector and raster.
