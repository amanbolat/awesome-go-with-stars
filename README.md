...
- <code>&nbsp;73104</code> [Ollama](https://github.com/jmorganca/ollama) - Run large language models locally.
- <code>&nbsp;21122</code> [LocalAI](https://github.com/mudler/LocalAI) - Open Source OpenAI alternative, self-host AI models.
- <code>&nbsp;&nbsp;3476</code> [langchaingo](https://github.com/tmc/langchaingo) - LangChainGo is a framework for developing applications powered by language models.
...
- <code>&nbsp;17076</code> [casbin](https://github.com/hsluoyz/casbin) - Authorization library that supports access control models like ACL, RBAC, and ABAC.
- <code>&nbsp;&nbsp;6601</code> [jwt-go](https://github.com/golang-jwt/jwt) - A full featured implementation of JSON Web Tokens (JWT). This library supports the parsing and verification as well as the generation and signing of JWTs.
...
- <code>&nbsp;&nbsp;5146</code> [goth](https://github.com/markbates/goth) - provides a simple, clean, and idiomatic way to use OAuth and OAuth2. Handles multiple providers out of the box.
- <code>&nbsp;&nbsp;4673</code> [keto](https://github.com/ory/keto) - Open Source (Go) implementation of "Zanzibar: Google's Consistent, Global Authorization System". Ships gRPC, REST APIs, newSQL, and an easy and granular permission language. Supports ACL, RBAC, and other access models.
...
- <code>&nbsp;&nbsp;2417</code> [openfga](https://github.com/openfga/openfga) - Implementation of fine-grained authorization based on the "Zanzibar: Google's Consistent, Global Authorization System" paper. Backed by [CNCF](https://www.cncf.io/).
...
- <code>&nbsp;&nbsp;1785</code> [gologin](https://github.com/dghubble/gologin) - chainable handlers for login with OAuth1 and OAuth2 authentication providers.
- <code>&nbsp;&nbsp;1572</code> [gorbac](https://github.com/mikespook/gorbac) - provides a lightweight role-based access control (RBAC) implementation in Golang.
- <code>&nbsp;&nbsp;1228</code> [oidc](https://github.com/zitadel/oidc) - Easy to use OpenID Connect client and server library written for Go and certified by the OpenID Foundation
- <code>&nbsp;&nbsp;&nbsp;817</code> [paseto](https://github.com/o1egl/paseto) - Golang implementation of Platform-Agnostic Security Tokens (PASETO).
...
- <code>&nbsp;&nbsp;&nbsp;183</code> [gosession](http://github.com/Kwynto/gosession) - This is quick session for net/http in GoLang. This package is perhaps the best implementation of the session mechanism, or at least it tries to become one.
...
- <code>&nbsp;46552</code> [go-ethereum](https://github.com/ethereum/go-ethereum) - Official Go implementation of the Ethereum protocol.
- <code>&nbsp;15862</code> [kubo](https://github.com/ipfs/kubo) - A blockchain framework implemented in Go. It provides content-addressable storage which can be used for decentralized storage in DApps. It is based on the IPFS protocol.
- <code>&nbsp;&nbsp;6040</code> [cosmos-sdk](https://github.com/cosmos/cosmos-sdk) - A Framework for Building Public Blockchains in the Cosmos Ecosystem.
...
- <code>&nbsp;&nbsp;&nbsp;710</code> [solana-go](https://github.com/gagliardetto/solana-go) - Go library to interface with Solana JSON RPC and WebSocket interfaces.
...
- <code>&nbsp;&nbsp;5522</code> [telegram-bot-api](https://github.com/Syfaro/telegram-bot-api) - Simple and clean Telegram bot client.
- <code>&nbsp;&nbsp;3721</code> [telebot](https://github.com/tucnak/telebot) - Telegram bot framework is written in Go.
- <code>&nbsp;&nbsp;3666</code> [olivia](https://github.com/olivia-ai/olivia) - A chatbot built with an artificial neural network.
- <code>&nbsp;&nbsp;1682</code> [wayback](https://github.com/wabarc/wayback) - A bot for Telegram, Mastodon, Slack, and other messaging platforms archives webpages.
...
- <code>&nbsp;&nbsp;&nbsp;467</code> [bot](https://github.com/go-telegram/bot) - Zero-dependencies Telegram Bot library with additional UI components
- <code>&nbsp;&nbsp;&nbsp;437</code> [telego](https://github.com/mymmrac/telego) - Telegram Bot API library for Golang with full one-to-one API implementation.
...
- <code>&nbsp;15967</code> [air](https://github.com/cosmtrek/air) - Air - Live reload for Go apps.
- <code>&nbsp;10353</code> [Task](https://github.com/go-task/task) - simple "Make" alternative.
...
- <code>&nbsp;&nbsp;&nbsp;283</code> [taskctl](https://github.com/taskctl/taskctl) - Concurrent task runner.
...
- <code>&nbsp;25036</code> [bubbletea](https://github.com/charmbracelet/bubbletea) - Go framework to build terminal apps, based on The Elm Architecture.
- <code>&nbsp;13034</code> [termui](https://github.com/gizak/termui) - Go terminal dashboard based on **termbox-go** and inspired by <code>&nbsp;15427</code> [blessed-contrib](https://github.com/yaronn/blessed-contrib).
- <code>&nbsp;&nbsp;9722</code> [gocui](https://github.com/jroimartin/gocui) - Minimalist Go library aimed at creating Console User Interfaces.
- <code>&nbsp;&nbsp;7562</code> [lipgloss](https://github.com/charmbracelet/lipgloss) - Declaratively define styles for color, format and layout in the terminal.
- <code>&nbsp;&nbsp;5227</code> [go-prompt](https://github.com/c-bata/go-prompt) - Library for building a powerful interactive prompt, inspired by <code>&nbsp;&nbsp;9053</code> [python-prompt-toolkit](https://github.com/jonathanslenders/python-prompt-toolkit).
- <code>&nbsp;&nbsp;4978</code> [bubbles](https://github.com/charmbracelet/bubbles) - TUI components for bubbletea.
- <code>&nbsp;&nbsp;4653</code> [termbox-go](https://github.com/nsf/termbox-go) - Termbox is a library for creating cross-platform text-based interfaces.
...
- <code>&nbsp;&nbsp;3900</code> [progressbar](https://github.com/schollz/progressbar) - Basic thread-safe progress bar that works in every OS.
- <code>&nbsp;&nbsp;2628</code> [termdash](https://github.com/mum4k/termdash) - Go terminal dashboard based on **termbox-go** and inspired by <code>&nbsp;13034</code> [termui](https://github.com/gizak/termui).
...
- <code>&nbsp;&nbsp;&nbsp;500</code> [box-cli-maker](https://github.com/Delta456/box-cli-maker) - Make Highly Customized Boxes for your CLI.
...
- <code>&nbsp;36547</code> [cobra](https://github.com/spf13/cobra) - Commander for modern Go CLI interactions.
- <code>&nbsp;21833</code> [urfave/cli](https://github.com/urfave/cli) - Simple, fast, and fun package for building command line apps in Go (formerly codegangsta/cli).
- <code>&nbsp;&nbsp;5503</code> [elvish](https://github.com/elves/elvish) - An expressive programming language and a versatile interactive shell.
...
- <code>&nbsp;&nbsp;3457</code> [kingpin](https://github.com/alecthomas/kingpin) - Command line and flag parser supporting sub commands (superseded by `kong`; see below).
...
- <code>&nbsp;&nbsp;1223</code> [ops](https://github.com/nanovms/ops) - Unikernel Builder/Orchestrator.
- <code>&nbsp;&nbsp;1036</code> [liner](https://github.com/peterh/liner) - Go readline-like library for command-line interfaces.
...
- <code>&nbsp;&nbsp;&nbsp;745</code> [carapace-bin](https://github.com/rsteube/carapace-bin) - Multi-shell multi-command argument completer.
...
- <code>&nbsp;&nbsp;&nbsp;270</code> [carapace](https://github.com/rsteube/carapace) - Command argument completion generator for spf13/cobra.
...
- <code>&nbsp;26132</code> [viper](https://github.com/spf13/viper) - Go configuration with fangs.
- <code>&nbsp;&nbsp;7755</code> [godotenv](https://github.com/joho/godotenv) - Go port of Ruby's dotenv library (Loads environment variables from `.env`).
- <code>&nbsp;&nbsp;4928</code> [kelseyhightower/envconfig](https://github.com/kelseyhightower/envconfig) - Go library for managing configuration data from environment variables.
- <code>&nbsp;&nbsp;4490</code> [env](https://github.com/caarlos0/env) - Parse environment variables to Go structs (with defaults).
- <code>&nbsp;&nbsp;3420</code> [ini](https://github.com/go-ini/ini) - Go package to read and write INI files.
...
- <code>&nbsp;&nbsp;1884</code> [kong](https://github.com/alecthomas/kong) - Command-line parser with support for arbitrarily complex command-line structures and additional sources of configuration such as YAML, JSON, TOML, etc (successor to `kingpin`).
- <code>&nbsp;&nbsp;1506</code> [cleanenv](https://github.com/ilyakaznacheev/cleanenv) - Minimalistic configuration reader (from files, ENV, and wherever you want).
...
- <code>&nbsp;31688</code> [drone](https://github.com/drone/drone) - Drone is a Continuous Integration platform built on Docker, written in Go.
- <code>&nbsp;&nbsp;4477</code> [CDS](https://github.com/ovh/cds) - Enterprise-Grade CI/CD and DevOps Automation Open Source Platform.
- <code>&nbsp;&nbsp;3813</code> [woodpecker](https://github.com/woodpecker-ci/woodpecker) - Woodpecker is a community fork of the Drone CI system.
...
- <code>&nbsp;&nbsp;&nbsp;&nbsp;58</code> [go-test-coverage](https://github.com/vladopajic/go-test-coverage) - Tool and GitHub action which reports issues when test coverage is below set threshold.
...
- <code>&nbsp;&nbsp;1274</code> [bitset](https://github.com/bits-and-blooms/bitset) - Go package implementing bitsets.
...
- <code>&nbsp;15695</code> [gods](https://github.com/emirpasic/gods) - Go Data Structures. Containers, Sets, Lists, Stacks, Maps, BidiMaps, Trees, HashSet etc.
- <code>&nbsp;&nbsp;7469</code> [go-datastructures](https://github.com/Workiva/go-datastructures) - Collection of useful, performant, and thread-safe data structures.
...
- <code>&nbsp;&nbsp;2959</code> [gota](https://github.com/kniren/gota) - Implementation of dataframes, series, and data wrangling methods for Go.
...
- <code>&nbsp;&nbsp;&nbsp;248</code> [queue](https://github.com/adrianbrad/queue) - Multiple thread-safe, generic queue implementations for Go.
...
- <code>&nbsp;&nbsp;9746</code> [bleve](https://github.com/blevesearch/bleve) - Modern text indexing library for go.
...
- <code>&nbsp;12791</code> [groupcache](https://github.com/golang/groupcache) - Groupcache is a caching and cache-filling library, intended as a replacement for memcached in many cases.
- <code>&nbsp;&nbsp;7284</code> [BigCache](https://github.com/allegro/bigcache) - Efficient key/value cache for gigabytes of data.
...
- <code>&nbsp;&nbsp;2017</code> [fastcache](https://github.com/VictoriaMetrics/fastcache) - fast thread-safe inmemory cache for big number of entries. Minimizes GC overhead.
- <code>&nbsp;&nbsp;1526</code> [otter](https://github.com/maypok86/otter) - A high performance lockless cache for Go. Many times faster than Ristretto and friends.
...
- <code>&nbsp;&nbsp;&nbsp;115</code> [go-freelru](https://github.com/elastic/go-freelru) A GC-less, fast and generic LRU hashmap library with optional locking, sharding, eviction and expiration.
...
- <code>&nbsp;53426</code> [prometheus](https://github.com/prometheus/prometheus) - Monitoring system and time series database.
- <code>&nbsp;36375</code> [tidb](https://github.com/pingcap/tidb) - TiDB is a distributed SQL database. Inspired by the design of Google F1.
- <code>&nbsp;29371</code> [cockroach](https://github.com/cockroachdb/cockroach) - Scalable, Geo-Replicated, Transactional Datastore.
- <code>&nbsp;28045</code> [influxdb](https://github.com/influxdb/influxdb) - Scalable datastore for metrics, events, and real-time analytics.
- <code>&nbsp;27741</code> [Milvus](https://github.com/milvus-io/milvus) - Milvus is a vector database for embedding management, analytics and search.
- <code>&nbsp;20137</code> [dgraph](https://github.com/dgraph-io/dgraph) - Scalable, Distributed, Low Latency, High Throughput Graph Database.
- <code>&nbsp;17228</code> [dolt](https://github.com/dolthub/dolt) - Dolt – It's Git for Data.
- <code>&nbsp;15100</code> [rqlite](https://github.com/rqlite/rqlite) - The lightweight, distributed, relational database built on SQLite.
- <code>&nbsp;13503</code> [badger](https://github.com/dgraph-io/badger) - Fast key-value store in Go.
- <code>&nbsp;11140</code> [VictoriaMetrics](https://github.com/VictoriaMetrics/VictoriaMetrics) - fast, resource-effective and scalable open source time series database. May be used as long-term remote storage for Prometheus. Supports PromQL.
...
- <code>&nbsp;&nbsp;7817</code> [bbolt](https://github.com/etcd-io/bbolt) - An embedded key/value database for Go.
- <code>&nbsp;&nbsp;6062</code> [goleveldb](https://github.com/syndtr/goleveldb) - Implementation of the <code>&nbsp;35375</code> [LevelDB](https://github.com/google/leveldb) key/value database in Go.
- <code>&nbsp;&nbsp;4557</code> [pebble](https://github.com/cockroachdb/pebble) - RocksDB/LevelDB inspired key-value database in Go.
- <code>&nbsp;&nbsp;4428</code> [buntdb](https://github.com/tidwall/buntdb) - Fast, embeddable, in-memory key/value database for Go with custom indexing and spatial support.
...
- <code>&nbsp;&nbsp;2850</code> [LinDB](https://github.com/lindb/lindb) - LinDB is a scalable, high performance, high availability distributed time series database.
...
- <code>&nbsp;&nbsp;1217</code> [Databunker](https://github.com/paranoidguy/databunker) - Personally identifiable information (PII) storage service built to comply with GDPR and CCPA.
- <code>&nbsp;&nbsp;1053</code> [objectbox-go](https://github.com/objectbox/objectbox-go) - High-performance embedded Object Database (NoSQL) with Go API.
...
- <code>&nbsp;14335</code> [migrate](https://github.com/golang-migrate/migrate) - Database migrations. CLI and Golang library.
- <code>&nbsp;10349</code> [bytebase](https://github.com/bytebase/bytebase) - Safe database schema change and version control for DevOps teams.
- <code>&nbsp;&nbsp;6034</code> [goose](https://github.com/pressly/goose) - Database migration tool. You can manage your database's evolution by creating incremental SQL or Go scripts.
- <code>&nbsp;&nbsp;5239</code> [atlas](https://github.com/ariga/atlas) - A Database Toolkit. A CLI designed to help companies better work with their data.
- <code>&nbsp;&nbsp;4443</code> [dbmate](https://github.com/amacneil/dbmate) - A lightweight, framework-agnostic database migration tool.
...
- <code>&nbsp;18067</code> [vitess](https://github.com/youtube/vitess) - vitess provides servers and tools which facilitate scaling of MySQL databases for large scale web services.
- <code>&nbsp;&nbsp;8347</code> [pgweb](https://github.com/sosedoff/pgweb) - Web-based PostgreSQL database browser.
...
- <code>&nbsp;&nbsp;1029</code> [pg_timetable](https://github.com/cybertec-postgresql/pg_timetable) - Advanced scheduling for PostgreSQL.
...
- <code>&nbsp;&nbsp;&nbsp;356</code> [rdb](https://github.com/HDT3213/rdb) - Redis RDB file parser for secondary development and memory analysis.
...
- <code>&nbsp;11360</code> [sqlc](https://github.com/kyleconroy/sqlc) - Generate type-safe code from SQL.
...
- <code>&nbsp;&nbsp;2151</code> [jet](https://github.com/go-jet/jet) - Framework for writing type-safe SQL queries in Go, with ability to easily convert database query result into desired arbitrary object structure.
- <code>&nbsp;&nbsp;1586</code> [gendry](https://github.com/didi/gendry) - Non-invasive SQL builder and powerful data binder.
...
- <code>&nbsp;14784</code> [cayley](https://github.com/google/cayley) - Graph database with support for multiple backends.
...
- <code>&nbsp;&nbsp;9719</code> [pgx](https://github.com/jackc/pgx) - PostgreSQL driver supporting features beyond those exposed by database/sql.
- <code>&nbsp;&nbsp;8825</code> [pq](https://github.com/lib/pq) - Pure Go Postgres driver for database/sql.
- <code>&nbsp;&nbsp;7575</code> [go-sqlite3](https://github.com/mattn/go-sqlite3) - SQLite3 driver for go that uses database/sql.
...
- <code>&nbsp;&nbsp;&nbsp;&nbsp;16</code> [pig](https://github.com/alexeyco/pig) - Simple <code>&nbsp;&nbsp;9719</code> [pgx](https://github.com/jackc/pgx) wrapper to execute and <code>&nbsp;&nbsp;1211</code> [scan](https://github.com/georgysavva/scany) query results easily.

### NoSQL Database Drivers

- <code>&nbsp;19497</code> [redis](https://github.com/redis/go-redis) - Redis client for Golang.
- <code>&nbsp;&nbsp;9717</code> [redigo](https://github.com/gomodule/redigo) - Redigo is a Go client for the Redis database.
- <code>&nbsp;&nbsp;7976</code> [mongo-go-driver](https://github.com/mongodb/mongo-go-driver) - Official MongoDB driver for the Go language.
...
- <code>&nbsp;&nbsp;&nbsp;731</code> [mgm](https://github.com/kamva/mgm) - MongoDB model-based ODM for Go (based on official MongoDB driver).
...
- <code>&nbsp;&nbsp;5518</code> [go-elasticsearch](https://github.com/elastic/go-elasticsearch) - Official Elasticsearch client for Go.
- <code>&nbsp;&nbsp;2784</code> [clickhouse-go](https://github.com/ClickHouse/clickhouse-go/) - ClickHouse SQL client for Go with a `database/sql` compatibility.
...
- <code>&nbsp;&nbsp;2003</code> [dateparse](https://github.com/araddon/dateparse) - Parse date's without knowing format in advance.
...
- <code>&nbsp;27964</code> [go-zero](https://github.com/tal-tech/go-zero) - A web and rpc framework. It's born to ensure the stability of the busy sites with resilient design. Builtin goctl greatly improves the development productivity.
- <code>&nbsp;26249</code> [go-kit](https://github.com/go-kit/kit) - Microservice toolkit with support for service discovery, load balancing, pluggable transports, request tracking, etc.
- <code>&nbsp;22587</code> [Kratos](https://github.com/go-kratos/kratos) - A modular-designed and easy-to-use microservices framework in Go.
- <code>&nbsp;21512</code> [go-micro](https://github.com/micro/go-micro) - A distributed systems development framework.
- <code>&nbsp;20065</code> [grpc-go](https://github.com/grpc/grpc-go) - The Go language implementation of gRPC. HTTP/2 based RPC.
- <code>&nbsp;14977</code> [NATS](https://github.com/nats-io/gnatsd) - Lightweight, high performance messaging system for microservices, IoT, and cloud native systems.
- <code>&nbsp;12040</code> [micro](https://github.com/micro/micro) - A distributed systems runtime for the cloud and beyond.
- <code>&nbsp;&nbsp;7989</code> [rpcx](https://github.com/smallnest/rpcx) - Distributed pluggable RPC service framework like alibaba Dubbo.
- <code>&nbsp;&nbsp;7973</code> [raft](https://github.com/hashicorp/raft) - Golang implementation of the Raft consensus protocol, by HashiCorp.
- <code>&nbsp;&nbsp;6751</code> [Kitex](https://github.com/cloudwego/kitex) - A high-performance and strong-extensibility Golang RPC framework that helps developers build microservices. If the performance and extensibility are the main concerns when you develop microservices, Kitex can be a good choice.
- <code>&nbsp;&nbsp;6165</code> [lura](https://github.com/luraproject/lura) - Ultra performant API Gateway framework with middlewares.
...
- <code>&nbsp;&nbsp;4152</code> [evans](https://github.com/ktr0731/evans) - Evans: more expressive universal gRPC client.
...
- <code>&nbsp;&nbsp;2067</code> [Dragonfly](https://github.com/dragonflyoss/Dragonfly2) - Provide efficient, stable and secure file distribution and image acceleration based on p2p technology to be the best practice and standard solution in cloud native architectures.
...
- <code>&nbsp;&nbsp;1354</code> [redis-lock](https://github.com/bsm/redislock) - Simplified distributed locking implementation using Redis.
- <code>&nbsp;&nbsp;1255</code> [hprose](https://github.com/hprose/hprose-golang) - Very newbility RPC Library, support 25+ languages now.
- <code>&nbsp;&nbsp;1049</code> [sponge](https://github.com/zhufuyi/sponge) - A distributed development framework that integrates automatic code generation, gin and grpc frameworks, base development frameworks.
...
- <code>&nbsp;&nbsp;&nbsp;730</code> [trpc-go](https://github.com/trpc-group/trpc-go) - The Go language implementation of tRPC, which is a pluggable, high-performance RPC framework.
...
- <code>&nbsp;&nbsp;&nbsp;564</code> [raft](https://github.com/etcd-io/raft) - Go implementation of the Raft consensus protocol, by CoreOS.
...
- <code>&nbsp;&nbsp;&nbsp;473</code> [Temporal](https://github.com/temporalio/sdk-go) - Durable execution system for making code fault-tolerant and simple.
- <code>&nbsp;&nbsp;&nbsp;381</code> [go-jump](https://github.com/dgryski/go-jump) - Port of Google's "Jump" Consistent Hash function.
- <code>&nbsp;&nbsp;&nbsp;371</code> [sleuth](https://github.com/ursiform/sleuth) - Library for master-less p2p auto-discovery and RPC between HTTP services (using <code>&nbsp;&nbsp;9386</code> [ZeroMQ](https://github.com/zeromq/libzmq)).
...
- <code>&nbsp;13536</code> [MailHog](https://github.com/mailhog/MailHog) - Email and SMTP testing with web and API interface.
- <code>&nbsp;&nbsp;4770</code> [Mailpit](https://github.com/axllent/mailpit) - Email and SMTP testing tool for developers.
- <code>&nbsp;&nbsp;4750</code> [Maddy](https://github.com/foxcpp/maddy) - All-in-one (SMTP, IMAP, DKIM, DMARC, MTA-STS, DANE) email server
- <code>&nbsp;&nbsp;2782</code> [hermes](https://github.com/matcornic/hermes) - Golang package that generates clean, responsive HTML e-mails.
- <code>&nbsp;&nbsp;2592</code> [email](https://github.com/jordan-wright/email) - A robust and flexible email library for Go.
...
- <code>&nbsp;&nbsp;6074</code> [gopher-lua](https://github.com/yuin/gopher-lua) - Lua 5.1 VM and compiler written in Go.
- <code>&nbsp;&nbsp;5762</code> [expr](https://github.com/antonmedv/expr) - Expression evaluation engine for Go: fast, non-Turing complete, dynamic typing, static typing.
- <code>&nbsp;&nbsp;5070</code> [goja](https://github.com/dop251/goja) - ECMAScript 5.1(+) implementation in Go.
...
- <code>&nbsp;&nbsp;2092</code> [cel-go](https://github.com/google/cel-go) - Fast, portable, non-Turing complete expression evaluation with gradual typing.
...
- <code>&nbsp;&nbsp;&nbsp;&nbsp;75</code> [binder](https://github.com/alexeyco/binder) - Go to Lua binding library, based on <code>&nbsp;&nbsp;6074</code> [gopher-lua](https://github.com/yuin/gopher-lua).
...
- <code>&nbsp;&nbsp;2207</code> [go-multierror](https://github.com/hashicorp/go-multierror) - Go (golang) package for representing a list of errors as a single error.
...
- <code>&nbsp;&nbsp;1101</code> [errorx](https://github.com/joomcode/errorx) - A feature rich error package with stack traces, composition of errors and more.
...
- <code>&nbsp;&nbsp;6426</code> [pdfcpu](https://github.com/pdfcpu/pdfcpu) - PDF processor.
- <code>&nbsp;&nbsp;5761</code> [afero](https://github.com/spf13/afero) - FileSystem Abstraction System for Go.
- <code>&nbsp;&nbsp;3381</code> [gdu](https://github.com/dundee/gdu) - Disk usage analyzer with console interface.
...
- <code>&nbsp;&nbsp;&nbsp;691</code> [copy](https://github.com/otiai10/copy) - Copy directory recursively.
- <code>&nbsp;&nbsp;&nbsp;432</code> [gofs](https://github.com/no-src/gofs) - A cross-platform real-time file synchronization tool out of the box.
- <code>&nbsp;&nbsp;&nbsp;294</code> [afs](https://github.com/viant/afs) - Abstract File Storage (mem, scp, zip, tar, cloud: s3, gs) for Go.
...
- <code>&nbsp;&nbsp;&nbsp;&nbsp;21</code> [todotxt](https://github.com/1set/todotxt) - Go library for Gina Trapani's [*todo.txt*](http://todotxt.org/) files, supports parsing and manipulating of task lists in the <code>&nbsp;&nbsp;2299</code> [*todo.txt* format](https://github.com/todotxt/todo.txt).
...
- <code>&nbsp;&nbsp;6045</code> [decimal](https://github.com/shopspring/decimal) - Arbitrary-precision fixed-point decimal numbers.
- <code>&nbsp;&nbsp;4851</code> [ticker](https://github.com/achannarasappa/ticker) - Terminal stock watcher and stock position tracker.
...
- <code>&nbsp;&nbsp;&nbsp;442</code> [ach](https://github.com/moov-io/ach) - A reader, writer, and validator for Automated Clearing House (ACH) files.
...
- <code>&nbsp;&nbsp;&nbsp;715</code> [form](https://github.com/go-playground/form) - Decodes url.Values into Go value(s) and Encodes Go value(s) into url.Values. Dual Array and Full map support.
...
- <code>&nbsp;&nbsp;&nbsp;282</code> [httpin](https://github.com/ggicci/httpin) - Decode an HTTP request into a custom struct, including querystring, forms, HTTP headers, etc.
...
- <code>&nbsp;&nbsp;2384</code> [mo](https://github.com/samber/mo) - Monads and popular FP abstractions, based on Go 1.18+ Generics (Option, Result, Either...).
...
- <code>&nbsp;10096</code> [Ebitengine](https://github.com/hajimehoshi/ebiten) - dead simple 2D game engine in Go.
- <code>&nbsp;&nbsp;5166</code> [Leaf](https://github.com/name5566/leaf) - Lightweight game server framework.
- <code>&nbsp;&nbsp;4419</code> [Pixel](https://github.com/faiface/pixel) - Hand-crafted 2D game library in Go.
...
- <code>&nbsp;&nbsp;2526</code> [goworld](https://github.com/xiaonanln/goworld) - Scalable game server engine, featuring space-entity framework and hot-swapping.
...
- <code>&nbsp;&nbsp;2156</code> [go-sdl2](https://github.com/veandco/go-sdl2) - Go bindings for the [Simple DirectMedia Layer](https://www.libsdl.org/).
...
- <code>&nbsp;&nbsp;1376</code> [raylib-go](https://github.com/gen2brain/raylib-go) - Go bindings for [raylib](https://www.raylib.com/), a simple and easy-to-use library to learn videogames programming.
...
- <code>&nbsp;&nbsp;5479</code> [oapi-codegen](https://github.com/deepmap/oapi-codegen) - This package contains a set of utilities for generating Go boilerplate code for services based on OpenAPI 3.0 API definitions.
...
- <code>&nbsp;&nbsp;&nbsp;974</code> [GoWrap](https://github.com/hexdigest/gowrap) - Generate decorators for Go interfaces using simple templates.
- <code>&nbsp;&nbsp;&nbsp;674</code> [go-enum](https://github.com/abice/go-enum) - Code generation for enums from code comments.
...
- <code>&nbsp;&nbsp;1642</code> [S2 geometry](https://github.com/golang/geo) - S2 geometry library in Go.
...
- <code>&nbsp;12553</code> [gopherjs](https://github.com/gopherjs/gopherjs) - Compiler from Go to JavaScript.
...
- <code>&nbsp;12312</code> [ants](https://github.com/panjf2000/ants) - A high-performance and low-cost goroutine pool in Go.
- <code>&nbsp;&nbsp;8576</code> [conc](https://github.com/sourcegraph/conc) - `conc` is your toolbelt for structured concurrency in go, making common tasks easier and safer.
- <code>&nbsp;&nbsp;3830</code> [tunny](https://github.com/Jeffail/tunny) - Goroutine pool for golang.
...
- <code>&nbsp;&nbsp;&nbsp;329</code> [flowmatic](https://github.com/carlmjohnson/flowmatic) - Structured concurrency made easy.
...
- <code>&nbsp;23713</code> [fyne](https://github.com/fyne-io/fyne) - Cross platform native GUIs designed for Go based on Material Design. Supports: Linux, macOS, Windows, BSD, iOS and Android.
- <code>&nbsp;12268</code> [webview](https://github.com/zserge/webview) - Cross-platform webview window with simple two-way JavaScript bindings (Windows / macOS / Linux).
- <code>&nbsp;10283</code> [qt](https://github.com/therecipe/qt) - Qt binding for Go (support for Windows / macOS / Linux / Android / iOS / Sailfish OS / Raspberry Pi).
- <code>&nbsp;&nbsp;8329</code> [ui](https://github.com/andlabs/ui) - Platform-native GUI library for Go. Cross platform.
- <code>&nbsp;&nbsp;7751</code> [app](https://github.com/murlokswarm/app) - Package to create apps with GO, HTML and CSS. Supports: MacOS, Windows in progress.
- <code>&nbsp;&nbsp;6758</code> [walk](https://github.com/lxn/walk) - Windows application library kit for Go.
...
- <code>&nbsp;&nbsp;&nbsp;956</code> [Spot](https://github.com/roblillack/spot) - Reactive, cross-platform desktop GUI toolkit.
...
- <code>&nbsp;&nbsp;9374</code> [robotgo](https://github.com/go-vgo/robotgo) - Go Native cross-platform GUI system automation. Control the mouse, keyboard and other.
- <code>&nbsp;&nbsp;3167</code> [systray](https://github.com/getlantern/systray) - Cross platform Go library to place an icon and menu in the notification area.
...
- <code>&nbsp;&nbsp;1600</code> [ghw](https://github.com/jaypipes/ghw) - Golang hardware discovery/inspection library.
...
- <code>&nbsp;&nbsp;5128</code> [imaging](https://github.com/disintegration/imaging) - Simple Go image processing package.
- <code>&nbsp;&nbsp;4312</code> [gg](https://github.com/fogleman/gg) - 2D rendering in pure Go.
- <code>&nbsp;&nbsp;3933</code> [bild](https://github.com/anthonynsimon/bild) - Collection of image processing algorithms in pure Go.
- <code>&nbsp;&nbsp;3251</code> [ln](https://github.com/fogleman/ln) - 3D line art rendering in Go.
- <code>&nbsp;&nbsp;2750</code> [gowitness](https://github.com/sensepost/gowitness) - Screenshoting webpages using go and headless chrome on command line.
...
- <code>&nbsp;&nbsp;1799</code> [smartcrop](https://github.com/muesli/smartcrop) - Finds good crops for arbitrary images and crop sizes.
- <code>&nbsp;&nbsp;1731</code> [gift](https://github.com/disintegration/gift) - Package of image processing filters.
- <code>&nbsp;&nbsp;1731</code> [imagick](https://github.com/gographics/imagick) - Go binding to ImageMagick's MagickWand C API.
- <code>&nbsp;&nbsp;1450</code> [canvas](https://github.com/tdewolff/canvas) - Vector graphics to PDF, SVG or rasterized image.
...
- <code>&nbsp;&nbsp;8787</code> [gobot](https://github.com/hybridgroup/gobot/) - Gobot is a framework for robotics, physical computing, and the Internet of Things.
...
- <code>&nbsp;&nbsp;&nbsp;&nbsp;32</code> [mainflux](https://github.com/Mainflux/mainflux) - Industrial IoT Messaging and Device Management Server.
...
- <code>&nbsp;&nbsp;5072</code> [gocron](https://github.com/go-co-op/gocron) - Easy and fluent Go job scheduling. This is an actively maintained fork of <code>&nbsp;&nbsp;3404</code> [jasonlvhit/gocron](https://github.com/jasonlvhit/gocron).
- <code>&nbsp;&nbsp;1719</code> [go-quartz](https://github.com/reugn/go-quartz) - Simple, zero-dependency scheduling library for Go.
- <code>&nbsp;&nbsp;1288</code> [Dagu](https://github.com/dagu-go/dagu) - No-code workflow executor. it executes DAGs defined in a simple YAML format.
...
- <code>&nbsp;13799</code> [GJSON](https://github.com/tidwall/gjson) - Get a JSON value with one line of code.
- <code>&nbsp;&nbsp;3398</code> [gabs](https://github.com/Jeffail/gabs) - For parsing, creating and editing unknown or dynamic JSON in Go.
...
- <code>&nbsp;&nbsp;2192</code> [fastjson](https://github.com/valyala/fastjson) - Fast JSON parser and validator for Go. No custom structs, no code generation, no reflection.
- <code>&nbsp;&nbsp;&nbsp;808</code> [OjG](https://github.com/ohler55/ojg) - Optimized JSON for Go is a high performance parser with a variety of additional JSON tools including JSONPath.
...
- <code>&nbsp;24218</code> [logrus](https://github.com/Sirupsen/logrus) - Structured logger for Go.
- <code>&nbsp;21175</code> [zap](https://github.com/uber-go/zap) - Fast, structured, leveled logging in Go.
- <code>&nbsp;&nbsp;9997</code> [zerolog](https://github.com/rs/zerolog) - Zero-allocation JSON logger.
...
- <code>&nbsp;&nbsp;4673</code> [lumberjack](https://github.com/natefinch/lumberjack) - Simple rolling logger, implements io.WriteCloser.
...
- <code>&nbsp;&nbsp;&nbsp;633</code> [tint](https://github.com/lmittmann/tint) - A slog.Handler that writes tinted logs.
...
- <code>&nbsp;&nbsp;&nbsp;289</code> [slog-multi](https://github.com/samber/slog-multi) - Chain of slog.Handler (pipeline, fanout...).
- <code>&nbsp;&nbsp;&nbsp;286</code> [go-logger](https://github.com/apsdehal/go-logger) - Simple logger of Go Programs, with level handlers.
- <code>&nbsp;&nbsp;&nbsp;198</code> [logur](https://github.com/logur/logur) - An opinionated logger interface and collection of logging best practices with adapters and integrations for well-known libraries (<code>&nbsp;24218</code> [logrus](https://github.com/sirupsen/logrus), <code>&nbsp;26250</code> [go-kit log](https://github.com/go-kit/kit/tree/master/log), <code>&nbsp;21175</code> [zap](https://github.com/uber-go/zap), <code>&nbsp;&nbsp;9997</code> [zerolog](https://github.com/rs/zerolog), etc).
...
- <code>&nbsp;&nbsp;&nbsp;&nbsp;44</code> [go-log](https://github.com/ian-kent/go-log) - Log4j implementation in Go.
...
- <code>&nbsp;&nbsp;&nbsp;&nbsp;28</code> [logrusly](https://github.com/sebest/logrusly) - <code>&nbsp;24218</code> [logrus](https://github.com/sirupsen/logrus) plug-in to send errors to a [Loggly](https://www.loggly.com/).
...
- <code>&nbsp;&nbsp;&nbsp;&nbsp;16</code> [logrusiowriter](https://github.com/cabify/logrusiowriter) - `io.Writer` implementation using <code>&nbsp;24218</code> [logrus](https://github.com/sirupsen/logrus) logger.
...
- <code>&nbsp;&nbsp;&nbsp;&nbsp;13</code> [kemba](https://github.com/clok/kemba) - A tiny debug logging tool inspired by <code>&nbsp;11025</code> [debug](https://github.com/visionmedia/debug), great for CLI tools and applications.
...
- <code>&nbsp;&nbsp;9209</code> [GoLearn](https://github.com/sjwhitworth/golearn) - General Machine Learning library for Go.
- <code>&nbsp;&nbsp;8243</code> [gorse](https://github.com/zhenghaoz/gorse) - An offline recommender system backend based on collaborative filtering written in Go.
- <code>&nbsp;&nbsp;5385</code> [gorgonia](https://github.com/gorgonia/gorgonia) - graph-based computational library like Theano for Go that provides primitives for building various machine learning and neural network algorithms.
...
- <code>&nbsp;&nbsp;2547</code> [gosseract](https://github.com/otiai10/gosseract) - Go package for OCR (Optical Character Recognition), by using Tesseract C++ library.
...
- <code>&nbsp;11144</code> [sarama](https://github.com/Shopify/sarama) - Go library for Apache Kafka.
- <code>&nbsp;&nbsp;8878</code> [Asynq](https://github.com/hibiken/asynq) - A simple, reliable, and efficient distributed task queue for Go built on top of Redis.
- <code>&nbsp;&nbsp;8044</code> [Centrifugo](https://github.com/centrifugal/centrifugo) - Real-time messaging (Websockets or SockJS) server in Go.
- <code>&nbsp;&nbsp;7931</code> [Benthos](https://github.com/Jeffail/benthos) - A message streaming bridge between a range of protocols.
- <code>&nbsp;&nbsp;7794</code> [gorush](https://github.com/appleboy/gorush) - Push notification server using <code>&nbsp;&nbsp;2946</code> [APNs2](https://github.com/sideshow/apns2) and google <code>&nbsp;&nbsp;&nbsp;103</code> [GCM](https://github.com/google/go-gcm).
...
- <code>&nbsp;&nbsp;6848</code> [Watermill](https://github.com/ThreeDotsLabs/watermill) - Working efficiently with message streams. Building event driven applications, enabling event sourcing, RPC over messages, sagas. Can use conventional pub/sub implementations like Kafka or RabbitMQ, but also HTTP or MySQL binlog.
- <code>&nbsp;&nbsp;5616</code> [go-socket.io](https://github.com/googollee/go-socket.io) - socket.io library for golang, a realtime application framework.
- <code>&nbsp;&nbsp;5236</code> [NATS Go Client](https://github.com/nats-io/nats) - Lightweight and high performance publish-subscribe and distributed queueing messaging system - this is the Go library.
- <code>&nbsp;&nbsp;4479</code> [Confluent Kafka Golang Client](https://github.com/confluentinc/confluent-kafka-go) - confluent-kafka-go is Confluent's Golang client for Apache Kafka and the Confluent Platform.
...
- <code>&nbsp;&nbsp;3594</code> [melody](https://github.com/olahol/melody) - Minimalist framework for dealing with websocket sessions, includes broadcasting and automatic ping/pong handling.
...
- <code>&nbsp;&nbsp;2551</code> [go-nsq](https://github.com/nsqio/go-nsq) - the official Go package for NSQ.
- <code>&nbsp;&nbsp;2082</code> [gopush-cluster](https://github.com/Terry-Mao/gopush-cluster) - gopush-cluster is a go push server cluster.
- <code>&nbsp;&nbsp;1653</code> [EventBus](https://github.com/asaskevich/EventBus) - The lightweight event bus with async compatibility.
- <code>&nbsp;&nbsp;1527</code> [Uniqush-Push](https://github.com/uniqush/uniqush-push) - Redis backed unified push service for server-side notifications to mobile devices.
...
- <code>&nbsp;&nbsp;1367</code> [amqp](https://github.com/rabbitmq/amqp091-go) - Go RabbitMQ Client Library.
...
- <code>&nbsp;&nbsp;&nbsp;417</code> [pubsub](https://github.com/tuxychandru/pubsub) - Simple pubsub package for go.
...
- <code>&nbsp;&nbsp;4238</code> [unioffice](https://github.com/unidoc/unioffice) - Pure go library for creating and processing Office Word (.docx), Excel (.xlsx) and Powerpoint (.pptx) documents.

### Microsoft Excel

*Libraries for working with Microsoft Excel.*

- <code>&nbsp;17513</code> [excelize](https://github.com/xuri/excelize) - Golang library for reading and writing Microsoft Excel&trade; (XLSX) files.
- <code>&nbsp;&nbsp;5793</code> [xlsx](https://github.com/tealeg/xlsx) - Library to simplify reading the XML format used by recent version of Microsoft Excel in Go programs.
...
- <code>&nbsp;12478</code> [google/wire](https://github.com/google/wire) - Automated Initialization in Go.
- <code>&nbsp;&nbsp;5337</code> [fx](https://github.com/uber-go/fx) - A dependency injection based application framework for Go (built on top of dig).
- <code>&nbsp;&nbsp;3752</code> [dig](https://github.com/uber-go/dig) - A reflection based dependency injection toolkit for Go.
- <code>&nbsp;&nbsp;1657</code> [do](https://github.com/samber/do) - A dependency injection framework based on Generics.
...
- <code>&nbsp;&nbsp;&nbsp;348</code> [goioc/di](https://github.com/goioc/di) - Spring-inspired Dependency Injection Container.
...
- <code>&nbsp;46783</code> [golang-standards/project-layout](https://github.com/golang-standards/project-layout) - Set of common historical and emerging project layout patterns in the Go ecosystem. Note: despite the org-name they do not represent official golang standards, see <code>&nbsp;46784</code> [this issue](https://github.com/golang-standards/project-layout/issues/117) for more information. Nonetheless, some may find the layout useful.
- <code>&nbsp;&nbsp;3429</code> [ardanlabs/service](https://github.com/ardanlabs/service) - A <code>&nbsp;&nbsp;3429</code> [starter kit](https://github.com/ardanlabs/service/wiki) for building production grade scalable web service applications.
- <code>&nbsp;&nbsp;1783</code> [modern-go-application](https://github.com/sagikazarmark/modern-go-application) - Go application boilerplate and example applying modern practices.
- <code>&nbsp;&nbsp;1736</code> [nunu](https://github.com/go-nunu/nunu) - Nunu is a scaffolding tool for building Go applications.
...
- <code>&nbsp;&nbsp;&nbsp;451</code> [go-starter](https://github.com/allaboutapps/go-starter) - An opinionated production-ready RESTful JSON backend template, highly integrated with VSCode DevContainers.
...
- <code>&nbsp;&nbsp;1337</code> [xstrings](https://github.com/huandu/xstrings) - Collection of useful string functions ported from other languages.
- <code>&nbsp;&nbsp;&nbsp;882</code> [sttr](https://github.com/abhimanyu003/sttr) - cross-platform, cli app to perform various operations on string.
...
- <code>&nbsp;10195</code> [gopsutil](https://github.com/shirou/gopsutil) - Cross-platform library for retrieving process and system utilization(CPU, Memory, Disks, etc).
- <code>&nbsp;&nbsp;5570</code> [gatus](https://github.com/TwinProduction/gatus) - Automated service health dashboard.
- <code>&nbsp;&nbsp;4290</code> [gofakeit](https://github.com/brianvoe/gofakeit) - Random data generator written in go.
- <code>&nbsp;&nbsp;4264</code> [archiver](https://github.com/mholt/archiver) - Library and command for making and extracting .zip and .tar.gz archives.
- <code>&nbsp;&nbsp;2088</code> [go-resiliency](https://github.com/eapache/go-resiliency) - Resiliency patterns for golang.
...
- <code>&nbsp;&nbsp;&nbsp;889</code> [shoutrrr](https://github.com/containrrr/shoutrrr) - Notification library providing easy access to various messaging services like slack, mattermost, gotify and smtp among others.
- <code>&nbsp;&nbsp;&nbsp;864</code> [stateless](https://github.com/qmuntal/stateless) - A fluent library for creating state machines.
...
- <code>&nbsp;&nbsp;&nbsp;358</code> [lk](https://github.com/hyperboloide/lk) - A simple licensing library for golang.
...
- <code>&nbsp;&nbsp;&nbsp;&nbsp;38</code> [govader](https://github.com/jonreiter/govader) - Go implementation of <code>&nbsp;&nbsp;4292</code> [VADER Sentiment Analysis](https://github.com/cjhutto/vaderSentiment).
...
- <code>&nbsp;&nbsp;2345</code> [gojieba](https://github.com/yanyiwu/gojieba) - This is a Go implementation of <code>&nbsp;32638</code> [jieba](https://github.com/fxsjy/jieba) which a Chinese word splitting algorithm.
...
- <code>&nbsp;&nbsp;2828</code> [go-i18n](https://github.com/nicksnyder/go-i18n/) - Package and an accompanying tool to work with localized text.
...
- <code>&nbsp;&nbsp;&nbsp;&nbsp;47</code> [spreak](https://github.com/vorlif/spreak) - Flexible translation and humanization library for Go, based on the concepts behind gettext.
...
- <code>&nbsp;21232</code> [fasthttp](https://github.com/valyala/fasthttp) - Package fasthttp is a fast HTTP implementation for Go, up to 10 times faster than net/http.
- <code>&nbsp;13751</code> [kcptun](https://github.com/xtaci/kcptun) - Extremely simple & fast udp tunnel based on KCP protocol.
- <code>&nbsp;12937</code> [webrtc](https://github.com/pions/webrtc) - A pure Go implementation of the WebRTC API.
- <code>&nbsp;&nbsp;9670</code> [quic-go](https://github.com/lucas-clemente/quic-go) - An implementation of the QUIC protocol in pure Go.
...
- <code>&nbsp;&nbsp;6184</code> [gopacket](https://github.com/google/gopacket) - Go library for packet processing with libpcap bindings.
...
- <code>&nbsp;&nbsp;3949</code> [netpoll](https://github.com/cloudwego/netpoll) - A high-performance non-blocking I/O networking framework, which focused on RPC scenarios, developed by ByteDance.
- <code>&nbsp;&nbsp;3514</code> [ssh](https://github.com/gliderlabs/ssh) - Higher-level API for building SSH servers (wraps crypto/ssh).
- <code>&nbsp;&nbsp;3512</code> [gobgp](https://github.com/osrg/gobgp) - BGP implemented in the Go Programming Language.
...
- <code>&nbsp;&nbsp;2040</code> [nbio](https://github.com/lesismal/nbio) - Pure Go 1000k+ connections solution, support tls/http1.x/websocket and basically compatible with net/http, with high-performance and low memory cost, non-blocking, event-driven, easy-to-use.
- <code>&nbsp;&nbsp;1883</code> [water](https://github.com/songgao/water) - Simple TUN/TAP library.
...
- <code>&nbsp;&nbsp;1086</code> [gosnmp](https://github.com/soniah/gosnmp) - Native Go library for performing SNMP actions.
- <code>&nbsp;&nbsp;1017</code> [gws](https://github.com/lxzan/gws) - High-Performance WebSocket Server & Client With AsyncIO Supporting .
...
- <code>&nbsp;&nbsp;&nbsp;889</code> [cidranger](https://github.com/yl2chen/cidranger) - Fast IP to CIDR lookup for Go.
- <code>&nbsp;&nbsp;&nbsp;795</code> [easytcp](https://github.com/DarthPestilane/easytcp) - A light-weight TCP framework written in Go (Golang), built with message router. EasyTCP helps you build a TCP server easily fast and less painful.
...
- <code>&nbsp;&nbsp;&nbsp;&nbsp;44</code> [fwdctl](https://github.com/alegrey91/fwdctl) - A simple and intuitive CLI to manage IPTables forwards in your Linux server.
...
- <code>&nbsp;&nbsp;9532</code> [resty](https://github.com/go-resty/resty) - Simple HTTP and REST client for Go inspired by Ruby rest-client.
- <code>&nbsp;&nbsp;4087</code> [req](https://github.com/imroc/req) - Simple Go HTTP client with Black Magic (Less code and More efficiency).
- <code>&nbsp;&nbsp;2572</code> [heimdall](https://github.com/gojektech/heimdall) - An enhanced http client with retry and hystrix capabilities.
- <code>&nbsp;&nbsp;2106</code> [grequests](https://github.com/levigross/grequests) - A Go "clone" of the great and famous Requests library.
- <code>&nbsp;&nbsp;1884</code> [go-retryablehttp](https://github.com/hashicorp/go-retryablehttp) - Retryable HTTP client in Go.
- <code>&nbsp;&nbsp;1653</code> [sling](https://github.com/dghubble/sling) - Sling is a Go HTTP client library for creating and sending API requests.
...
- <code>&nbsp;&nbsp;1046</code> [gl](https://github.com/go-gl/gl) - Go bindings for OpenGL (generated via glow).
...
- <code>&nbsp;35859</code> [GORM](https://github.com/go-gorm/gorm) - The fantastic ORM library for Golang, aims to be developer friendly.
- <code>&nbsp;15082</code> [ent](https://github.com/facebook/ent) - An entity framework for Go. Simple, yet powerful ORM for modeling and querying data.
- <code>&nbsp;&nbsp;6515</code> [SQLBoiler](https://github.com/volatiletech/sqlboiler) - ORM generator. Generate a featureful and blazing-fast ORM tailored to your database schema.
...
- <code>&nbsp;&nbsp;3401</code> [bun](https://github.com/uptrace/bun) - SQL-first Golang ORM. Successor of go-pg.
- <code>&nbsp;&nbsp;2328</code> [gormt](https://github.com/xxjwxc/gormt) - Mysql database to golang gorm struct.
- <code>&nbsp;&nbsp;2002</code> [Prisma](https://github.com/prisma/prisma-client-go) - Prisma Client Go, Typesafe database access for Go.
...
- <code>&nbsp;&nbsp;1228</code> [go-sqlbuilder](https://github.com/huandu/go-sqlbuilder) - A flexible and powerful SQL string builder library plus a zero-config ORM.
...
- <code>&nbsp;&nbsp;&nbsp;285</code> [gup](https://github.com/nao1215/gup) - Update binaries installed by "go install".
...
- <code>&nbsp;19727</code> [jaeger](https://github.com/jaegertracing/jaeger) - A distributed tracing system.
- <code>&nbsp;&nbsp;5348</code> [pixie](https://github.com/pixie-labs/pixie) - No instrumentation tracing for Golang applications via eBPF.
...
- <code>&nbsp;&nbsp;9788</code> [graphql-go](https://github.com/graphql-go/graphql) - Implementation of GraphQL for Go.
- <code>&nbsp;&nbsp;9728</code> [gqlgen](https://github.com/99designs/gqlgen) - go generate based graphql server library.
- <code>&nbsp;&nbsp;4939</code> [dasel](https://github.com/tomwright/dasel) - Query and update data structures using selectors from the command line. Comparable to jq/yq but supports JSON, YAML, TOML and XML with zero runtime dependencies.
- <code>&nbsp;&nbsp;4609</code> [graphql](https://github.com/neelance/graphql-go) - GraphQL server with a focus on ease of use.
- <code>&nbsp;&nbsp;2165</code> [gojsonq](https://github.com/thedevsaddam/gojsonq) - A simple Go package to Query over JSON Data.
...
- <code>&nbsp;&nbsp;3736</code> [statik](https://github.com/rakyll/statik) - Embeds static files into a Go executable.
...
- <code>&nbsp;&nbsp;7342</code> [gonum](https://github.com/gonum/gonum) - Gonum is a set of numeric libraries for the Go programming language. It contains libraries for matrices, statistics, optimization, and more.
...
- <code>&nbsp;&nbsp;1134</code> [dataframe-go](https://github.com/rocketlaunchr/dataframe-go) - Dataframes for machine-learning and statistics (similar to pandas).
...
- <code>&nbsp;15545</code> [age](https://github.com/FiloSottile/age) - A simple, modern and secure encryption tool (and Go library) with small explicit keys, no config options, and UNIX-style composability.
- <code>&nbsp;&nbsp;7398</code> [lego](https://github.com/go-acme/lego) - Pure Go ACME client library and CLI tool (for use with Let's Encrypt).
- <code>&nbsp;&nbsp;4873</code> [CertMagic](https://github.com/caddyserver/certmagic) - Mature, robust, and powerful ACME client integration for fully-managed TLS certificate issuance and renewal.
...
- <code>&nbsp;&nbsp;2492</code> [memguard](https://github.com/awnumar/memguard) - A pure Go library for handling sensitive values in memory.
- <code>&nbsp;&nbsp;2231</code> [secure](https://github.com/unrolled/secure) - HTTP middleware for Go that facilitates some quick security wins.
- <code>&nbsp;&nbsp;2031</code> [acmetool](https://github.com/hlandau/acme) - ACME (Let's Encrypt) client tool with automatic renewal.
- <code>&nbsp;&nbsp;1913</code> [Coraza](https://github.com/corazawaf/coraza) - Enterprise-ready, modsecurity and OWASP CRS compatible WAF library.
...
- <code>&nbsp;13138</code> [jsoniter](https://github.com/json-iterator/go) - High-performance 100% compatible drop-in replacement of "encoding/json".
- <code>&nbsp;&nbsp;9607</code> [goprotobuf](https://github.com/golang/protobuf) - Go support, in the form of a library and protocol compiler plugin, for Google's protocol buffers.
...
- <code>&nbsp;55059</code> [Caddy](https://github.com/caddyserver/caddy) - Caddy is an alternative, HTTP/2 web server that's easy to configure and use.
...
- <code>&nbsp;44987</code> [minio](https://github.com/minio/minio) - Minio is a distributed object storage server.
- <code>&nbsp;34565</code> [pocketbase](https://github.com/pocketbase/pocketbase) - PocketBase is a realtime backend in 1 file consisting of embedded database (SQLite) with realtime subscriptions, built-in auth management and much more.
- <code>&nbsp;&nbsp;8420</code> [SFTPGo](https://github.com/drakkan/sftpgo) - Fully featured and highly configurable SFTP server with optional FTP/S and WebDAV support. It can serve local filesystem and Cloud Storage backends such as S3 and Google Cloud Storage.
...
- <code>&nbsp;&nbsp;3389</code> [flipt](https://github.com/markphelps/flipt) - A self contained feature flag solution written in Go and Vue.js
- <code>&nbsp;&nbsp;3178</code> [Wish](https://github.com/charmbracelet/wish) - Make SSH apps, just like that!
- <code>&nbsp;&nbsp;2717</code> [Fider](https://github.com/getfider/fider) - Fider is an open platform to collect and organize customer feedback.
...
- <code>&nbsp;&nbsp;1781</code> [go-streams](https://github.com/reugn/go-streams) - Go stream processing library.
...
- <code>&nbsp;&nbsp;6928</code> [templ](https://github.com/a-h/templ) - A HTML templating language that has great developer tooling.
- <code>&nbsp;&nbsp;4022</code> [sprig](https://github.com/Masterminds/sprig) - Useful template functions for Go templates.
- <code>&nbsp;&nbsp;3027</code> [quicktemplate](https://github.com/valyala/quicktemplate) - Fast, powerful, yet easy to use template engine. Converts templates into Go code and then compiles it.
- <code>&nbsp;&nbsp;2797</code> [pongo2](https://github.com/flosch/pongo2) - Django-like template-engine for Go.
- <code>&nbsp;&nbsp;1488</code> [maroto](https://github.com/johnfercher/maroto) - A maroto way to create PDFs. Maroto is inspired in Bootstrap and uses gofpdf. Fast and simple.
...
- <code>&nbsp;22354</code> [Testify](https://github.com/stretchr/testify) - Sacred extension to the standard go testing package.
- <code>&nbsp;&nbsp;8137</code> [GoConvey](https://github.com/smartystreets/goconvey/) - BDD-style framework with web UI and live reload.
- <code>&nbsp;&nbsp;4028</code> [go-cmp](https://github.com/google/go-cmp) - Package for comparing Go values in tests.
- <code>&nbsp;&nbsp;3230</code> [testcontainers-go](https://github.com/testcontainers/testcontainers-go) - A Go package that makes it simple to create and clean up container-based dependencies for automated integration/smoke tests. The clean, easy-to-use API enables developers to programmatically define containers that should be run as part of a test and clean up those resources when the test is done.
...
- <code>&nbsp;&nbsp;1736</code> [is](https://github.com/matryer/is) - Professional lightweight testing mini-framework for Go.
- <code>&nbsp;&nbsp;1321</code> [gnomock](https://github.com/orlangure/gnomock) - integration testing with real dependencies (database, cache, even Kubernetes or AWS) running in Docker, without mocks.
- <code>&nbsp;&nbsp;1108</code> [go-vcr](https://github.com/dnaeon/go-vcr) - Record and replay your HTTP interactions for fast, deterministic and accurate tests.
...
- <code>&nbsp;&nbsp;&nbsp;768</code> [embedded-postgres](https://github.com/fergusstrange/embedded-postgres) - Run a real Postgres database locally on Linux, OSX or Windows as part of another Go application or test.
...
- <code>&nbsp;&nbsp;5902</code> [go-sqlmock](https://github.com/DATA-DOG/go-sqlmock) - Mock SQL driver for testing database interactions.
- <code>&nbsp;&nbsp;5757</code> [mockery](https://github.com/vektra/mockery) - Tool to generate Go interfaces.
...
- <code>&nbsp;&nbsp;1883</code> [httpmock](https://github.com/jarcoal/httpmock) - Easy mocking of HTTP responses from external resources.
...
- <code>&nbsp;&nbsp;&nbsp;262</code> [xgo](https://github.com/xhd2015/xgo) - A general pureposed function mocking library.
...
- <code>&nbsp;10530</code> [chromedp](https://github.com/knq/chromedp) - a way to drive/test Chrome, Safari, Edge, Android Webviews, and other browsers supporting the Chrome Debugging Protocol.
- <code>&nbsp;&nbsp;4929</code> [rod](https://github.com/go-rod/rod) - A Devtools driver to make web automation and scraping easy.
- <code>&nbsp;&nbsp;2529</code> [selenoid](https://github.com/aerokube/selenoid) - alternative Selenium hub server that launches browsers within containers.
- <code>&nbsp;&nbsp;1909</code> [playwright-go](https://github.com/mxschmitt/playwright-go) - browser automation library to control Chromium, Firefox and WebKit with a single API.
...
- <code>&nbsp;&nbsp;4153</code> [go-humanize](https://github.com/dustin/go-humanize) - Formatters for time, numbers, and memory size to human readable format.
...
- <code>&nbsp;&nbsp;1662</code> [go-toml](https://github.com/pelletier/go-toml) - Go library for the TOML format with query support and handy cli tools.
- <code>&nbsp;&nbsp;&nbsp;751</code> [html-to-markdown](https://github.com/JohannesKaufmann/html-to-markdown) - Convert HTML to Markdown. Even works with entire websites and can be extended through rules.
...
- <code>&nbsp;&nbsp;&nbsp;614</code> [mxj](https://github.com/clbanning/mxj) - Encode / decode XML as JSON or map[string]interface{}; extract values with dot-notation paths and wildcards. Replaces x2j and j2x packages.
...
- <code>&nbsp;&nbsp;6910</code> [sh](https://github.com/mvdan/sh) - Shell parser and formatter.
- <code>&nbsp;&nbsp;2492</code> [gofeed](https://github.com/mmcdole/gofeed) - Parse RSS and Atom feeds in Go.
...
- <code>&nbsp;22478</code> [colly](https://github.com/asciimoo/colly) - Fast and Elegant Scraping Framework for Gophers.
- <code>&nbsp;13682</code> [GoQuery](https://github.com/PuerkitoBio/goquery) - GoQuery brings a syntax and a set of features similar to jQuery to the Go language.
...
- <code>&nbsp;10140</code> [github](https://github.com/google/go-github) - Go library for accessing the GitHub REST API v3.
- <code>&nbsp;&nbsp;8495</code> [go-openai](https://github.com/sashabaranov/go-openai) - OpenAI ChatGPT, DALL·E, Whisper API library for Go.
- <code>&nbsp;&nbsp;4821</code> [discordgo](https://github.com/bwmarrin/discordgo) - Go bindings for the Discord Chat API.
...
- <code>&nbsp;&nbsp;3641</code> [google-cloud](https://github.com/GoogleCloudPlatform/gcloud-golang) - Google Cloud APIs Go Client Library.
- <code>&nbsp;&nbsp;2469</code> [aws-sdk-go](https://github.com/aws/aws-sdk-go-v2) - The official AWS SDK for the Go programming language.
- <code>&nbsp;&nbsp;2328</code> [minio-go](https://github.com/minio/minio-go) - Minio Go Library for Amazon S3 compatible cloud storage.
...
- <code>&nbsp;&nbsp;&nbsp;938</code> [webhooks](https://github.com/go-playground/webhooks) - Webhook receiver for GitHub and Bitbucket.
...
- <code>&nbsp;61123</code> [fzf](https://github.com/junegunn/fzf) - Command-line fuzzy finder written in Go.
- <code>&nbsp;44180</code> [dive](https://github.com/wagoodman/dive) - A tool for exploring each layer in a Docker image.
- <code>&nbsp;22715</code> [hub](https://github.com/github/hub) - wrap git commands with additional functionality to interact with github from the terminal.
- <code>&nbsp;15714</code> [lo](https://github.com/samber/lo) - A Lodash like Go library based on Go 1.18+ Generics (map, filter, contains, find...)
- <code>&nbsp;15586</code> [sqlx](https://github.com/jmoiron/sqlx) - provides a set of extensions on top of the excellent built-in database/sql package.
- <code>&nbsp;15256</code> [ctop](https://github.com/bcicen/ctop) - [Top-like](https://ctop.sh) interface (e.g. htop) for container metrics.
- <code>&nbsp;13303</code> [goreleaser](https://github.com/goreleaser/goreleaser) - Deliver Go binaries as fast and easily as possible.
- <code>&nbsp;10492</code> [wuzz](https://github.com/asciimoo/wuzz) - Interactive cli tool for HTTP inspection.
- <code>&nbsp;&nbsp;8699</code> [usql](https://github.com/knq/usql) - usql is a universal command-line interface for SQL databases.
...
- <code>&nbsp;&nbsp;4178</code> [hystrix-go](https://github.com/afex/hystrix-go) - Implements Hystrix patterns of programmer-defined fallbacks aka circuit breaker.
...
- <code>&nbsp;&nbsp;3500</code> [panicparse](https://github.com/maruel/panicparse) - Groups similar goroutines and colorizes stack dump.
...
- <code>&nbsp;&nbsp;2774</code> [mergo](https://github.com/imdario/mergo) - Helper to merge structs and maps in Golang. Useful for configuration default values, avoiding messy if-statements.
...
- <code>&nbsp;&nbsp;2359</code> [create-go-app](https://github.com/create-go-app/cli) - A powerful CLI for create a new production-ready project with backend (Golang), frontend (JavaScript, TypeScript) & deploy automation (Ansible, Docker) by running one command.
...
- <code>&nbsp;&nbsp;1459</code> [mimetype](https://github.com/gabriel-vasile/mimetype) - Package for MIME type detection based on magic numbers.
- <code>&nbsp;&nbsp;1211</code> [scany](https://github.com/georgysavva/scany) - Library for scanning data from a database into Go structs and more.
...
- <code>&nbsp;&nbsp;&nbsp;793</code> [upterm](https://github.com/owenthereal/upterm) - A tool for developers to share terminal/tmux sessions securely over the web. It’s perfect for remote pair programming, accessing computers behind NATs/firewalls, remote debugging, and more.
...
- <code>&nbsp;&nbsp;&nbsp;617</code> [changie](https://github.com/miniscruff/changie) - Automated changelog tool for preparing releases with lots of customization options.
...
- <code>&nbsp;&nbsp;&nbsp;530</code> [scan](https://github.com/blockloop/scan) - Scan golang `sql.Rows` directly to structs, slices, or primitive types.
...
- <code>&nbsp;&nbsp;&nbsp;347</code> [limiters](https://github.com/mennanov/limiters) - Rate limiters for distributed applications in Golang with configurable back-ends and distributed locks.
...
- <code>&nbsp;&nbsp;5093</code> [uuid](https://github.com/google/uuid) - Go package for UUIDs based on RFC 4122 and DCE 1.1: Authentication and Security Services.
...
- <code>&nbsp;&nbsp;3786</code> [xid](https://github.com/rs/xid) - Xid is a globally unique id generator library, ready to be safely used directly in your server code.
...
- <code>&nbsp;15880</code> [validator](https://github.com/go-playground/validator) - Go Struct and Field validation, including Cross Field, Cross Struct, Map, Slice and Array diving.
...
- <code>&nbsp;&nbsp;3615</code> [ozzo-validation](https://github.com/go-ozzo/ozzo-validation) - Supports validation of various data types (structs, strings, maps, slices, etc.) with configurable and extensible validation rules specified in usual code constructs instead of struct tags.
...
- <code>&nbsp;&nbsp;5611</code> [go-git](https://github.com/go-git/go-git) - highly extensible Git implementation in pure Go.
...
- <code>&nbsp;&nbsp;2077</code> [goav](https://github.com/giorgisio/goav) - Comprehensive Go bindings for FFmpeg.
- <code>&nbsp;&nbsp;1181</code> [m3u8](https://github.com/grafov/m3u8) - Parser and generator library of M3U8 playlists for Apple HLS.
- <code>&nbsp;&nbsp;&nbsp;877</code> [gmf](https://github.com/3d0c/gmf) - Go bindings for FFmpeg av\* libraries.
- <code>&nbsp;&nbsp;&nbsp;629</code> [gortsplib](https://github.com/aler9/gortsplib) - Pure Go RTSP server and client library.
...
- <code>&nbsp;76249</code> [Gin](https://github.com/gin-gonic/gin) - Gin is a web framework written in Go! It features a martini-like API with much better performance, up to 40 times faster. If you need performance and good productivity.
- <code>&nbsp;31890</code> [Fiber](https://github.com/gofiber/fiber) - An Express.js inspired web framework build on Fasthttp.
- <code>&nbsp;31047</code> [Beego](https://github.com/beego/beego) - beego is an open-source, high-performance web framework for the Go programming language.
- <code>&nbsp;28821</code> [Echo](https://github.com/labstack/echo) - High performance, minimalist Go web framework.
- <code>&nbsp;13108</code> [Revel](https://github.com/revel/revel) - High-productivity web framework for the Go language.
- <code>&nbsp;11011</code> [GoFrame](https://github.com/gogf/gf) - GoFrame is a modular, powerful, high-performance and enterprise-class application development framework of Golang.
- <code>&nbsp;&nbsp;5503</code> [Goa](https://github.com/goadesign/goa) - Goa provides a holistic approach for developing remote APIs and microservices in Go.
- <code>&nbsp;&nbsp;4824</code> [Hertz](https://github.com/cloudwego/hertz) - A high-performance and strong-extensibility Go HTTP framework that helps developers build microservices.
- <code>&nbsp;&nbsp;3756</code> [Gizmo](https://github.com/NYTimes/gizmo) - Microservice toolkit used by the New York Times.
- <code>&nbsp;&nbsp;3512</code> [go-json-rest](https://github.com/ant0ine/go-json-rest) - Quick and easy way to setup a RESTful JSON API.
- <code>&nbsp;&nbsp;3483</code> [Macaron](https://github.com/go-macaron/macaron) - Macaron is a high productive and modular design web framework in Go.
- <code>&nbsp;&nbsp;2217</code> [utron](https://github.com/gernest/utron) - Lightweight MVC framework for Go(Golang).
- <code>&nbsp;&nbsp;1522</code> [Huma](https://github.com/danielgtaylor/huma/) - Framework for modern REST/GraphQL APIs with built-in OpenAPI 3, generated documentation, and a CLI.
- <code>&nbsp;&nbsp;1473</code> [Goyave](https://github.com/go-goyave/goyave) - Feature-complete REST API framework aimed at clean code and fast development, with powerful built-in functionalities.
- <code>&nbsp;&nbsp;1255</code> [GoFr](https://github.com/gofr-dev/gofr) - Gofr is an opinionated microservice development framework.
...
- <code>&nbsp;&nbsp;&nbsp;434</code> [Flamingo](https://github.com/i-love-flamingo/flamingo) - Framework for pluggable web projects. Including a concept for modules and offering features for DI, Configareas, i18n, template engines, graphql, observability, security, events, routing & reverse routing etc.
...
- <code>&nbsp;&nbsp;2613</code> [Tollbooth](https://github.com/didip/tollbooth) - Rate limit HTTP request handler.
- <code>&nbsp;&nbsp;2570</code> [CORS](https://github.com/rs/cors) - Easily add CORS capabilities to your API.
- <code>&nbsp;&nbsp;2000</code> [Limiter](https://github.com/ulule/limiter) - Dead simple rate limit middleware for Go.
...
- <code>&nbsp;20349</code> [mux](https://github.com/gorilla/mux) - Powerful URL router and dispatcher for golang.
- <code>&nbsp;17437</code> [chi](https://github.com/go-chi/chi) - Small, fast and expressive HTTP router built on net/context.
- <code>&nbsp;16374</code> [httprouter](https://github.com/julienschmidt/httprouter) - High performance router. Use this and the standard http handlers to form a very high performance web framework.
...
- <code>&nbsp;14642</code> [tinygo](https://github.com/tinygo-org/tinygo) - Go compiler for small places. Microcontrollers, WebAssembly, and command-line tools. Based on LLVM.
...
- <code>&nbsp;14745</code> [golangci-lint](https://github.com/golangci/golangci-lint) – A fast Go linters runner. It runs linters in parallel, uses caching, supports `yaml` config, has integrations with all major IDE and has dozens of linters included.
...
- <code>&nbsp;&nbsp;1786</code> [go-critic](https://github.com/go-critic/go-critic) - source code linter that brings checks that are currently not implemented in other linters.
- <code>&nbsp;&nbsp;1751</code> [GoPlantUML](https://github.com/jfeliu007/goplantuml) - Library and CLI that generates text plantump class diagram containing information about structures and interfaces with the relationship among them.
...
- <code>&nbsp;&nbsp;&nbsp;829</code> [go-cleanarch](https://github.com/roblaszczak/go-cleanarch) - go-cleanarch was created to validate Clean Architecture rules, like a The Dependency Rule and interaction between packages in your Go projects.
...
- <code>&nbsp;&nbsp;&nbsp;474</code> [vacuum](https://github.com/daveshanley/vacuum) - An ultra-super-fast, lightweight OpenAPI linter and quality checking tool.
...
- <code>&nbsp;&nbsp;&nbsp;&nbsp;81</code> [testifylint](https://github.com/Antonboom/testifylint) – A linter that checks usage of <code>&nbsp;22353</code> [github.com/stretchr/testify](https://github.com/stretchr/testify).
...
- <code>&nbsp;15883</code> [vim-go](https://github.com/fatih/vim-go) - Go development plugin for Vim.
- <code>&nbsp;&nbsp;5009</code> [gocode](https://github.com/nsf/gocode) - Autocompletion daemon for the Go programming language.
- <code>&nbsp;&nbsp;3765</code> [vscode-go](https://github.com/golang/vscode-go) - Extension for Visual Studio Code (VS Code) which provides support for the Go language.
...
- <code>&nbsp;&nbsp;&nbsp;552</code> [goimports-reviser](https://github.com/incu6us/goimports-reviser) - Formatting tool for imports.
...
- <code>&nbsp;&nbsp;&nbsp;296</code> [xgen](https://github.com/xuri/xgen) - XSD (XML Schema Definition) parser and Go/C/Java/Rust/TypeScript code generator.
...
- <code>&nbsp;&nbsp;9336</code> [go-swagger](https://github.com/go-swagger/go-swagger) - Swagger 2.0 implementation for go. Swagger is a simple yet powerful representation of your RESTful API.
- <code>&nbsp;&nbsp;5794</code> [go-callvis](https://github.com/TrueFurby/go-callvis) - Visualize call graph of your Go program using dot format.
- <code>&nbsp;&nbsp;5254</code> [OctoLinker](https://github.com/OctoLinker/browser-extension) - Navigate through go files efficiently with the OctoLinker browser extension for GitHub.
...
- <code>&nbsp;&nbsp;&nbsp;556</code> [go-size-analyzer](https://github.com/Zxilly/go-size-analyzer) - Analyze and visualize the size of dependencies in compiled Golang binaries, providing insight into their impact on the final build.
...
- <code>107824</code> [kubernetes](https://github.com/kubernetes/kubernetes) - Container Cluster Manager from Google.
- <code>&nbsp;67968</code> [Moby](https://github.com/moby/moby) - Collaborative project for the container ecosystem to assemble container-based systems.
- <code>&nbsp;48736</code> [traefik](https://github.com/containous/traefik) - Reverse proxy and load balancer with support for multiple backends.
- <code>&nbsp;42692</code> [Gitea](https://github.com/go-gitea/gitea) - Fork of Gogs, entirely community driven.
- <code>&nbsp;28634</code> [minikube](https://github.com/kubernetes/minikube) - Run Kubernetes locally.
- <code>&nbsp;26810</code> [k3s](https://github.com/k3s-io/k3s) - Lightweight Kubernetes.
- <code>&nbsp;23740</code> [k6](https://github.com/grafana/k6) - A modern load testing tool, using Go and JavaScript.
- <code>&nbsp;22923</code> [Vegeta](https://github.com/tsenart/vegeta) - HTTP load testing tool and library. It's over 9000!
- <code>&nbsp;17499</code> [Hey](https://github.com/rakyll/hey) - Hey is a tiny program that sends some load to a web application.
...
- <code>&nbsp;12927</code> [kind](https://github.com/kubernetes-sigs/kind) - Kubernetes IN Docker - local clusters for testing Kubernetes.
- <code>&nbsp;10654</code> [kubeshark](https://github.com/kubeshark/kubeshark) - API traffic analyzer for Kubernetes, inspired by Wireshark, purposely built for Kubernetes.
- <code>&nbsp;&nbsp;9992</code> [webhook](https://github.com/adnanh/webhook) - Tool which allows user to create HTTP endpoints (hooks) that execute commands on the server.
- <code>&nbsp;&nbsp;9798</code> [GVM](https://github.com/moovweb/gvm) - GVM provides an interface to manage Go versions.
- <code>&nbsp;&nbsp;8572</code> [Flannel](https://github.com/flannel-io/flannel) - Flannel is a network fabric for containers, designed for Kubernetes.
- <code>&nbsp;&nbsp;8222</code> [Ddosify](https://github.com/ddosify/ddosify) - High-performance load testing tool, written in Golang.
- <code>&nbsp;&nbsp;7344</code> [ko](https://github.com/google/ko) - Command line tool for building and deploying Go applications on Kubernetes
- <code>&nbsp;&nbsp;6182</code> [KubeVela](https://github.com/kubevela/kubevela) - Cloud native application delivery.
- <code>&nbsp;&nbsp;5385</code> [bombardier](https://github.com/codesenberg/bombardier) - Fast cross-platform HTTP benchmarking tool.
- <code>&nbsp;&nbsp;5224</code> [podinfo](https://github.com/stefanprodan/podinfo) - Podinfo is a tiny web application made with Go that showcases best practices of running microservices in Kubernetes. Podinfo is used by CNCF projects like Flux and Flagger for end-to-end testing and workshops.
- <code>&nbsp;&nbsp;5185</code> [script](https://github.com/bitfield/script) - Making it easy to write shell-like scripts in Go for DevOps and system administration tasks.
- <code>&nbsp;&nbsp;5180</code> [gaia](https://github.com/gaia-pipeline/gaia) - Build powerful pipelines in any programming language.
- <code>&nbsp;&nbsp;5161</code> [k3d](https://github.com/k3d-io/k3d) - Little helper to run CNCF's k3s in Docker.
...
- <code>&nbsp;&nbsp;2401</code> [s5cmd](https://github.com/peak/s5cmd) - Blazing fast S3 and local filesystem execution tool.
- <code>&nbsp;&nbsp;2269</code> [Fleet device management](https://github.com/fleetdm/fleet) - Lightweight, programmable telemetry for servers and workstations.
...
- <code>&nbsp;&nbsp;1710</code> [kubeblocks](https://github.com/apecloud/kubeblocks) - KubeBlocks is an open-source control plane that runs and manages databases, message queues and other data infrastructure on K8s.
...
- <code>&nbsp;&nbsp;&nbsp;762</code> [KusionStack](https://github.com/KusionStack/kusion) - A unified programmable configuration techstack to deliver modern app in 'platform as code' and 'infra as code' approach.
- <code>&nbsp;&nbsp;&nbsp;734</code> [cassowary](https://github.com/rogerwelin/cassowary) - Modern cross-platform HTTP load-testing tool written in Go.
...
- <code>&nbsp;&nbsp;&nbsp;269</code> [tau](https://github.com/taubyte/tau) - Easily build Cloud Computing Platforms with features like Serverless WebAssembly Functions, Frontend Hosting, CI/CD, Object Storage, K/V Database, and Pub-Sub Messaging.
...
- <code>&nbsp;26664</code> [croc](https://github.com/schollz/croc) - Easily and securely send files or folders from one computer to another.
- <code>&nbsp;24252</code> [restic](https://github.com/restic/restic) - De-duplicating backup program.
- <code>&nbsp;21478</code> [Seaweed File System](https://github.com/chrislusf/seaweedfs) - Fast, Simple and Scalable Distributed File System with O(1) disk seek.
...
- <code>&nbsp;10436</code> [toxiproxy](https://github.com/shopify/toxiproxy) - Proxy to simulate network and system conditions for automated tests.
- <code>&nbsp;10248</code> [Comcast](https://github.com/tylertreat/Comcast) - Simulate bad network connections.
- <code>&nbsp;&nbsp;8293</code> [confd](https://github.com/kelseyhightower/confd) - Manage local application configuration files using templates and data from etcd or consul.
- <code>&nbsp;&nbsp;7480</code> [LiteIDE](https://github.com/visualfc/liteide) - LiteIDE is a simple, open source, cross-platform Go IDE.
- <code>&nbsp;&nbsp;6648</code> [drive](https://github.com/odeke-em/drive) - Google Drive client for the commandline.
- <code>&nbsp;&nbsp;6237</code> [scc](https://github.com/boyter/scc) - Sloc Cloc and Code, a very fast accurate code counter with complexity calculations and COCOMO estimates.
- <code>&nbsp;&nbsp;5393</code> [nes](https://github.com/fogleman/nes) - Nintendo Entertainment System (NES) emulator written in Go.
- <code>&nbsp;&nbsp;5043</code> [Duplicacy](https://github.com/gilbertchen/duplicacy) - A cross-platform network and cloud backup tool based on the idea of lock-free deduplication.
- <code>&nbsp;&nbsp;4314</code> [blocky](https://github.com/0xERR0R/blocky) - Fast and lightweight DNS proxy as ad-blocker for local network with many features.
...
- <code>&nbsp;&nbsp;1408</code> [Plik](https://github.com/root-gg/plik) - Plik is a temporary file upload system (Wetransfer like) in Go.
...
- <code>&nbsp;&nbsp;1066</code> [Gokapi](https://github.com/Forceu/gokapi) - Lightweight server to share files, which expire after a set amount of downloads or days. Similar to Firefox Send, but without public upload.
...
- <code>&nbsp;&nbsp;&nbsp;565</code> [yai](https://github.com/ekkinox/yai) - AI powered terminal assistant.
...
- <code>&nbsp;&nbsp;&nbsp;457</code> [GoNB](https://github.com/janpfeifer/gonb) - Interactive Go programming with Jupyter Notebooks (also works in VSCode, Binder and Google's Colab).
...
- <code>&nbsp;&nbsp;&nbsp;234</code> [crawley](https://github.com/s0rg/crawley) - Web scraper/crawler for cli.
...
- <code>&nbsp;&nbsp;&nbsp;139</code> [stew](https://github.com/marwanhawari/stew) - An independent package manager for compiled binaries.
...
- <code>&nbsp;&nbsp;2018</code> [go-web-framework-benchmark](https://github.com/smallnest/go-web-framework-benchmark) - Go web framework benchmark.
...
- <code>&nbsp;16215</code> [GoBooks](https://github.com/dariubs/GoBooks) - A curated list of Go books.
...
- <code>&nbsp;29371</code> [CockroachDB](https://github.com/cockroachdb/cockroach/blob/master/docs/style.md)
- <code>&nbsp;15494</code> [Hyperledger](https://github.com/hyperledger/fabric/blob/release-1.4/docs/source/style-guides/go-style.rst)
- <code>&nbsp;15388</code> [Uber](https://github.com/uber-go/guide/blob/master/style.md)
...
- <code>120637</code> [Go Projects](https://github.com/golang/go/wiki/Projects) - List of projects on the Go community wiki.
- <code>&nbsp;31400</code> [awesome-awesomeness](https://github.com/bayandin/awesome-awesomeness) - List of other amazingly awesome lists.
- <code>&nbsp;28464</code> [Awesome Remote Job](https://github.com/lukasz-madon/awesome-remote-job) - Curated list of awesome remote jobs. A lot of them are looking for Go hackers.
...
- <code>&nbsp;43012</code> [Build web application with Golang](https://github.com/astaxie/build-web-application-with-golang) - Golang ebook intro how to build a web app with golang.
- <code>&nbsp;24358</code> [go-patterns](https://github.com/tmrts/go-patterns) - Curated list of Go design patterns, recipes and idioms.
- <code>&nbsp;21450</code> [Learn Go with TDD](https://github.com/quii/learn-go-with-tests) - Learn Go with test-driven development.
- <code>&nbsp;18499</code> [Learn Go with 1000+ Exercises](https://github.com/inancgumus/learngo) - Learn Go with thousands of examples, exercises, and quizzes.
- <code>&nbsp;&nbsp;8160</code> [Go Cheat Sheet](https://github.com/a8m/go-lang-cheat-sheet) - Go's reference card.
- <code>&nbsp;&nbsp;6045</code> [go-clean-template](https://github.com/evrone/go-clean-template) - Clean Architecture template for Golang services.
- <code>&nbsp;&nbsp;4544</code> [Golang for Node.js Developers](https://github.com/miguelmota/golang-for-nodejs-developers) - Examples of Golang compared to Node.js for learning.
...
- <code>&nbsp;&nbsp;&nbsp;782</code> [goapp](https://github.com/bnkamalesh/goapp) - An opinionated guideline to structure & develop a Go web application/service.
